...
extern jint iwnn_get_segment_stroke_length(JNIEnv *env, jclass clazz, jint iwnnp, jint segment);
extern jint iwnn_get_word_stroke_length(JNIEnv *env, jclass clazz, jint iwnnp, jint cand);
#endif /*__IWNN_H_*/
