...
//// OSK MOD end
    ...
    /** Key code for change language popup label English */
    public static final int KEYCODE_POPUP_LABEL_ENGLISH = -614;
    /** Key code for change style popup title */
    public static final int KEYCODE_POPUP_TITLE_INPUT_STYLE = -615;
    /** Key code for starting NormalKeyboard */
    public static final int KEYCODE_KEYBOARD_STYLE_NORMAL = -616;
    /** Key code for starting OnHandedKeyboard */
    public static final int KEYCODE_KEYBOARD_STYLE_ONEHANDED = -617;
    /** Key code for starting SplitKeyboard */
    public static final int KEYCODE_KEYBOARD_STYLE_SPLIT = -618;
    /** Key code for starting FloatingKeyboard */
    public static final int KEYCODE_KEYBOARD_STYLE_FLOATING = -619;
    /** Key code for line of key icon */
    public static final int KEYCODE_KEYBOARD_STYLE_LINE = -620;
    /** Key code for period */
    ...
    /** language popup index */
    private static final int LANGUAGE_POPUP_INDEX_JAPANESE = 1;
    private static final int LANGUAGE_POPUP_INDEX_ENGLISH = 2;
    private static final int LANGUAGE_POPUP_INDEX_KOREAN = 4;
    ...
    public static final int[] FUNCTION_KEYTOP_DRAWABLE_TABLE =
    {
        ...
        R.drawable.ime_keypad_func_icon_keypad,
    ...
    {
        R.drawable.ime_keypad_icon_jp_mic_popup,
        R.drawable.ime_keypad_input_icon_kbd_normal,
        R.drawable.ime_keypad_icon_jp_handwriting_popup,
    ...
    private final int[][] FUNCTION_KEY_ICON_TABLE =
    {
        ...
        {R.drawable.ime_keypad_input_icon_cliptray_normal,          R.drawable.ime_keypad_input_icon_cliptray_pressed       },
    ...
    /* language popup layout table */
    private final int[] LANGUAGE_POPUP_LAYOUT_TABLE =
    {
        R.xml.popup_changelanguage_ja,
        R.xml.popup_changelanguage_en,
        R.xml.popup_changelanguage_ja_en,
        R.xml.popup_changelanguage_ko,
        R.xml.popup_changelanguage_ja_ko,
        R.xml.popup_changelanguage_en_ko,
        R.xml.popup_changelanguage_ja_en_ko,
    };
...
//// OSK MOD end
    ...
    public void setKeyboard(Keyboard keyboard) {
        ...
        if ((keyboard.getXmlLayoutResId() == R.xml.popup_mail_kddi)
    ...
    private void onBufferDraw() {
        ...
        // To camouflage portrait orientation, framework load resources for portrait orientation.
        ...
        int oldOrientation = config.orientation;
        if (mKeyboard != null) {
            if (isFloatingLandscape
                    && (mKeyboard.getXmlLayoutResId() != R.xml.popup_mail_kddi)
                    && (mKeyboard.getXmlLayoutResId() != R.xml.popup_url)) {
                // Except mail / url list, bacause it is too long to show in short side of display.
        ...
        for (int i = 0; i < keyCount; i++) {
            ...
            if (key.pressed) {
                if((key.codes[0] != KEYCODE_POPUP_TITLE_INPUT_LANGUAGE)
                        && (key.codes[0] != KEYCODE_POPUP_TITLE_INPUT_STYLE)){
                    if (keyskin.isValid()) {
                        int color = keyskin.getKeyPressedTextColor();
                        if (color != 0) {
                            mKeyPressedTextColor = color;
            ...
            } else if ((key.codes[0] == KEYCODE_POPUP_TITLE_INPUT_LANGUAGE) ||
                    (key.codes[0] == KEYCODE_POPUP_TITLE_INPUT_STYLE)) {
                if (i != 0) {
                    if (keyskin.isValid()) {
                        keyBackground = keyskin.getDrawable(
                                R.drawable.editor_btn_effect_character_title_mid);
                    } else {
                        keyBackground = r.getDrawable(
                                R.drawable.editor_btn_effect_character_title_mid);
                    }
                } else {
                    if (keyskin.isValid()) {
                        keyBackground = keyskin.getDrawable(
                                R.drawable.editor_btn_effect_character_title_top);
                    } else {
                        keyBackground = r.getDrawable(
                                R.drawable.editor_btn_effect_character_title_top);
                    }
            ...
            if ((label != null)
                ...
                if ((mKeyboard.getXmlLayoutResId() != R.xml.keyboard_popup_num_symbol_template)
                        ...
                        && (mKeyboard.getXmlLayoutResId() != R.xml.popup_changelanguage_ja)
                        && (mKeyboard.getXmlLayoutResId() != R.xml.popup_changelanguage_en)
                        && (mKeyboard.getXmlLayoutResId() != R.xml.popup_changelanguage_ja_en)
                        && (mKeyboard.getXmlLayoutResId() != R.xml.popup_changelanguage_ko)
                        && (mKeyboard.getXmlLayoutResId() != R.xml.popup_changelanguage_ja_ko)
                        && (mKeyboard.getXmlLayoutResId() != R.xml.popup_changelanguage_en_ko)
                        && (mKeyboard.getXmlLayoutResId() != R.xml.popup_changelanguage_ja_en_ko)) {
                    ...
                    if (mOneHandedShown) {
                        ...
                        textSize = r.getDimensionPixelSize(R.dimen.key_floating_qwerty_text_size);
                    }
                }

                if ((mKeyboard.getXmlLayoutResId() == R.xml.popup_mail_kddi)
                        || (mKeyboard.getXmlLayoutResId() == R.xml.popup_url)) {
                ...
                // In the case of the enter key of a floating keyboard.
                if (isFloatingShown
                        && (key.codes[0] == DefaultSoftKeyboard.KEYCODE_QWERTY_ENTER)) {
                    // In the case of the field of url or e-mail.
                    if ((mKeyboard.getXmlLayoutResId()
                                    == R.xml.keyboard_qwerty_jp_half_alphabet_url)
                            || (mKeyboard.getXmlLayoutResId()
                            ...
                            || (mKeyboard.getXmlLayoutResId()
                                    == R.xml.keyboard_qwerty_jp_half_alphabet_mail)
                            || (mKeyboard.getXmlLayoutResId()
                                    == R.xml.keyboard_qwerty_jp_half_alphabet_shift_mail)) {
                        textSize = r.getDimensionPixelSize(R.dimen.key_floating_com_enter_text_size_qwerty);
                    } else {
                        textSize = r.getDimensionPixelSize(R.dimen.key_floating_enter_text_size_qwerty);
                    }
                }
                ...
                if ((mKeyboard.getXmlLayoutResId() == R.xml.popup_mail_kddi)
                    ...
                    if ((mKeyboard.getXmlLayoutResId() == R.xml.keyboard_popup_num_symbol_template)
                        ...
                        if (key.pressed && key.codes[0] != DefaultSoftKeyboard.KEYCODE_QWERTY_ENTER) {
                            if (!keyskin.isValid()) {
                                paint.setColor(r.getColor(R.color.key_10key_text_color_pressed));
                            } else {
                                paint.setColor(keyskin.getColor(
                ...
                for (int j=0; j<KEYCODE_FUNCTION_MAX; j++) {
                    if (FUNCTION_KEY_CONVERT_TABLE[j][0] == key.codes[0]) {
                        ...
                        if (KEYCODE_FUNCTION_KEYBOARDTYPE == key.codes[0]) {
                            if (       mKeyboard.getXmlLayoutResId() == R.xml.keyboard_functionkey_preview_unable_qwerty
                ...
                if ((mKeyboard.getXmlLayoutResId() == R.xml.keyboard_12key_phone)
                    ...
                    if (keyskin.isValid()) {
                        ...
                        if (KeyboardSkinData.KEYBOARD_THEME_PACKAGENAME_LOVELY.endsWith(
                            ...
                            key.iconPreview = keyskin.getDrawable(
                                    (int)R.drawable.ime_keypad_icon_jp_setting_popup);
                        }
                    } else {
                        key.icon = r.getDrawable(R.drawable.ime_keypad_icon_jp_setting);
                        key.iconPreview = r.getDrawable((int)R.drawable.ime_keypad_icon_jp_setting_popup);
                    }
                    if (key.iconPreview != null) {
                        key.iconPreview.setBounds(0, 0,
                                key.iconPreview.getIntrinsicWidth(),
                ...
                if (mKeyboard.getXmlLayoutResId() == R.xml.keyboard_12key_phone_shift) {
                    if (KEYCODE_PHONEKEYBOARD_SPACE == key.codes[0]) {
                        if (keyskin.isValid()) {
                            ...
                            if (key.pressed) {
                                key.icon = r.getDrawable(R.drawable.ime_keypad_icon_jp_space_blk_pressed);
                            } else {
                                key.icon = r.getDrawable(R.drawable.ime_keypad_icon_jp_space_blk);
                            }
                            key.iconPreview = r.getDrawable(
                                    (int)R.drawable.ime_keypad_icon_jp_space_blk_popup);
                        }
                        if (key.iconPreview != null) {
                            key.iconPreview.setBounds(0, 0,
                                    key.iconPreview.getIntrinsicWidth(),
                ...
                if ((mKeyboard.getXmlLayoutResId() != R.xml.popup_changelanguage_ja)
                        && (mKeyboard.getXmlLayoutResId() != R.xml.popup_changelanguage_en)
                        && (mKeyboard.getXmlLayoutResId() != R.xml.popup_changelanguage_ja_en)
                        && (mKeyboard.getXmlLayoutResId() != R.xml.popup_changelanguage_ko)
                        && (mKeyboard.getXmlLayoutResId() != R.xml.popup_changelanguage_ja_ko)
                ...
                if (key.keyIconId >= KEY_ID_QWERTY_NUM_SYMBOL_Q && key.keyIconId <= KEY_ID_QWERTY_NUM_SYMBOL_M) {
                    ...
                    if (mOneHandedShown) {
                        ...
                        paint.setTextSize(r.getDimensionPixelSize(R.dimen.key_floating_qwerty_text_size));
                    } else {
                    ...
                    if (key.pressed) {
                        paint.setColor(keyskin.getColor(
                                OpenWnn.getContext(), R.color.key_text_color_main_pressed));
                    } else {
                        paint.setColor(keyskin.getColor(
                                OpenWnn.getContext(), R.color.key_qwerty_text_color));
                    }
        ...
        // Restore camouflaged orientation.
        if (isFloatingLandscape) {
            config.orientation = oldOrientation;
            r.updateConfiguration(config, dm);
        }
    }
    ...
    private void showKey(final int keyIndex) {
        ...
        boolean isFloatingShown =
                InputMethodBase.mOriginalInputMethodSwitcher.mInputMethodBase.isNotExpandedFloatingMode();
        ...
        if (((key.icon != null) && !isQwertyEiji)
            ...
            } else if ((mKeyboardType == DefaultSoftKeyboard.KEYBOARD_12KEY)
                    && (res.getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT)
                    && (keyboard.getKeyMode() == DefaultSoftKeyboard.KEYMODE_JA_FULL_NUMBER
                        || keyboard.getKeyMode() == DefaultSoftKeyboard.KEYMODE_JA_HALF_NUMBER)) {
                if (!isFloatingShown) {
                    // Adjusting vertical alignment of key preview on numeric 12key normal keyboard.
                    top = res.getDimensionPixelSize(R.dimen.key_preview_text_padding_vgap);
                }
            } else {
                top = res.getDimensionPixelSize(R.dimen.preview_icon_padding_top);
                bottom = res.getDimensionPixelSize(R.dimen.preview_iconpreview_padding_bottom);
                if (isFloatingShown) {
                    if ((mKeyboardType == DefaultSoftKeyboard.KEYBOARD_12KEY)
                            && ((key.edgeFlags & Keyboard.EDGE_LEFT) == 0)
                            && ((key.edgeFlags & Keyboard.EDGE_RIGHT) == 0)) {
                        // Adjusting vertical alignment of key preview on 12key floating keyboard except left and right column(only 3 middle columns).
                        int floatingBottomAdjust = res.getDimensionPixelSize(R.dimen.preview_icon_padding_floating_edge_bottom_adjust);
                        bottom += floatingBottomAdjust;
                    }
                }
            }
        ...
        if (isFloatingShown) {
            ...
            if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
                mPopupPreviewX += sharedPref.getInt(
                        InputMethodBase.FLOATING_POPUP_X_PORT_KEY,
                        getResources().getDimensionPixelSize(
                                R.dimen.floating_keyboard_default_pos_x));
                mPopupPreviewY += sharedPref.getInt(
                        InputMethodBase.FLOATING_POPUP_Y_PORT_KEY,
                        getResources().getDimensionPixelSize(
                                R.dimen.floating_keyboard_default_pos_y));
            } else {
                mPopupPreviewX += sharedPref.getInt(
                        InputMethodBase.FLOATING_POPUP_X_LAND_KEY,
                        getResources().getDimensionPixelSize(
                                R.dimen.floating_keyboard_default_pos_x));
                mPopupPreviewY += sharedPref.getInt(
                        InputMethodBase.FLOATING_POPUP_Y_LAND_KEY,
                        getResources().getDimensionPixelSize(
                                R.dimen.floating_keyboard_default_pos_y));
            }
        }
        ...
        if (previewPopup.isShowing()) {
            ...
            try {
                View parentView;
                if (InputMethodBase.mOriginalInputMethodSwitcher.mInputMethodBase.isNotExpandedFloatingMode()) {
                    parentView = InputMethodBase.mOriginalInputMethodSwitcher.mInputMethodBase.getFloatingPopupParent();
                } else {
                    parentView = mPopupParent;
                }

                previewPopup.showAtLocation(parentView, Gravity.NO_GRAVITY,
    ...
    protected boolean onLongPress(Key popupKey) {
        ...
        if ((mPopupKeyboardId != 0) && (mPopupKeyboardId != DUMMY_POPUP_RESID)) {
            mMiniKeyboardContainer = mMiniKeyboardCache.get(popupKey);
            Resources r = getContext().getResources();

            // In floating mode, camouflaging orientation to portrait at Keyboard() constructor in this method.
            // So, whole url / mail list is too long to show on floating keyboard in landscape orientation(short side of display).
            // Thus, calling setForceFloatingPortrait(false) cancels to camouflage orientation at Keyboard() constructor.
            boolean isFloatingLandscape =
                    InputMethodBase.mOriginalInputMethodSwitcher.mInputMethodBase.isFloatingLandscape();
            boolean isForceFloatingPortrait = false;
            if (isFloatingLandscape
                    && ((mPopupKeyboardId != R.xml.popup_mail_kddi)
                    || (mPopupKeyboardId != R.xml.popup_url)
                    )) {
                isForceFloatingPortrait = true;
            }
            InputMethodBase.mOriginalInputMethodSwitcher.mInputMethodBase.setForceFloatingPortrait(isForceFloatingPortrait);
            ...
            if(mPopupKeyboardId == R.xml.popup_changelanguage) {
                ...
                boolean enableJa = pref.getBoolean(
                        ControlPanelStandard.INPUT_LANGUAGE_JA_KEY,
                        r.getBoolean(R.bool.input_language_ja_default_value));
                boolean enableEn = pref.getBoolean(
                        ControlPanelStandard.INPUT_LANGUAGE_EN_KEY,
                        r.getBoolean(R.bool.input_language_en_default_value));
                boolean enableKo = pref.getBoolean(
                        ControlPanelStandard.INPUT_LANGUAGE_KO_KEY,
                        r.getBoolean(R.bool.input_language_ko_default_value));
                int popupIndex = 0;

                if (enableJa) {
                    popupIndex |= LANGUAGE_POPUP_INDEX_JAPANESE;
                }
                if (enableEn) {
                    popupIndex |= LANGUAGE_POPUP_INDEX_ENGLISH;
                }
                if (enableKo) {
                    popupIndex |= LANGUAGE_POPUP_INDEX_KOREAN;
                }
                ...
                if(wnn != null ) {
                    ...
                    mPopupKeyboardId = LANGUAGE_POPUP_LAYOUT_TABLE[popupIndex-1];
                }
            }
            ...
            if (mMiniKeyboardContainer == null || isFunctionResId(mPopupKeyboardId)) {
                ...
                if (popupKey.codes[0] == KEYCODE_COM_EMAIL ||
                    ...
                    popup_view_padding_bottom = r.getDimensionPixelSize(R.dimen.popup_view_padding_function_bottom);
                     ...
                     || popupKey.codes[0] == DefaultSoftKeyboardJAJP.KEYCODE_NUM_MOJI) {
                    popup_view_padding_top = r.getDimensionPixelSize(R.dimen.popup_view_padding_change_language_top);
                    popup_view_padding_right = 0;
                    popup_view_padding_left = 0;
                    popup_view_padding_bottom = r.getDimensionPixelSize(R.dimen.popup_view_padding_change_language_bottom);
                ...
                mMiniKeyboard.setOnKeyboardActionListener(new OnKeyboardActionListener() {
                    public void onKey(int primaryCode, int[] keyCodes) {
                        if ((KEYCODE_POPUP_TITLE_INPUT_LANGUAGE != primaryCode)
                                && (KEYCODE_POPUP_TITLE_INPUT_STYLE != primaryCode)
                                && (KEYCODE_KEYBOARD_STYLE_LINE != primaryCode)) {
                ...
                if (popupKey.popupCharacters != null) {
                    ...
                    int modeId = 0;
                    // set modeId for input language pop-up.
                    for (int i = 0; i < LANGUAGE_POPUP_LAYOUT_TABLE.length; i++) {
                        if (mPopupKeyboardId == LANGUAGE_POPUP_LAYOUT_TABLE[i]) {
                            if (InputMethodBase.mOriginalInputMethodSwitcher.mInputMethodBase
                                    .isSplitViewMode()) {
                                modeId = R.id.keyboard_style_fl;
                                if (r.getConfiguration().orientation
                                        == Configuration.ORIENTATION_PORTRAIT) {
                                    if (mEnableOneHanded) {
                                        modeId = R.id.keyboard_style_oh_fl;
                                    }
                                } else {
                                    if (mEnableSplit) {
                                        modeId = R.id.keyboard_style_sp_fl;
                                    }
                                }
                            } else {
                                if (r.getConfiguration().orientation
                                        == Configuration.ORIENTATION_PORTRAIT) {
                                    if (mEnableOneHanded) {
                                        modeId = R.id.keyboard_style_oh;
                                    }
                                } else {
                                    if (mEnableSplit) {
                                        modeId = R.id.keyboard_style_sp;
                                    }
                                }
                            }
                            break;
                    ...
                    keyboard = new Keyboard(getContext(), mPopupKeyboardId, modeId);
                }
            ...
            if (popupKey.codes[0] == KEYCODE_COM_EMAIL) {
                ...
                boolean enableOneHanded = pref.getBoolean("one_handed", res.getBoolean(
                        R.bool.one_handed_default_value));
                boolean enableSplit = pref.getBoolean("split_mode", res.getBoolean(
                        R.bool.split_mode_default_value));
                boolean isSplitViewMode = InputMethodBase.mOriginalInputMethodSwitcher
                        .mInputMethodBase.isSplitViewMode();
                boolean orientationPortrait = (res.getConfiguration().orientation
                        == Configuration.ORIENTATION_PORTRAIT);
                mChangeLangDialogOnScreen = true;
                popup_width = r.getDimensionPixelSize(R.dimen.popup_change_language_width);
                if (mPopupKeyboardId == R.xml.popup_changelanguage_ja
                        || mPopupKeyboardId == R.xml.popup_changelanguage_en
                        || mPopupKeyboardId == R.xml.popup_changelanguage_ko) {
                    popup_height = r.getDimensionPixelSize(R.dimen.popup_change_language_height)
                            - r.getDimensionPixelSize(R.dimen.popup_change_language_key_height) * 2;
                } else if (mPopupKeyboardId == R.xml.popup_changelanguage_ja_en
                        || mPopupKeyboardId == R.xml.popup_changelanguage_ja_ko
                        || mPopupKeyboardId == R.xml.popup_changelanguage_en_ko) {
                    popup_height = r.getDimensionPixelSize(R.dimen.popup_change_language_height)
                            - r.getDimensionPixelSize(R.dimen.popup_change_language_key_height);
                } else {
                    popup_height = r.getDimensionPixelSize(R.dimen.popup_change_language_height);
                }
                // If show the icon of the Keyboard style,
                // add the height of the input language for pop-up.
                boolean isShowKeyboardIcon = isSplitViewMode;
                if (!isShowKeyboardIcon) {
                    if (orientationPortrait) {
                        isShowKeyboardIcon = enableOneHanded;
                    } else {
                        isShowKeyboardIcon = enableSplit;
                    }
                }
                if (isShowKeyboardIcon) {
                    popup_height += r.getDimensionPixelSize(
                                    R.dimen.popup_change_language_key_height) * 2
                            + r.getDimensionPixelSize(
                                    R.dimen.popup_change_style_row_icon_vertical_gap)
                            + r.getDimensionPixelSize(
                                    R.dimen.popup_change_style_row_mid_title_vertical_gap);
                }
                popup_x = (int) getX() + popupKey.x
                        + getPaddingLeft()
                        + r.getDimensionPixelSize(R.dimen.popup_function_left_x_gap);
            ...
            if (isFloatingShown) {
                ...
                if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
                    popup_x += sharedPref.getInt(
                            InputMethodBase.FLOATING_POPUP_X_PORT_KEY, getResources().
                            getDimensionPixelSize(R.dimen.floating_keyboard_default_pos_x));
                    popup_y += (getResources().getDimensionPixelSize(R.dimen.popup_floating_offset_y)
                            - sharedPref.getInt(InputMethodBase.FLOATING_POPUP_Y_PORT_KEY,
                              getResources().getDimensionPixelSize(R.dimen.floating_keyboard_default_pos_y)));
                } else {
                    popup_x += sharedPref.getInt(
                            InputMethodBase.FLOATING_POPUP_X_LAND_KEY, getResources().
                            getDimensionPixelSize(R.dimen.floating_keyboard_default_pos_x));
                    popup_y += (getResources().getDimensionPixelSize(R.dimen.popup_floating_offset_y)
                            - sharedPref.getInt(InputMethodBase.FLOATING_POPUP_Y_LAND_KEY,
                              getResources().getDimensionPixelSize(R.dimen.floating_keyboard_default_pos_y)));
                }
            }

            mPopupKeyboard.showAtLocation(parentView, Gravity.LEFT | Gravity.BOTTOM,
                    popup_x, popup_y);
            ...
            // Restore forcing portrait orientation.
            if (isForceFloatingPortrait) {
                InputMethodBase.mOriginalInputMethodSwitcher.mInputMethodBase.setForceFloatingPortrait(false);
            }
    ...
    /**
     * Get the key pressed state of MiniKeyboard.
     *
     * @param Key icon id.
     * @return Whether the key is pressed.
     */
    public boolean isMiniKeyboardPressed(int id){
        if( mMiniKeyboard != null) {
            Keyboard miniKb = mMiniKeyboard.getKeyboard();
            List<Key> keys = miniKb.getKeys();

            for (int i = 0; i < keys.size(); i++) {
                if (keys.get(i).keyIconId == id) {
    ...
    /**
     * Sets the current keyboard type.
     *
     * @param keyboardType The current keyboard type.
     */
