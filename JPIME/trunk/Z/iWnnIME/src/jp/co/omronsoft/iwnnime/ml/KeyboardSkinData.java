...
public class KeyboardSkinData {
    ...
    private static final HashMap<Integer, String> RESOURCEID_KEYSTRING_TABLE = new HashMap<Integer, String>() {{
        ...
        put(R.drawable.ime_keypad_input_icon_cliptray_normal, "ime_keypad_input_icon_cliptray_normal");
        put(R.drawable.ime_keypad_input_icon_cliptray_pressed, "ime_keypad_input_icon_cliptray_pressed");
        ...
        put(R.drawable.ime_keypad_icon_input_extention, "ime_keypad_icon_input_extention");
        put(R.drawable.ime_keypad_icon_input_extention_small, "ime_keypad_icon_input_extention_small");
        put(R.drawable.ime_keypad_icon_jp_input_extention, "ime_keypad_icon_jp_input_extention");
