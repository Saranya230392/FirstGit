...
public class Keyboard {
    ...
    public Keyboard(Context context, int xmlLayoutResId, int modeId) {
        ...
        // And height of keys on floating keyboard is calculated by display width in landscape orientation(long side).
        ...
        // Restore camouflaged orientation and display width / height.
        if (isFloatingLandscape) {
            int old = mDisplayWidth;
    ...
    public Keyboard(Context context, int xmlLayoutResId, float scaleWidth, int modeId) {
        ...
        if (isFloatingShown) {
            mDisplayWidth = res.getDimensionPixelSize(R.dimen.floating_keyboard_width)
                    - res.getDimensionPixelSize(R.dimen.floating_keyboard_padding_left)
                    - res.getDimensionPixelSize(R.dimen.floating_keyboard_padding_right);
            if (mOrientation == Configuration.ORIENTATION_LANDSCAPE) {
                mOrientation = Configuration.ORIENTATION_PORTRAIT;
            }
        }
    ...
    private void parseKeyboardAttributes(Resources res, XmlResourceParser parser) {
        ...
        if (isFloatingShown && (mXmlLayoutResId != R.xml.popup_mail_kddi)
            ...
            Resources mainRes = mContext.getResources();
            mDefaultHeight = mainRes.getDimensionPixelSize(R.dimen.floating_key_height);
            mDefaultVerticalGap = mainRes.getDimensionPixelSize(R.dimen.floating_keyboard_vertical_gap);
        }
        ...
        if ((mXmlLayoutResId != R.xml.popup_mail_kddi)
            ...
            if (mXmlLayoutResId == R.xml.keyboard_4key) {
                if (isFloatingShown) {
                    Resources mainRes = mContext.getResources();
                    mDefaultHeight = mainRes.getDimensionPixelSize(R.dimen.floating_key_height_4key);
                    mDefaultWidth = mainRes.getDimensionPixelSize(R.dimen.floating_key_width_4key);
                    mDefaultVerticalGap = 0;
                    mDefaultHorizontalGap = 0;
                } else {
    ...
    /**
     * Gets the scale of keyboard width.
     *
     * @return The scale of keyboard width.
     */
