...
//// OSK MOD end
    ...
    private void onBufferDraw() {
        ...
        for (int i = 0; i < keyCount; i++) {
            ...
            if (!key.showPreview && (key.label != null && key.label.toString().equals(" "))) {
                ...
                if (keyskin.isValid()) {
                    keyBackground = keyskin.getDrawable(R.drawable.editor_btn_effect_character_title_top);
                } else {
                    keyBackground = r.getDrawable(R.drawable.editor_btn_effect_character_title_top);
                }
            } else {
            ...
            if ((label != null)
                ...
                if (key.keyIconId >= KEY_ID_QWERTY_NUM_SYMBOL_Q && key.keyIconId <= KEY_ID_QWERTY_NUM_SYMBOL_M) {
                    ...
                    if (key.pressed) {
                        paint.setColor(keyskin.getColor(OpenWnn.getContext(), R.color.key_text_color_main_pressed));
                    } else {
    ...
    private void showKey(final int keyIndex) {
        ...
        if (isFloatingShown) {
            //add method
            //if candidate view is shown, mPopupPreviewY += candidate height.
        ...
        if (previewPopup.isShowing()) {
            ...
            try {
                View parentView;
                if (InputMethodBase.mOriginalInputMethodSwitcher.mInputMethodBase.getFloatingPopupParent() != null) {
    ...
    protected boolean onLongPress(Key popupKey) {
        ...
        if (mPopupKeyboardId != 0) {
            ...
            if (mMiniKeyboardContainer == null || isFunctionResId(mPopupKeyboardId)) {
                ...
                if (mPopupKeyboardId == R.xml.keyboard_functionkey_preview_ko) {
                    if (!mEnableVoiceInput) {
                        ...
                        } else if (res.getConfiguration().orientation
                                == Configuration.ORIENTATION_PORTRAIT) {
                            if (!mEnableOneHanded) {
                                mPopupKeyboardId = R.xml.keyboard_functionkey_preview_ko_unable_voice_keyboard;
            ...
            boolean oneHandedShown  = false;
            boolean isFloatingShown = InputMethodBase.mOriginalInputMethodSwitcher.mInputMethodBase.isNotExpandedFloatingMode();
            if(OpenWnn.getCurrentIme() != null) {
                DefaultSoftKeyboard keyboard = (DefaultSoftKeyboard)OpenWnn.getCurrentIme().mInputViewManager;
                if (keyboard instanceof DefaultSoftKeyboard) {
                    oneHandedShown = ((DefaultSoftKeyboard)keyboard).isOneHandedMode();
                }
            }
            int oneHandedKeyOffsetY = 0;
            if (oneHandedShown || isFloatingShown) {
                SharedPreferences pref =
                        PreferenceManager.getDefaultSharedPreferences(getContext());
                String oneHandedPosition = pref.getString("one_handed_position",
                        r.getString(R.string.one_handed_position_default_value));
                if (oneHandedPosition.equals(DefaultSoftKeyboard.ONEHANDED_POSITION_TOP_RIGHT)
                        || oneHandedPosition.equals(DefaultSoftKeyboard.ONEHANDED_POSITION_TOP_LEFT)) {
                    oneHandedKeyOffsetY =
                            r.getDimensionPixelSize(R.dimen.one_handed_keybord_view_height);
                }
            }
            ...
            if (popupKey.codes[0] == KEYCODE_COM_EMAIL) {
                ...
                if (mKeyboardType != KEYBOARD_QWERTY) {
                    popup_offset_y = r.getDimensionPixelSize(R.dimen.popup_function_offset_y);
                    if (mEnableOneHanded || isFloatingShown) {
            ...
            if (isFloatingShown) {
                //add method
                //if candidate view is shown, popup_y -= candidate height.
                SharedPreferences sharedPref = PreferenceManager
                        .getDefaultSharedPreferences(getContext());
                if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
                    ...
                    popup_y += (370 - 420)
                            + (730 - sharedPref.getInt(
                                    InputMethodBase.FLOATING_POPUP_Y_PORT_KEY, getResources().
                    ...
                    popup_x += sharedPref.getInt(
                            ...
                            getDimensionPixelSize(R.dimen.floating_keyboard_default_pos_x));
                    popup_y += (280 - 420)
                            + (330 - sharedPref.getInt(
                                    InputMethodBase.FLOATING_POPUP_Y_LAND_KEY, getResources().
                                    getDimensionPixelSize(R.dimen.floating_keyboard_default_pos_y)));
                }
            }
