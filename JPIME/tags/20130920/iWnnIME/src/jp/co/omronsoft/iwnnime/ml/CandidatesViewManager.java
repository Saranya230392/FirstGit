...
public abstract class CandidatesViewManager {
    ...
    protected void displayDialog(View view, final WnnWord word) {
        if ((view instanceof CandidateTextView) && (null != mViewLongPressDialog)) {
            ...
            mainlayout.setBackground(res.getDrawable((int) R.drawable.ime_popup_jp_full_holo));
            ...
            int left = res.getDimensionPixelSize(R.dimen.candidate_longpress_dialog_button_layout_padding_left);
            int right = res.getDimensionPixelSize(R.dimen.candidate_longpress_dialog_button_layout_padding_right);
            int bottom = res.getDimensionPixelSize(R.dimen.candidate_longpress_dialog_button_layout_padding_bottom);
            mViewLongPressDialog.setPadding(left, 0, right, bottom);
            ...
            if (mWnn.isNotExpandedFloatingMode()) {
                mDialog.getWindow().getAttributes().token = mWnn.getFloatingPopupParent().getWindowToken();
            } else {
