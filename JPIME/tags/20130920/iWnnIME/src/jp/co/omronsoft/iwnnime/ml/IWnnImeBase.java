...
public class IWnnImeBase {
    ...
    public boolean setCandidatesView(View view) {
        if (mWnnSwitcher.isSplitViewMode()) {
            View floatingKeyboard = mWnnSwitcher.getFloatingContentView();
            if (floatingKeyboard != null) {
                LinearLayout candidateArea = (LinearLayout)floatingKeyboard.findViewById(R.id.candidate_area);
   ...
   public boolean setCandidatesViewShown(boolean shown) {
    ...
    public void showFloating() {
        if (mWnnSwitcher.isSplitViewMode() && (mWnnSwitcher.getApplicationContext().getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE)) {
