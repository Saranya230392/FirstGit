...
public class KeyboardSkinData {
    ...
    private static final HashMap<Integer, String> RESOURCEID_KEYSTRING_TABLE = new HashMap<Integer, String>() {{
        ...
        put(R.drawable.ime_keypad_handwriting_icon_sym, "ime_keypad_handwriting_icon_sym_popup");
        ...
        put(R.drawable.ime_keypad_icon_del, "ime_keypad_icon_del_popup");
        ...
        put(R.drawable.ime_keypad_icon_enter, "ime_keypad_icon_enter_popup");
        ...
        put(R.drawable.ime_keypad_icon_left, "ime_keypad_icon_left_popup");
        ...
        put(R.drawable.key_12key_space_off, "key_12key_space_off");
