...
///////////////// iwnn_trial_add_2
   ...
   /** Alphabet-last pattern */
    ...
    private static final String OPT_ENABLE_LEARNING_EN_KEY = "opt_enable_learning_en";

    /** Key of "English Word Prediction" setting. **/
    private static final String OPT_PREDICTION_EN_KEY = "opt_prediction_en";

    /** Key of "English Wildcard Prediction" setting. **/
    private static final String OPT_FUNFUN_EN_KEY = "opt_funfun_en";
    ...
    private static final String OPT_SPELL_CORRECTION_EN_KEY = "opt_spell_correction_en";
...
///////////////// iwnn_trial_add_3
    ...
    private void updateComposingText(WnnWord word) {
        ...
        StrSegment segment = new StrSegment(word.candidate, 0, word.stroke.length() - 1);
    ...
    private void changeEngineMode(int mode) {
        ...
        case OpenWnnEvent.Mode.NO_LV1_CONV:
            ...
            mEnableFunfun = pref.getBoolean(OPT_FUNFUN_EN_KEY, res.getBoolean(R.bool.opt_funfun_en_default_value));
            mEnableLearning   = pref.getBoolean(OPT_ENABLE_LEARNING_EN_KEY, res.getBoolean(R.bool.opt_enable_learning_en_default_value));
            mEnablePrediction = pref.getBoolean(OPT_PREDICTION_EN_KEY, res.getBoolean(R.bool.opt_prediction_en_default_value));
            mEnableSpellCorrection = pref.getBoolean(OPT_SPELL_CORRECTION_EN_KEY, res.getBoolean(R.bool.opt_spell_correction_en_default_value));
        ...
        default:
            ...
            mEnableFunfun = pref.getBoolean(OPT_FUNFUN_JA_KEY, res.getBoolean(R.bool.opt_funfun_ja_default_value));
            mEnableLearning   = pref.getBoolean(OPT_ENABLE_LEARNING_JA_KEY, res.getBoolean(R.bool.opt_enable_learning_ja_default_value));
            mEnablePrediction = pref.getBoolean(OPT_PREDICTION_JA_KEY, res.getBoolean(R.bool.opt_prediction_ja_default_value));
            mEnableSpellCorrection = pref.getBoolean(OPT_SPELL_CORRECTION_JA_KEY, res.getBoolean(R.bool.opt_spell_correction_ja_default_value));
    ...
    private void updateEngineState(EngineState state) {
        ...
        if (state.keyboard != EngineState.INVALID) {
            ...
            default:
                ...
                SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(OpenWnn.superGetContext());
                Resources res = getResources();
                if (myState.language == EngineState.LANGUAGE_JP) {
                    mEnableSpellCorrection = pref.getBoolean(OPT_SPELL_CORRECTION_JA_KEY, res.getBoolean(R.bool.opt_spell_correction_ja_default_value));
                }else{
                    mEnableSpellCorrection = pref.getBoolean(OPT_SPELL_CORRECTION_EN_KEY, res.getBoolean(R.bool.opt_spell_correction_en_default_value));
                }
    ...
    private void fitInputType(SharedPreferences preference, EditorInfo info) {
        ...
        if(keymode == DefaultSoftKeyboardJAJP.KEYMODE_JA_HALF_ALPHABET){
            mEnableFunfun = preference.getBoolean(OPT_FUNFUN_EN_KEY, res.getBoolean(R.bool.opt_funfun_en_default_value));
            mEnableLearning   = preference.getBoolean(OPT_ENABLE_LEARNING_EN_KEY, res.getBoolean(R.bool.opt_enable_learning_en_default_value));
            mEnablePrediction = preference.getBoolean(OPT_PREDICTION_EN_KEY, res.getBoolean(R.bool.opt_prediction_en_default_value));
            mEnableSpellCorrection = preference.getBoolean(OPT_SPELL_CORRECTION_EN_KEY, res.getBoolean(R.bool.opt_spell_correction_en_default_value));
        } else {
            mEnableFunfun = preference.getBoolean(OPT_FUNFUN_JA_KEY, res.getBoolean(R.bool.opt_funfun_ja_default_value));
            mEnableLearning   = preference.getBoolean(OPT_ENABLE_LEARNING_JA_KEY, res.getBoolean(R.bool.opt_enable_learning_ja_default_value));
            mEnablePrediction = preference.getBoolean(OPT_PREDICTION_JA_KEY, res.getBoolean(R.bool.opt_prediction_ja_default_value));
            mEnableSpellCorrection = preference.getBoolean(OPT_SPELL_CORRECTION_JA_KEY, res.getBoolean(R.bool.opt_spell_correction_ja_default_value));
        }
        ...
        if (bundle != null) {
            ...
            if (assist != null) {
                ...
                if (functype != 0) {
                    ...
                    mWnnSwitcher.setEmojiType(emojitype);
                }
            }
        }
        setEmojiFlag();
    ...
    @Override protected void commitMushRoomString() {
        ...
        if (mMushroomResultString != null && getInputConnection() != null && pm.isScreenOn() && !isScreenLock) {
            if (!mMushroomResultString.equals("")) {
                ...
                //check selected any words before.
                if ((mEditorSelectionStart == mEditorSelectionEnd) && (mEditorSelectionStart <= 0)) {
