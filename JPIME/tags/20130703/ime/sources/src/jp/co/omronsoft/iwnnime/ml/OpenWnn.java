...
public class OpenWnn extends InputMethodBase {
    ...
    */
    ...
    @Override public void onCreate() {
        ...
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(OpenWnn.superGetContext()); // DEBUG
    ...
    private boolean mIsFullScreenChanged = false;
...
//            Object object = f.get(this);
    ...
    private int getPreferenceId() {
        return getIntFromNotResetSettingsPreference(OpenWnn.superGetContext(), DecoEmojiListener.PREF_KEY, -1);
    }
