...
public class Keyboard {
    ...
    /** Line image row index of change language popup. */
    private static int ROW_INDEX_CHANGE_LANGUAGE_POPUP_LINE_IMAGE = 1;
    ...
    public static class Key {
        ...
        /** Sub characters */
        public CharSequence subCharacters;
        /** Key Hint characters */
        ...
        /** Whether this key is line image key */
        public boolean isLineImageKey;
        ...
        public Key(Resources res, Row parent, int x, int y, XmlResourceParser parser) {
            ...
            subCharacters = getText(a,
                    R.styleable.WnnKeyboardView_subCharacters);
            ...
            isLineImageKey = a.getBoolean(R.styleable.WnnKeyboardView_isLineImage, false);
                ...
                while ((event = parser.next()) != XmlResourceParser.END_DOCUMENT) {
                    if (event == XmlResourceParser.START_TAG) {
                        ...
                        if (TAG_ROW.equals(tag)) {
                            ...
                            if ((mXmlLayoutResId == R.xml.popup_changelanguage)
                                    || (mXmlLayoutResId == R.xml.popup_changelanguage_unable_ko)) {
                                if (row == ROW_INDEX_CHANGE_LANGUAGE_POPUP_LINE_IMAGE) {
                                    currentRow.defaultHeight = res.getDimensionPixelSize(R.dimen.popup_change_language_key_height_line);
                                }
                            }
    ...
    private void parseKeyboardAttributes(Resources res, XmlResourceParser parser) {
        ...
        if (mOneHandedShown && (mXmlLayoutResId != R.xml.popup_mail)
                            ...
                            && (mXmlLayoutResId != R.xml.popup_changelanguage)
                            && (mXmlLayoutResId != R.xml.popup_changelanguage_unable_ko)) {
            Resources mainRes = mContext.getResources();
        ...
        if ((mXmlLayoutResId != R.xml.popup_mail)
                && (mXmlLayoutResId != R.xml.popup_url)
                && (mXmlLayoutResId != R.xml.popup_period_en)
                && (mXmlLayoutResId != R.xml.popup_period_en_full)
                && (mXmlLayoutResId != R.xml.popup_period_ja)
        ...
        mDefaultHeight = mDefaultHeight - (mDefaultVerticalGap * (Keyline - 1)) / Keyline;
        if (Keyline == KEY_LINE_5_KEYBOARD) {
