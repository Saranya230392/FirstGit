...
public class KeyboardView extends View implements View.OnClickListener {
    ...
    public interface OnKeyboardActionListener {
         ...
         * @param text the sequence of characters to be displayed.
         */
        void onSubCharacter(CharSequence text);
...
//// OSK MOD end
    ...
    private final int[] FUNCTION_KEYTOP_DRAWABLE_TABLE =
    {
        R.drawable.ime_keypad_icon_mic,
        R.drawable.ime_keypad_icon_kbd,
        R.drawable.ime_keypad_icon_handwriting,
        R.drawable.ime_keypad_icon_setting
    };
    private final int[] FUNCTION_KEYTOP_DRAWABLE_TABLE_JP =
    {
        R.drawable.ime_keypad_icon_jp_mic,
        R.drawable.ime_keypad_icon_jp_kbd,
        R.drawable.ime_keypad_icon_jp_handwriting,
        R.drawable.ime_keypad_icon_setting
    };
    private final int[] FUNCTION_KEYTOP_DRAWABLE_TABLE_SMALL =
    {
        R.drawable.ime_keypad_icon_mic_small,
        R.drawable.ime_keypad_icon_kbd_small,
    ...
    {
        R.drawable.ime_keypad_icon_jp_mic_normal,
        R.drawable.ime_keypad_input_icon_kbd_normal,
        R.drawable.ime_keypad_icon_jp_handwriting_normal,
    ...
    protected boolean mEnableVoiceInput = false;
    ...
    /** whether long press */
    private boolean mIsKeyLongPressed = false;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_REPEAT:
                    ...
                    break;
                case MSG_LONGPRESS:
                    mIsKeyLongPressed = true;
                    openPopupIfRequired((MotionEvent) msg.obj);
                    if ((mCurrentKey < mKeys.length)
                         && (mKeys[mCurrentKey].subCharacters != null)) {
                        mKeyboardActionListener.onSubCharacter(mKeys[mCurrentKey].subCharacters);
                    }
                    break;
...
//// OSK MOD end
    ...
    private void onBufferDraw() {
        ...
        for (int i = 0; i < keyCount; i++) {
            ...
            if(key.isPressHoldKey){
                if (keyskin.isValid()) {
                    keyBackground = key.isSecondKey ?
                            keyskin.getDrawable(R.drawable.ime_btn_func_more_normal)
                            : keyskin.getDrawable(R.drawable.ime_keypad_btn_more_normal);
                } else {
                    keyBackground = key.isSecondKey ?
                            r.getDrawable(R.drawable.ime_btn_func_more_normal)
                            : r.getDrawable(R.drawable.ime_keypad_btn_more_normal);
                }
            } else if (!key.showPreview && (key.label != null && key.label.toString().equals(" "))) {
                if (keyskin.isValid()) {
                    keyBackground = key.isSecondKey ?
                            keyskin.getDrawable(R.drawable.ime_btn_func_normal) : keyskin.getDrawable(R.drawable.ime_keypad_btn_normal);
                } else {
                    keyBackground = key.isSecondKey ?
                            r.getDrawable(R.drawable.ime_btn_func_normal) : r.getDrawable(R.drawable.ime_keypad_btn_normal);
                }
            ...
            if ((label != null)
                ...
                if ((mKeyboard.getXmlLayoutResId() == R.xml.popup_mail)
                    ...
                    if (isPeriodPopupWindow(mKeyboard.getXmlLayoutResId())) {
                        if (key.pressed) {
                            paint.setColor(keyskin.getColor(
                                    OpenWnn.getContext(), R.color.popup_text_color_press));
                        } else {
                ...
                if (DefaultSoftKeyboard.KEYCODE_FUNCTION_KEY == key.codes[0]) {
                    if(keyskin.isValid()){
                        if (isSmall) {
                            key.icon = keyskin.getDrawable(FUNCTION_KEYTOP_DRAWABLE_TABLE_SMALL[functionIndex]);
                        } else if (isQwerty) {
                            key.icon = keyskin.getDrawable(FUNCTION_KEYTOP_DRAWABLE_TABLE[functionIndex]);
                        } else {
                            key.icon = keyskin.getDrawable(FUNCTION_KEYTOP_DRAWABLE_TABLE_JP[functionIndex]);
                        }
                        key.iconPreview = keyskin.getDrawable(FUNCTION_PREVIEW_DRAWABLE_TABLE[functionIndex]);
                    }else{
                        if (isSmall) {
                            key.icon = r.getDrawable(FUNCTION_KEYTOP_DRAWABLE_TABLE_SMALL[functionIndex]);
                        } else if (isQwerty) {
                            key.icon = r.getDrawable(FUNCTION_KEYTOP_DRAWABLE_TABLE[functionIndex]);
                        } else {
                            key.icon = r.getDrawable(FUNCTION_KEYTOP_DRAWABLE_TABLE_JP[functionIndex]);
                        }
                        key.iconPreview = r.getDrawable(FUNCTION_PREVIEW_DRAWABLE_TABLE[functionIndex]);
                    }
                ...
                if (DefaultSoftKeyboard.KEYCODE_JP12_LEFT == key.codes[0]) {
                    if (isSmall) {
                        if(keyskin.isValid()){
                            key.icon = keyskin.getDrawable((int)R.drawable.ime_keypad_icon_left_small);
                        } else {
                            key.icon = r.getDrawable(R.drawable.ime_keypad_icon_left_small);
                        }
                        if(key.iconPreview != null){
                            key.iconPreview.setBounds(0, 0,
                                key.iconPreview.getIntrinsicWidth(),
                ...
                if ((mKeyboard.getXmlLayoutResId() == R.xml.keyboard_12key_phone)
                    ...
                    if(keyskin.isValid()){
                        ...
                        key.iconPreview = keyskin.getDrawable((int)R.drawable.ime_keypad_icon_jp_setting);
                    } else {
                ...
                if (mKeyboard.getXmlLayoutResId() == R.xml.keyboard_12key_phone_shift) {
                    if (KEYCODE_PHONEKEYBOARD_SPACE == key.codes[0]) {
                        if(keyskin.isValid()){
                            ...
                            key.iconPreview = keyskin.getDrawable((int)R.drawable.ime_keypad_icon_jp_space_blk);
                        } else {
                            key.icon = r.getDrawable(R.drawable.ime_keypad_icon_jp_space_blk);
                            key.iconPreview = r.getDrawable((int)R.drawable.ime_keypad_icon_jp_space_blk);
                        }
                        if(key.iconPreview != null){
                            key.iconPreview.setBounds(0, 0,
                                key.iconPreview.getIntrinsicWidth(),
    ...
    private void detectAndSendKey(int index, int x, int y, long eventTime) {
        if (index != NOT_A_KEY && index < mKeys.length) {
            ...
            } else if (mIsKeyLongPressed && key.subCharacters != null) {
                mKeyboardActionListener.onRelease(NOT_A_KEY);
            } else {
    ...
    private void showKey(final int keyIndex) {
        ...
        if (key.codes[0] == DefaultSoftKeyboard.KEYCODE_JP12_EMOJI ||
        ...
        if (mKeyboardType == KEYBOARD_QWERTY) {
            mPopupPreviewY -= res.getDimensionPixelSize(R.dimen.preview_offset_popup_qwerty_top);
        }
        ...
        if ((key.popupResId == 0) ||
                (key.codes != null && key.codes[0] ==  DefaultSoftKeyboard.KEYCODE_JP12_LEFT)) {
            if ((key.edgeFlags & Keyboard.EDGE_LEFT) > 0) {
                if ((mPopupPreviewX - mOffsetInWindow[0]) < previewOffset) {
                    mPopupPreviewX = mOffsetInWindow[0] + previewOffset;
                }
            } else if ((key.edgeFlags & Keyboard.EDGE_RIGHT) > 0) {
                if ((mPopupPreviewX + popupWidth) > (mOffsetInWindow[0] + getWidth() - previewOffset)) {
                    mPopupPreviewX = mOffsetInWindow[0] + getWidth() - popupWidth - previewOffset;
                }
            } else {
            ...
            if (key.icon != null) {
                if( key.codes[0] == DefaultSoftKeyboard.KEYCODE_FUNCTION_KEY ){
                    mPreviewText.setPadding(
                            ...
                            res.getDimensionPixelSize(R.dimen.preview_icon_padding_right),
                            res.getDimensionPixelSize(R.dimen.preview_icon_functionkey_padding_bottom));
                }else{
                    mPreviewText.setPadding(
                            res.getDimensionPixelSize(R.dimen.preview_icon_padding_left),
                            res.getDimensionPixelSize(R.dimen.preview_icon_padding_top),
        ...
        if (mPopupKeyboardId != 0) {
            ...
            if (mMiniKeyboardContainer == null) {
                ...
                mMiniKeyboard.setOnKeyboardActionListener(new OnKeyboardActionListener() {
                    ...
                    public void onSubCharacter(CharSequence text) {}
                    ...
                    if (!mEnableVoiceInput) {
                        if (mKeyboardType == KEYBOARD_QWERTY) {
                            if (res.getConfiguration().orientation
                                    == Configuration.ORIENTATION_PORTRAIT) {
                                if (!mEnableOneHanded) {
                                    mPopupKeyboardId = R.xml.keyboard_functionkey_preview_unable_voice_keyboard;
                                } else if (mNormalShown && mOneHandedShown) {
                            ...
                            if (res.getConfiguration().orientation
                                ...
                                if (!mEnableOneHanded) {
                                    mPopupKeyboardId =
                                            R.xml.keyboard_functionkey_preview_unable_keyboard;
                                } else if(mNormalShown && mOneHandedShown) {
                        ...
                        if (mKeyboardType == KEYBOARD_QWERTY) {
                            if (res.getConfiguration().orientation
                                    == Configuration.ORIENTATION_PORTRAIT) {
                                if (!mEnableOneHanded) {
                                    mPopupKeyboardId = R.xml.keyboard_functionkey_preview_unable_keyboard;
                                } else if (mNormalShown && mOneHandedShown) {
                                    mPopupKeyboardId =
                            ...
                            if (res.getConfiguration().orientation
                                ...
                                if (!mEnableOneHanded) {
                                    ...
                                    mPopupKeyboardId = R.xml.keyboard_functionkey_preview;
                                }
                            } else {
                                if (!mEnableSplit) {
                                    mPopupKeyboardId = R.xml.keyboard_functionkey_preview_unable_keyboard;
            ...
            if (popupKey.codes[0] == KEYCODE_COM_EMAIL) {
                ...
                if (mKeyboardType == KEYBOARD_QWERTY) {
                    if (getResources().getConfiguration().orientation
                            == Configuration.ORIENTATION_LANDSCAPE) {
                        popup_x = r.getDimensionPixelSize(R.dimen.popup_qwerty_mail_x);
                    } else {
                        popup_x = (int) getX() + popupKey.x + (popupKey.width  / 2)
                                - (popup_width / 2);
                    }
                } else {
                    popup_x = (int) getX() + mKeyboard.getMinWidth() - popup_width
                            + r.getDimensionPixelSize(R.dimen.popup_offset_x);
                    keynum = 2;
                }
                ...
                if (mKeyboardType == KEYBOARD_QWERTY) {
                    if (getResources().getConfiguration().orientation
                            == Configuration.ORIENTATION_LANDSCAPE) {
                        popup_x = r.getDimensionPixelSize(R.dimen.popup_qwerty_url_x);
                    } else {
                        popup_x = (int) getX() + popupKey.x + (popupKey.width  / 2)
                                - (popup_width / 2);
                    }
                ...
                popup_x = (int) getX() + popupKey.x + (popupKey.width  / 2) - (popup_width / 2);
            } else if (popupKey.codes[0] == KEYCODE_FUNCTION_POPUP){
                ...
                popup_x = (int) getX() + r.getDimensionPixelSize(R.dimen.popup_offset_x);
            } else {
            ...
            mPopupKeyboard.showAtLocation(this, Gravity.LEFT | Gravity.BOTTOM, popup_x,
                    (popupKey.height * keynum) + popup_offset_y);
