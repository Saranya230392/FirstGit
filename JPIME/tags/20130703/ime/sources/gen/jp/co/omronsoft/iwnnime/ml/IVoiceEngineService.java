 ...
 * Original file: D:\\model\\iWnnIME\\Env\\snapshot_src_for_lg\\ime\\sources\\src\\jp\\co\\omronsoft\\iwnnime\\ml\\IVoiceEngineService.aidl
 */
package jp.co.omronsoft.iwnnime.ml;
/**
 * iWnnEngine Service.
 */
public interface IVoiceEngineService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements jp.co.omronsoft.iwnnime.ml.IVoiceEngineService
{
private static final java.lang.String DESCRIPTOR = "jp.co.omronsoft.iwnnime.ml.IVoiceEngineService";
...
/**
 * Cast an IBinder object into an jp.co.omronsoft.iwnnime.ml.IVoiceEngineService interface,
 * generating a proxy if needed.
 */
public static jp.co.omronsoft.iwnnime.ml.IVoiceEngineService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof jp.co.omronsoft.iwnnime.ml.IVoiceEngineService))) {
return ((jp.co.omronsoft.iwnnime.ml.IVoiceEngineService)iin);
}
return new jp.co.omronsoft.iwnnime.ml.IVoiceEngineService.Stub.Proxy(obj);
}
...
private static class Proxy implements jp.co.omronsoft.iwnnime.ml.IVoiceEngineService
{
