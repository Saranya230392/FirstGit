...
import com.lge.emoji.BaseEmojiKeyboard;
...
public class InputMethodSwitcher extends InputMethodService {
    ...
    public boolean mHwEmojiPaletteMode = false;
    ...
    public static final int IME_TYPE_EMOJIPALLETE = 4;
    ...
    public void changeInputMethod( int mode ) {
        ...
        if ( mode == IME_TYPE_IWNNIME && mHwEmojiPaletteMode) {
            mode = IME_TYPE_HANDWRITING;
        }

        mSymbolMode = false;
        mHwEmojiPaletteMode = false;
        ...
        switch (mode) {
            ...
            case IME_TYPE_NAVIGATION:
               ...
               ((IWnnLanguageSwitcher)mInputMethodBase).mInputConnection = getCurrentInputConnection();
                ...
                break;
            case IME_TYPE_EMOJIPALLETE:
                if (DEBUG) {Log.d("InputMethodSwitcher", "change emojipallete.");}
                if (mInputMethodBase instanceof BaseHandwritingKeyboard) {
                    mHwEmojiPaletteMode = true;
                }
                mInputMethodBase = new BaseEmojiKeyboard(this);
                break;
            default:
