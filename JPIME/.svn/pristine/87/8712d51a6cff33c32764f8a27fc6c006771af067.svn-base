/**
 * @file
 *   辞書アダプタ：統合辞書(ストレージ辞書)アダプタ
 *
 *   統合辞書フォーマット(ストレージ辞書)へのアクセス関数を提供する
 *
 * @author
...
/*              define  宣  言                  */
/************************************************/
#define NJ_SDIC_EXT_MAX_SIZE         0x78          /**< 統合辞書(ストレージ辞書)拡張情報最大サイズ */
#define NJ_OFFSET_DIC_TYPE           0x08          /**< 辞書データ先頭から共通データ：辞書タイプまでのバイトオフセット */
#define NJ_MASK_STORAGE_DIC_TYPE     0x40000000    /**< ストレージ辞書タイプのビットマスク */

#define GET_STORAGE_CACHE_YOMI_INDEX(h) ((NJ_UINT8*)(((NJ_STORAGE_DIC_INFO*)(h))->cache_area[NJ_SDIC_STORAGE_YOMI_INDEX]))
#define GET_STORAGE_CACHE_TUNAGARI_INDEX(h) ((NJ_UINT8*)(((NJ_STORAGE_DIC_INFO*)(h))->cache_area[NJ_SDIC_STORAGE_TUNAGARI_INDEX]))
#define GET_STORAGE_CACHE_HINSI_NO(h) ((NJ_UINT8*)(((NJ_STORAGE_DIC_INFO*)(h))->cache_area[NJ_SDIC_STORAGE_HINSI_NO]))
#define GET_STORAGE_CACHE_REAL_ZOKUSEI(h) ((NJ_UINT8*)(((NJ_STORAGE_DIC_INFO*)(h))->cache_area[NJ_SDIC_STORAGE_REAL_ZOKUSEI]))
#define GET_STORAGE_CACHE_ZOKUSEI(h) ((NJ_UINT8*)(((NJ_STORAGE_DIC_INFO*)(h))->cache_area[NJ_SDIC_STORAGE_ZOKUSEI]))
#define GET_STORAGE_CACHE_TUNAGARI(h) ((NJ_UINT8*)(((NJ_STORAGE_DIC_INFO*)(h))->cache_area[NJ_SDIC_STORAGE_TUNAGARI]))
#define GET_STORAGE_CACHE_HINDO(h) ((NJ_UINT8*)(((NJ_STORAGE_DIC_INFO*)(h))->cache_area[NJ_SDIC_STORAGE_HINDO]))
#define WORD_TOP_OFFSET(h) ((NJ_UINT32)NJ_INT32_READ((h) + 0x20))
#define YOMI_HYOKI_TOP_OFFSET(h) ((NJ_UINT32)NJ_INT32_READ((h) + 0x24))
#define HINDO_TOP_OFFSET(h) ((NJ_UINT32)NJ_INT32_READ((h) + 0x28))
#define TSUNAGARI_TOP_OFFSET(h) ((NJ_UINT32)NJ_INT32_READ((h) + 0x2C))
#define YOMI_IDX_AREA_TOP_OFFSET(h) ((NJ_UINT32)NJ_INT32_READ((h) + 0x30))
#define TSUNAGARI_IDX_AREA_TOP_OFFSET(h) ((NJ_UINT32)NJ_INT32_READ((h) + 0x34))
#define HYOKI_IDX_AREA_TOP_OFFSET(h) ((NJ_UINT32)NJ_INT32_READ((h) + 0x38))
#define ZOKUSEI_AREA_TOP_OFFSET(h) ((NJ_UINT32)NJ_INT32_READ((h) + 0x3C))
#define HINSI_NO_AREA_TOP_OFFSET(h) ((NJ_UINT32)NJ_INT32_READ((h) + 0x44))
#define REAL_ZOKUSEI_AREA_TOP_OFFSET(h) ((NJ_UINT32)NJ_INT32_READ((h) + 0x64))
#define GET_WORD_DATA_AREA_SIZE(h)  (NJ_GET_DIC_TYPE((h)) == NJ_DIC_TYPE_FUSION_HIGH_COMPRESS_STORAGE)    \
                                    ? WORD_DATA_HIGH_COMPRESS_AREA_SIZE                                 \
                                    : WORD_DATA_AREA_SIZE
#define WORD_DATA_OFFSET_HIGH_COMPRESS(h,x) (((h) + (NJ_UINT32)(((x) - 1) * WORD_DATA_HIGH_COMPRESS_AREA_SIZE)))
#define WORD_DATA_OFFSET(h,x) (((h) + (NJ_UINT32)(((x) - 1) * WORD_DATA_AREA_SIZE)))
#define WORD_TOP_ADDR(h) ((NJ_UINT8*)((h) + WORD_TOP_OFFSET((h))))
#define YOMI_HYOKI_TOP_ADDR(h) ((NJ_UINT8*)((h) + YOMI_HYOKI_TOP_OFFSET((h))))
#define HINDO_TOP_ADDR(h) ((NJ_UINT8*)((h) + HINDO_TOP_OFFSET((h))))
#define TSUNAGARI_TOP_ADDR(h) ((NJ_UINT8*)((h) + TSUNAGARI_TOP_OFFSET((h))))
#define YOMI_IDX_AREA_TOP_ADDR(h) ((NJ_UINT8*)((h) + YOMI_IDX_AREA_TOP_OFFSET((h))))
#define TSUNAGARI_IDX_AREA_TOP_ADDR(h) ((NJ_UINT8*)((h) + TSUNAGARI_IDX_AREA_TOP_OFFSET((h))))
#define HYOKI_IDX_AREA_TOP_ADDR(h) ((NJ_UINT8*)((h) + HYOKI_IDX_AREA_TOP_OFFSET((h))))
#define ZOKUSEI_AREA_TOP_ADDR(h) ((NJ_UINT8*)((h) + ZOKUSEI_AREA_TOP_OFFSET((h))))
#define ZOKUSEI_AREA_SIZE(h) ((NJ_INT32)(NJ_INT32_READ((h) + 0x40)))
#define HINSI_NO_AREA_TOP_ADDR(h) ((NJ_UINT8*)((h) + HINSI_NO_AREA_TOP_OFFSET((h))))
...
#define REAL_ZOKUSEI_AREA_TOP_ADDR(h) ((NJ_UINT8*)((h) + REAL_ZOKUSEI_AREA_TOP_OFFSET((h))))
...
#define GET_STORAGE_CACHE_JITU_MOJI(h) ((NJ_UINT8*)(((NJ_STORAGE_DIC_INFO*)(h))->cache_area[NJ_SDIC_STORAGE_JITU_MOJI]))
#define JITU_MOJI_HENKAN_DATA_AREA_TOP_OFFSET(h) ((NJ_UINT32)NJ_INT32_READ((h) + 0x70))
#define JITU_MOJI_HENKAN_DATA_AREA_TOP_ADDR(h) ((NJ_UINT8*)((h) + JITU_MOJI_HENKAN_DATA_AREA_TOP_OFFSET((h))))
...
#define STEM_TERMINATOR_STORAGE(x) ((NJ_UINT8)(0x80 & (x)))
...
#define WORD_DATA_ADDR_HIGH_COMPRESS(h,x) (WORD_DATA_OFFSET_HIGH_COMPRESS((h), (x)))
#define WORD_DATA_ADDR(h,x) (WORD_DATA_OFFSET((h), (x)))
...
#define HYOKI_INDEX_OFFSET(x,y) ((NJ_UINT32)((x) + (NJ_UINT32)(((y) - 1) * 0x04)))
...
#define WORD_DATA_OFFSET_FROM_DIC_TYPE(h,x,d)   (!(h) ? WORD_DATA_OFFSET_HIGH_COMPRESS((x),(d)) : WORD_DATA_OFFSET((x),(d)))
...
static NJ_INT16 search_node_rev_ext(NJ_SEARCH_CONDITION *condition, NJ_SEARCH_LOCATION_SET *loctset);
...
static NJ_INT16 sdic_search_data(NJ_CLASS *iwnn, NJ_SEARCH_CONDITION *condition, NJ_SEARCH_LOCATION_SET *loctset);
static NJ_INT16 sdic_search_data_fore(NJ_CLASS *iwnn, NJ_SEARCH_CONDITION *condition, NJ_SEARCH_LOCATION_SET *loctset, NJ_UINT16 dic_idx);
static NJ_INT16 sdic_search_data_rev(NJ_CLASS *iwnn, NJ_SEARCH_CONDITION *condition, NJ_SEARCH_LOCATION_SET *loctset);
static NJ_INT16 sdic_search_data_rev_ext(NJ_SEARCH_CONDITION *condition, NJ_SEARCH_LOCATION_SET *loctset);
static NJ_INT16 sdic_search_data_yominashi(NJ_CLASS *iwnn, NJ_SEARCH_CONDITION *condition, NJ_SEARCH_LOCATION_SET *loctset, NJ_UINT16 hidx);
...
static NJ_INT16 search_node_rev_aimai(NJ_CLASS *iwnn, NJ_SEARCH_CONDITION *condition, NJ_SEARCH_LOCATION_SET *loctset,
                                      NJ_UINT16 hidx);
static NJ_INT16 search_node_rev_aimai_ext(NJ_SEARCH_CONDITION *condition, NJ_SEARCH_LOCATION_SET *loctset,
                                          NJ_UINT16 hidx);
static NJ_INT16 sdic_search_data_fore_aimai(NJ_CLASS *iwnn, NJ_SEARCH_CONDITION *condition,
                                            NJ_SEARCH_LOCATION_SET *loctset, NJ_UINT16 hidx);
static NJ_INT16 sdic_search_data_rev_aimai(NJ_CLASS *iwnn, NJ_SEARCH_CONDITION *condition,
                                           NJ_SEARCH_LOCATION_SET *loctset, NJ_UINT16 hidx);
static NJ_INT16 sdic_search_data_rev_aimai_ext(NJ_SEARCH_CONDITION *condition,
                                               NJ_SEARCH_LOCATION_SET *loctset, NJ_UINT16 hidx);
...
static NJ_INT16 search_rev_idx_ext(NJ_SEARCH_LOCATION_SET *loctset, NJ_SEARCH_CONDITION *condition, 
                                   NJ_CHAR  *hyoki, NJ_UINT16 hyokilen, 
                                   NJ_UINT32 hyoki_top, NJ_UINT32 hyoki_bottom, 
                                   NJ_UINT16 startpos, NJ_UINT32 *topno, NJ_UINT32 *bottomno);
static NJ_INT32 sdic_get_next_data(NJ_CLASS *iwnn, NJ_SEARCH_LOCATION_SET *loctset,
                                   NJ_SEARCH_CACHE *psrhCache, NJ_UINT16 abIdx, NJ_UINT16 yomi_len,
                                   NJ_UINT16 dic_idx, NJ_UINT8 mode);
static NJ_INT32 sdic_get_next_data_rev(NJ_SEARCH_LOCATION_SET *loctset,
                                       NJ_SEARCH_CACHE *psrhCache,
                                       NJ_UINT16 abIdx);
static NJ_INT32 sdic_get_next_data_rev_ext(NJ_SEARCH_LOCATION_SET *loctset,
                                           NJ_SEARCH_CACHE *psrhCache,
                                           NJ_UINT16 abIdx);
static NJ_INT32 sdic_get_next_data_fore_ext(NJ_CLASS *iwnn,
                                            NJ_SEARCH_CONDITION *condition,
                                            NJ_SEARCH_LOCATION_SET *loctset,
                                            NJ_SEARCH_CACHE *psrhCache,
                                            NJ_UINT16 abIdx);
static NJ_INT32 sdic_get_word_freq(NJ_CLASS *iwnn, NJ_SEARCH_LOCATION_SET *loctset,
                                   NJ_SEARCH_CACHE *psrhCache, NJ_UINT16 abIdx, NJ_UINT16 dic_idx);
static NJ_INT32 sdic_get_word_freq_rev(NJ_SEARCH_LOCATION_SET *loctset,
                                       NJ_SEARCH_CACHE *psrhCache, NJ_UINT16 abIdx);
static NJ_INT32 sdic_get_word_freq_rev_ext(NJ_SEARCH_LOCATION_SET *loctset,
                                           NJ_SEARCH_CACHE *psrhCache, NJ_UINT16 abIdx);
static NJ_INT32 sdic_get_word_freq_fore_ext(NJ_SEARCH_LOCATION_SET *loctset,
                                            NJ_SEARCH_CACHE *psrhCache, NJ_UINT16 abIdx);
...
static NJ_INT8 get_candidate_string(NJ_DIC_HANDLE handle, NJ_UINT8 *word, NJ_UINT32 dic_str_offset, NJ_CHAR* str);
...
static NJ_INT32 sdic_get_storage_dic_cache_size(NJ_CLASS *iwnn, NJ_UINT32 dictype, NJ_FILE* filestream, 
                                                NJ_UINT32 *size, NJ_UINT32 *offset, NJ_UINT32 *dic_size, NJ_UINT32 mode);
...
static NJ_INT16 is_sdic_filtering(NJ_CLASS *iwnn, NJ_SEARCH_LOCATION_SET *loctset);
 ...
 * @param[in]   dic_str_offset  辞書読み・表記データエリアへのオフセット
...
static NJ_INT8 get_candidate_string(NJ_DIC_HANDLE handle, NJ_UINT8 *word, NJ_UINT32 dic_str_offset, NJ_CHAR* str) {
    ...
    if (NJ_GET_DIC_TYPE_EX(NJ_DIC_H_TYPE_ON_STORAGE, handle) == NJ_DIC_TYPE_FUSION_HIGH_COMPRESS_STORAGE) {
        /* 高圧縮タイプ判定用 */
        is_hicomp = 0;
    }
    ...
    if (len == 0) {
        ...
        /* 表記文字列長が0の時 */
        offset = dic_str_offset + YOMI_DATA_OFFSET(word);
        len = YOMI_LEN(word);
        if (HYOKI_INFO(word) == 0) {
            /* ひらがな(読み＝表記)設定 */
            if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO *)handle, NJ_SDIC_STORAGE_YOMI_HYOKI,
                                        offset, (NJ_UINT32)(len * sizeof(NJ_CHAR)), &ptr) < 0) {
                return -1;    /* NCH_FB */
            }
            for (i = len; i > 0; i--) {
        ...
        offset = dic_str_offset + HYOKI_DATA_OFFSET_FROM_DIC_TYPE(is_hicomp, word);
        if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO *)handle, NJ_SDIC_STORAGE_YOMI_HYOKI,
                                   offset, (NJ_UINT32)(len * sizeof(NJ_CHAR)), &ptr) < 0) {
            return -1;    /* NCH_FB */
        }
...
static NJ_UINT8 is_funfun_ok(NJ_DIC_HANDLE handle, NJ_UINT32 word_id, NJ_UINT8 clen_min, NJ_UINT8 clen_max) {
    ...
    /* 単語データのアドレス */
    offset = WORD_DATA_OFFSET(WORD_TOP_OFFSET(GET_STORAGE_CACHE_HEAD(handle)), word_id);

    /* ストレージデータから単語データの読み部分の読み込みを行う */
    if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)handle, NJ_SDIC_STORAGE_WORD_DATA,
                               offset, WORD_DATA_YOMI_DATA_SIZE, &word_data) < 0) {
        return 0;    /* NCH_FB */
    }
    ...
    if (clen_min >= 4) {
        ...
        /* 読み文字列の先頭ポインタ */
        offset  = YOMI_HYOKI_TOP_OFFSET(GET_STORAGE_CACHE_HEAD(handle)) + YOMI_DATA_OFFSET(word_data);

        /* ストレージデータから単語データの読み部分の読み込みを行う */
        if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)handle, NJ_SDIC_STORAGE_YOMI_HYOKI,
                                   offset, (yomi_len * sizeof(NJ_CHAR)), &yomi_ptr) < 0) {
            return 0;    /* NCH_FB */
        }
...
static NJ_UINT8 is_funfun_ok_high_compress(NJ_DIC_HANDLE handle, NJ_UINT32 word_id, NJ_UINT8 clen_min, NJ_UINT8 clen_max) {
    ...
    /* 単語データのアドレス */
    offset = WORD_DATA_OFFSET_HIGH_COMPRESS(WORD_TOP_OFFSET(GET_STORAGE_CACHE_HEAD(handle)), word_id);
...
static NJ_UINT8 is_funfun_ok_ext(NJ_DIC_HANDLE handle, NJ_UINT32 word_id, NJ_UINT8 clen_min, NJ_UINT8 clen_max) {
    ...
    /* 候補文字列の先頭ポインタ */
    offset = YOMI_HYOKI_TOP_OFFSET(GET_STORAGE_CACHE_HEAD(handle)) + HYOKI_DATA_OFFSET(word_data);
    ...
    /* ストレージデータから単語データの読み部分の読み込みを行う */
    if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)handle, NJ_SDIC_STORAGE_YOMI_HYOKI,
                               offset, (hyoki_len * sizeof(NJ_CHAR)), &hyoki_ptr) < 0) {
        return 0;    /* NCH_FB */
    }
...
static void get_stem_word(NJ_DIC_HANDLE hdl, NJ_UINT8 *stem_data, STEM_DATA_SET *stem_set, NJ_UINT8 check, NJ_UINT32 current) {
    ...
    NJ_UINT8 *head_addr;
    NJ_UINT8 *hinsi_top_addr;
    NJ_UINT32 yhtbl_offset;
    NJ_CHAR  tmp_buf[NJ_MAX_LEN + NJ_TERM_LEN];
    NJ_UINT8 is_hicomp = 1;


    /* 頻度データ領域の先頭アドレスを取得 */
    htbl_top = GET_STORAGE_CACHE_HINDO(hdl);

    if (NJ_GET_DIC_TYPE_EX(NJ_DIC_H_TYPE_ON_STORAGE, hdl) == NJ_DIC_TYPE_FUSION_HIGH_COMPRESS_STORAGE) {
        /* 高圧縮タイプ判定用 */
        is_hicomp = 0;
    }
    ...
    default:
        /*
         * 頻度取得は上位側(njd_s_get_word)で行っている為、
         * ここでは何も処理しないものとする
         */
        break;
    }
    ...
    /* 各キャッシュ領域の情報を格納 */
    head_addr = GET_STORAGE_CACHE_HEAD(hdl);
    hinsi_top_addr = GET_STORAGE_CACHE_HINSI_NO(hdl);

    data = HINSI_DATA_FROM_DIC_TYPE(is_hicomp, stem_data);
    if (BIT_FHINSI(head_addr)) {
        /* 前品詞 設定 */
        stem_set->fhinsi = GET_BITFIELD_16(data, 0, BIT_FHINSI(head_addr));
    } else {
        stem_set->fhinsi = 0; /*NCH*/
    }

    /* 品詞番号変換用テーブルの該当位置 */
    fb = FHINSI_NO_BYTE(head_addr);
    wkc = (hinsi_top_addr + (NJ_UINT32)(fb * stem_set->fhinsi));
    ...
    if (BIT_BHINSI(head_addr)) {
        /* 後品詞 設定 */
        stem_set->bhinsi = GET_BITFIELD_16(data, BIT_FHINSI(head_addr), BIT_BHINSI(head_addr));
    } else {
        stem_set->bhinsi = 0; /*NCH*/
    }
    /* 実品詞への変換：品詞番号変換用テーブルの該当位置 */
    bb = BHINSI_NO_BYTE(head_addr);
    wkc = (hinsi_top_addr
           + (NJ_UINT32)((fb * (FHINSI_NO_CNT(head_addr))) + (bb * stem_set->bhinsi)));
    /* 品詞番号設定 */
    if (bb == 2) {
    ...
    /* 表記長／読み文字列長を取得 */
    if (!is_hicomp) {
        yhtbl_offset = YOMI_HYOKI_TOP_OFFSET(head_addr) + YOMI_DATA_OFFSET(stem_data);

        if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)hdl, NJ_SDIC_STORAGE_YOMI_HYOKI,
                                   yhtbl_offset, YOMI_LEN_BYTE(stem_data), &wkc) < 0) {
            stem_set->candidate_len = YOMI_LEN_BYTE(stem_data); /* NCH_FB */
            stem_set->yomi_len = YOMI_LEN_BYTE(stem_data);      /* NCH_FB */
        } else {
...
static void get_stem_cand_data(NJ_DIC_HANDLE hdl, NJ_UINT8 *stem_data, STEM_DATA_SET *stem_set) {
    ...
    /* 表記長 設定 */
    if (!is_hicomp) {
        yhtbl_offset = YOMI_HYOKI_TOP_OFFSET(GET_STORAGE_CACHE_HEAD(hdl)) + YOMI_DATA_OFFSET(stem_data);
...
static NJ_UINT16 get_stem_yomi_string(NJ_DIC_HANDLE hdl, NJ_UINT8 *stem_data, NJ_CHAR *yomi, NJ_UINT16 yomi_len, NJ_UINT16 size) {
    ...
    /* 読みのオフセットを取得 */
    offset = YOMI_HYOKI_TOP_OFFSET(GET_STORAGE_CACHE_HEAD(hdl)) + YOMI_DATA_OFFSET(stem_data);

    /* 読み文字列を取得 */
    if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)hdl, NJ_SDIC_STORAGE_YOMI_HYOKI,
                               offset, (NJ_UINT32)(yomi_len * sizeof(NJ_CHAR)), &data) < 0) {
        /*
         * ファイルポインタから読み込み出来ない場合
         * バッファサイズよりも長い文字列長を返し、上位関数にてエラーと判断してもらう
         */
...
static void get_jitu_hinsi_no(NJ_DIC_HANDLE handle, NJ_UINT8 *word_data, NJ_UINT16 *fhinsi_jitu, NJ_UINT16 *bhinsi_jitu) {
    ...
    /* 各キャッシュ領域の情報を格納 */
    head_addr = GET_STORAGE_CACHE_HEAD(handle);
    hinsi_top_addr = GET_STORAGE_CACHE_HINSI_NO(handle);

    data = HINSI_DATA_FROM_DIC_TYPE(is_hicomp, word_data);
    if (BIT_FHINSI(head_addr)) {
        /* 前品詞 設定 */
        fhinsi = GET_BITFIELD_16(data, 0, BIT_FHINSI(head_addr));
    } else {
        fhinsi = 0; /*NCH*/
    }
    ...
    /* 品詞番号変換用テーブルの該当位置 */
    fb = FHINSI_NO_BYTE(head_addr);
    wkc = (hinsi_top_addr + (NJ_UINT32)(fb * fhinsi));
    ...
    if (BIT_BHINSI(head_addr)) {
        /* 後品詞 設定 */
        bhinsi = GET_BITFIELD_16(data, BIT_FHINSI(head_addr), BIT_BHINSI(head_addr));
    } else {
        bhinsi = 0; /*NCH*/
    }
    /* 実品詞への変換：品詞番号変換用テーブルの該当位置 */
    bb = BHINSI_NO_BYTE(head_addr);
    wkc = (hinsi_top_addr
           + (NJ_UINT32)((fb * (FHINSI_NO_CNT(head_addr))) + (bb * bhinsi)));
    /* 品詞番号設定 */
    if (bb == 2) {
...
/**
 * 正引き完全一致,正引き前方一致検索の時、統合辞書(ストレージ辞書)から検索条件（読み）に該当する単語を検索し、該当する候補データの情報を取得
 *
...
static NJ_INT16 search_node(NJ_CLASS *iwnn, NJ_SEARCH_CONDITION *condition,
    ...
    /* 各キャッシュ領域の情報を格納 */
    head_addr = GET_STORAGE_CACHE_HEAD(loctset->loct.handle);

    if (NJ_GET_DIC_TYPE_EX(NJ_DIC_H_TYPE_ON_STORAGE, loctset->loct.handle) == NJ_DIC_TYPE_FUSION_HIGH_COMPRESS_STORAGE) {
        /* 高圧縮タイプ判定用 */
        is_hicomp = 0;
    }
    ...
    if (ylen > 0) {
        ...
        yomi_top = 1; /*NCH*/
        yomi_end = WORD_AREA_CNT(head_addr); /*NCH*/
        word_cnt = 3; /*NCH*/
    }

    /* 頻度学習値利用に必要なデータを取得する */
    if (loctset->loct.ext_area[NJ_TYPE_EXT_AREA_DEFAULT] != NULL) {
        ext_top = EXT_AREA_TOP_ADDR((NJ_UINT8 *)loctset->loct.ext_area[NJ_TYPE_EXT_AREA_DEFAULT], head_addr);
    } else {
        ext_top = NULL;
    }
    ...
    /* 読み先頭と読み終端をセット */
    cnt = yomi_top;
    hdtbl_addr = GET_STORAGE_CACHE_HINDO(loctset->loct.handle);
            ...
            while (cnt <= yomi_end) {
                ...
                if (hindo_tmp < hindo_chk) {
                    ...
                    if (iwnn->option_data.phase3_filter != NULL) {
                        ...
                        /* フィルターチェック処理を実行 */
                        if (!(is_sdic_filtering(iwnn, &tmp_loctset))) {
                            /* 候補使用なしの場合、次候補検索へ移る */
                            cnt++;
                            continue;
                        }
 ...
 */
static NJ_INT16 sdic_search_data(NJ_CLASS *iwnn, NJ_SEARCH_CONDITION *condition, NJ_SEARCH_LOCATION_SET *loctset) {
    NJ_UINT8 *hdtbl_addr;                          /* データ領域先頭アドレス */
    NJ_UINT8 *data_cur, *hindo_cur;                /* カーソル位置データアドレス */
    STEM_DATA_SET stem_set;                        /* カーソル位置データ情報 */
    NJ_UINT8 *head_addr, *hinsi_top_addr;
    NJ_UINT32 wtbl_offset, data_offset;
    NJ_UINT8 stem_terminate;
    ...
    head_addr = GET_STORAGE_CACHE_HEAD(loctset->loct.handle);
    hinsi_top_addr = GET_STORAGE_CACHE_HINSI_NO(loctset->loct.handle);
    wtbl_offset = WORD_TOP_OFFSET(head_addr);
    hdtbl_addr = GET_STORAGE_CACHE_HINDO(loctset->loct.handle);
    hindo_cur = HINDO_HENKAN_ADDR(hdtbl_addr, loctset->loct.current);

    data_offset = WORD_DATA_OFFSET_FROM_DIC_TYPE(is_hicomp, wtbl_offset, loctset->loct.current);

    if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_WORD_DATA,
                                wtbl_offset, WORD_DATA_YOMI_BYTE_SIZE, &data_cur) < 0) {
        /*
         * ファイルポインタから読み込み出来ない場合
         * 検索終了の属性を設定
         */
    ...
    stem_terminate = *data_cur;

    if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_WORD_DATA,
                               data_offset, GET_WORD_DATA_AREA_SIZE(loctset->loct.handle), &data_cur) < 0) {
        /*
         * ファイルポインタから読み込み出来ない場合
         * 検索終了の属性を設定
         */
    ...
    if (GET_LOCATION_STATUS(loctset->loct.status) != NJ_ST_SEARCH_NO_INIT) {
        ...
        data_offset = WORD_DATA_OFFSET_FROM_DIC_TYPE(is_hicomp, wtbl_offset, cnt);
        if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_WORD_DATA,
                                   data_offset, GET_WORD_DATA_AREA_SIZE(loctset->loct.handle), &data_cur) < 0) {
            /*
             * ファイルポインタから読み込み出来ない場合
        ...
        if (HINDO_HENKAN_ON(hindo_cur)) {
            ...
            if (condition->hinsi.fore != NULL) {
                if (BIT_FHINSI(head_addr)) {
                    ...
                    stem_set.fhinsi = GET_BITFIELD_16(hdata, 0, BIT_FHINSI(head_addr));
                } else {
                    stem_set.fhinsi = 0; /*NCH*/
                }
            ...
            if (condition->hinsi.rear != NULL) {
                if (BIT_BHINSI(head_addr)) {
                    /* 後品詞 設定 */
                    hdata = HINSI_DATA_FROM_DIC_TYPE(is_hicomp, data_cur);
                    stem_set.bhinsi = GET_BITFIELD_16(hdata, BIT_FHINSI(head_addr), BIT_BHINSI(head_addr));
                } else {
                    stem_set.bhinsi = 0; /*NCH*/
                }
            ...
            if (STEM_TERMINATOR_STORAGE(stem_terminate)) {
                /* 次候補無し */
 ...
 * @retval  1  検索候補あり
 */
static NJ_INT16 sdic_search_data_fore(NJ_CLASS *iwnn, NJ_SEARCH_CONDITION *condition,
                                      NJ_SEARCH_LOCATION_SET *loctset, NJ_UINT16 dic_idx) {
    NJ_UINT32 bottom;
    ...
    if (condition->mode == NJ_CUR_MODE_FREQ) {
        ...
        /* 統合辞書(ストレージ辞書)データ領域の終端を超えた場合は抜ける */
        while (cursor <= bottom) {
            ...
            if ((cursor > loctset->loct.current) && (hindo_tmp == hindo_current)) {
                ...
                if ((hindo_chk < hindo_tmp) || ((cursor < word_next) && (hindo_chk == hindo_tmp))) {
                    ...
                    if (iwnn->option_data.phase3_filter != NULL) {
                        ...
                        ret = is_sdic_filtering(iwnn, &tmp_loctset);
                    } else {
 ...
 * @param[in]      con       検索条件
 * @param[in,out]  loctset   検索位置
 * @param[in]      comp_flg  統合辞書(ストレージ辞書)の完全一致で変換補正対象の有無<br>
 *                          （1:対象、1以外:対象としない）
 * @param[in]      dic_idx   辞書インデックス番号
 *
 * @retval  <0  エラー
 ...
 * @retval   1  検索候補あり
 */
NJ_INT16 njd_s_search_word(NJ_CLASS *iwnn, NJ_SEARCH_CONDITION *con,
    ...
    case NJ_CUR_OP_COMP:
        ...
        if ((con->mode != NJ_CUR_MODE_FREQ) ||
            (con->ylen <= 0) ||
            (con->ylen > NJ_GET_MAX_YLEN(head_addr))) {
            /* 該当候補なしとする */
            loctset->loct.status = NJ_ST_SEARCH_END_EXT;
            return 0;
        }
        ...
        ret = sdic_search_data(iwnn, con, loctset);
        if (ret < 1) {
    ...
    case NJ_CUR_OP_FORE:
        ...
        if ((con->ds->dic[dic_idx].srhCache == NULL) || (con->ylen == 0) ||
            ...
            ret = sdic_search_data_fore(iwnn, con, loctset, dic_idx);
        } else {
            if (GET_LOCATION_STATUS(loctset->loct.status) == NJ_ST_SEARCH_NO_INIT) {
                /* 検索状態：未初期化 */
                ret = search_node_aimai(iwnn, con, loctset, dic_idx);
                if (ret == NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_SEARCH_WORD, NJ_ERR_CACHE_NOT_ENOUGH)) {
            ...
            ret = sdic_search_data_fore_aimai(iwnn, con, loctset, dic_idx);
        }
        if (ret < 1) {
            /* 該当候補データが無い為、検索終了の属性をカーソルに設定する */
            loctset->loct.status = NJ_ST_SEARCH_END;
    ...
    case NJ_CUR_OP_REV:
        ...
        if ((con->mode != NJ_CUR_MODE_FREQ) ||
            (con->ylen <= 0) ||
            (con->ylen > NJ_GET_MAX_KLEN(head_addr))) {
            /* 該当候補なしとする */
            loctset->loct.status = NJ_ST_SEARCH_END_EXT;
            return 0;
        }
        if (loctset->loct.ext_area[NJ_TYPE_EXT_AREA_MORPHO] != NULL) {
            /*
             * 形態素用拡張領域にデータが設定されている場合は、
             * 拡張データを優先して参照する。
             */
            if (GET_LOCATION_STATUS(loctset->loct.status) == NJ_ST_SEARCH_NO_INIT) {
                /* 検索状態：未初期化 */
                /* 表記文字列インデックスを指定された候補で検索 */
                ret = search_node_rev_ext(con, loctset);
                if (ret < 1) {
                    return ret;
                }
            }
            /* 逆引き結果を取得 */
            ret = sdic_search_data_rev_ext(con, loctset);
            if (ret < 1) {
                /* 該当候補データが無い為、検索終了の属性をカーソルに設定する */
                loctset->loct.status = NJ_ST_SEARCH_END;
            }
            ...
            /* 逆引き結果を取得 */
            ret = sdic_search_data_rev(iwnn, con, loctset);
            if (ret < 1) {
                /* 該当候補データが無い為、検索終了の属性をカーソルに設定する */
                loctset->loct.status = NJ_ST_SEARCH_END;
            }
    ...
    case NJ_CUR_OP_REV_FORE:
        ...
        if (loctset->loct.ext_area[NJ_TYPE_EXT_AREA_MORPHO] != NULL) {
            ...
            if ((con->ds->dic[dic_idx].srhCache == NULL) || (con->ylen == 0) ||
                ...
                /* あいまい検索モード時 */
                if (GET_LOCATION_STATUS(loctset->loct.status) == NJ_ST_SEARCH_NO_INIT) {
                    ret = search_node_rev_aimai_ext(con, loctset, dic_idx);
                    if (ret == NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_SEARCH_WORD, NJ_ERR_CACHE_NOT_ENOUGH)) {
                        /* キャッシュ溢れが発生した場合は、もう一度同じ関数を呼ぶ */
                        NJ_SET_CACHEOVER_TO_SCACHE(con->ds->dic[dic_idx].srhCache); /*NCH_DEF*/
                        ret = search_node_rev_aimai_ext(con, loctset, dic_idx); /*NCH_DEF*/
                    }
                    if (ret < 1) {
                        return ret;
                    }
                }
                ret = sdic_search_data_rev_aimai_ext(con, loctset, dic_idx);
            }
        } else {
            if ((con->ds->dic[dic_idx].srhCache == NULL) || (con->ylen == 0) ||
                ((con->ds->mode & NJ_CACHE_MODE_VALID_FUSION) == 0) || 
                ...
                ret = sdic_search_data_rev_aimai(iwnn, con, loctset, dic_idx);
            }
        }
        break;
    ...
    case NJ_CUR_OP_LINK:
        ...
        ret = sdic_search_data_yominashi(iwnn, con, loctset, dic_idx);
        if (ret < 1) {
            /* 該当候補データが無い為、検索終了の属性をカーソルに設定する */
            loctset->loct.status = NJ_ST_SEARCH_END;
        }
        ...
        if ((con->ds->dic[dic_idx].srhCache == NULL) || (con->ylen == 0) ||
            ...
            if (GET_LOCATION_STATUS(loctset->loct.status) == NJ_ST_SEARCH_NO_INIT) {
                ...
                if (ret == NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_SEARCH_WORD, NJ_ERR_CACHE_NOT_ENOUGH)) {
                    /* キャッシュ溢れが発生した場合は、もう一度同じ関数を呼ぶ */
                    NJ_SET_CACHEOVER_TO_SCACHE(con->ds->dic[dic_idx].srhCache); /*NCH_DEF*/
                    ret = search_node_rev_aimai(iwnn, con, loctset, dic_idx); /*NCH_DEF*/
                }
                if (ret < 1) {
                    return ret;
                }
...
/**
 * ストレージ辞書アダプタ  単語取得（※ 読み、読み長は上位で設定する）
 *
 ...
 * @retval   0  正常終了
 */
NJ_INT16 njd_s_get_word(NJ_SEARCH_LOCATION_SET *loctset, NJ_WORD *word) {
    NJ_UINT8 *data;
    ...
    NJ_UINT32 current;
    NJ_UINT32 word_offset;
    NJ_UINT8 *head_addr;
    NJ_UINT32 data_offset, hitbl_offset, hitbl_word_offset;
    ...
    /* 単語データ領域の先頭アドレスを取得 */
    head_addr = GET_STORAGE_CACHE_HEAD(loctset->loct.handle);
    word_offset = WORD_TOP_OFFSET(head_addr);
    ...
    if ((check == NJ_CUR_OP_REV) ||
        ...
        if (loctset->loct.ext_area[NJ_TYPE_EXT_AREA_MORPHO] != NULL) {
            ...
            /* 表記文字列インデックス領域の先頭アドレスを取得 */
            hitbl_offset = HYOKI_IDX_AREA_TOP_OFFSET(head_addr);
            /* 表記文字列インデックス番号から単語データ番号、頻度を取得 */
            hitbl_word_offset = HYOKI_INDEX_OFFSET(hitbl_offset, loctset->loct.current);
            if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_HYOKI_INDEX,
                                       hitbl_word_offset, HYOKI_INDEX_DATA_AREA_SIZE, &data) < 0) {
                /*
                 * ファイルポインタから読み込み出来ない場合
                 * 検索終了の属性を設定
                 */
            ...
            current = HYOKI_INDEX_WORD_NO(data);
            stem_set.hindo_jitu = (NJ_INT16)HINDO_MORPHO(data);
        }

        data_offset = WORD_DATA_OFFSET_FROM_DIC_TYPE(is_hicomp, word_offset, current);
        if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_WORD_DATA,
                                   data_offset, GET_WORD_DATA_AREA_SIZE(loctset->loct.handle), &data) < 0) {
            /*
             * ファイルポインタから読み込み出来ない場合
             * 検索終了の属性を設定
             */
        ...
        /* つながりデータ領域の先頭アドレスを取得 */
        tdtbl_addr = GET_STORAGE_CACHE_TUNAGARI(loctset->loct.handle);
    ...
    case NJ_CUR_OP_FORE_EXT:
        ...
        word->stem.info3 = (NJ_UINT8)stem_set.yomi_len;
        break;
 ...
 */
NJ_INT16 njd_s_get_candidate(NJ_WORD *word, NJ_CHAR *candidate, NJ_UINT16 size) {
    NJ_SEARCH_LOCATION *loc;
    NJ_UINT8 *data;
    NJ_INT16 len;
    STEM_DATA_SET stem_set;
    NJ_UINT32 current;
    NJ_UINT32 word_offset, hitbl_offset, hitbl_word_offset;
    NJ_UINT8 *head_addr;
    NJ_UINT8 is_hicomp = 1;
    ...
    /* 該当候補データのアドレスを取得する */
    loc = &word->stem.loc;
    head_addr = GET_STORAGE_CACHE_HEAD(loc->handle);

    if (NJ_GET_DIC_TYPE_EX(NJ_DIC_H_TYPE_ON_STORAGE, loc->handle) == NJ_DIC_TYPE_FUSION_HIGH_COMPRESS_STORAGE) {
        /* 高圧縮タイプ判定用 */
        is_hicomp = 0;
    }
    ...
    case NJ_CUR_OP_LINK:
        ...
        /* つながりデータ番号から単語データ番号、頻度を取得 */
        current = TSUNAGARI_WORD_DATA_NO(TSUNAGARI_DATA_ADDR(GET_STORAGE_CACHE_TUNAGARI(loc->handle), loc->current));
        break;
    ...
    case NJ_CUR_OP_REV_FORE:
        ...
        if (loc->ext_area[NJ_TYPE_EXT_AREA_MORPHO] != NULL) {
            ...
            hitbl_offset = HYOKI_IDX_AREA_TOP_OFFSET(head_addr);
            hitbl_word_offset = HYOKI_INDEX_OFFSET(hitbl_offset, loc->current);
            if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loc->handle, NJ_SDIC_STORAGE_HYOKI_INDEX,
                                       hitbl_word_offset, HYOKI_INDEX_DATA_AREA_SIZE, &data) < 0) {
                /* ファイルからの読み込み不可の場合 */
                return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_CANDIDATE, NJ_ERR_STREAM_READ_ERR);    /* NCH_FB */
            }
            current = HYOKI_INDEX_WORD_NO(data);
        }
        break;
    ...
    default:
        ...
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_CANDIDATE, NJ_ERR_INVALID_RESULT); /*NCH*/
    }

    /* 単語データ領域のアドレスを取得 */
    word_offset = WORD_DATA_OFFSET_FROM_DIC_TYPE(is_hicomp, WORD_TOP_OFFSET(head_addr), current);
    if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loc->handle, NJ_SDIC_STORAGE_WORD_DATA,
                               word_offset, GET_WORD_DATA_AREA_SIZE(loc->handle), &data) < 0) {
        /* ファイルからの読み込み不可の場合 */
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_CANDIDATE, NJ_ERR_STREAM_READ_ERR);    /* NCH_FB */
    }
    ...
    if (size < (NJ_UINT16)((len + NJ_TERM_LEN) * sizeof(NJ_CHAR))) {
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_CANDIDATE, NJ_ERR_BUFFER_NOT_ENOUGH); /*NCH*/
    }
    if ((len = get_candidate_string(loc->handle, data, YOMI_HYOKI_TOP_OFFSET(head_addr), candidate)) < 0) {
        /* ファイルからの読み込み不可の場合 */
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_CANDIDATE, NJ_ERR_STREAM_READ_ERR); /* NCH_FB */
    }
    return len;
 ...
 * @retval  >0  取得文字配列長(ヌル文字含まず)
 */
NJ_INT16 njd_s_get_stroke(NJ_WORD *word, NJ_CHAR *stroke, NJ_UINT16 size) {
    NJ_SEARCH_LOCATION *loc;
    NJ_UINT8 *data;
    NJ_INT16 len;
    ...
    case NJ_CUR_OP_FORE:
        ...
        if (NJ_GET_YLEN_FROM_STEM(word) == 0) {
            ...
            return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_STROKE, NJ_ERR_INVALID_RESULT); /*NCH*/
        }
        current = loc->current;
        break;
    ...
    case NJ_CUR_OP_REV_FORE:
        if (loc->ext_area[NJ_TYPE_EXT_AREA_MORPHO] != NULL) {
            ...
            if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loc->handle, NJ_SDIC_STORAGE_HYOKI_INDEX,
                                       hitbl_word_offset, HYOKI_INDEX_DATA_AREA_SIZE, &data) < 0) {
                /* ファイルからの読み込み不可の場合 */
                return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_STROKE, NJ_ERR_STREAM_READ_ERR);    /* NCH_FB */
            }
            current = HYOKI_INDEX_WORD_NO(data);
        }
        break;
    ...
    /* サイズチェック */
    if (size < (NJ_UINT16)((len + NJ_TERM_LEN) * sizeof(NJ_CHAR))) {
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_STROKE, NJ_ERR_BUFFER_NOT_ENOUGH); /*NCH*/
    }
...
/**
 * 正引き前方一致検索−あいまい予測時、ストレージ辞書から検索条件（読み）に該当する単語を検索し、該当する候補データの情報を取得
 *
 * @param[in,out]  iwnn       解析情報クラス
 * @param[in]      condition  検索条件
 * @param[in,out]  loctset    検索位置
 * @param[in]      hidx       辞書インデックス
 *
 * @retval  0  検索候補なし
 * @retval  1  検索候補あり
 */
static NJ_INT16 search_node_aimai(NJ_CLASS *iwnn, NJ_SEARCH_CONDITION *condition, NJ_SEARCH_LOCATION_SET *loctset, NJ_UINT16 hidx) {
            ...
            if (abPtrIdx == 0) {
                            ...
                            if (ret < 0) {
                                ...
                                if (ret < 0) {
                                    ...
                                    if (abIdx >= NJ_SEARCH_CACHE_SIZE) {
                                        ...
                                        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_SEARCH_WORD, NJ_ERR_CACHE_NOT_ENOUGH); /*NCH*/
                                    }
                ...
                if (psrhCache->keyPtr[abPtrIdx] == psrhCache->keyPtr[abPtrIdx - 1]) {
                    ...
                    if ((abIdx > NJ_SEARCH_CACHE_SIZE) || (abIdx_old >= NJ_SEARCH_CACHE_SIZE) ||
                        ...
                        /* キャッシュが破壊されている */
                        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_SEARCH_WORD, NJ_ERR_CACHE_BROKEN); /*NCH_FB*/
                    }
                    ...
                    for (m = abIdx_old; m < endIdx; m++) {
                        ...
                        if (ret < 0) {
                            ...
                            if (abIdx >= NJ_SEARCH_CACHE_SIZE) {
                                psrhCache->keyPtr[abPtrIdx + 1] = 0;
                                return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_SEARCH_WORD, NJ_ERR_CACHE_NOT_ENOUGH);
                            }
                                ...
                                if (nj_charncmp(key, condition->charset->from[l], 1) == 0) {
                                    ...
                                    if (ret < 0) {
                                        ...
                                        if (abIdx >= NJ_SEARCH_CACHE_SIZE) {
                                            ...
                                            return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_SEARCH_WORD, NJ_ERR_CACHE_NOT_ENOUGH); /*NCH_DEF*/
                                        }
    ...
    if ((abIdx > NJ_SEARCH_CACHE_SIZE) || (abIdx_old >= NJ_SEARCH_CACHE_SIZE)) {
        /* キャッシュが破壊されている */
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_SEARCH_WORD, NJ_ERR_CACHE_BROKEN); /*NCH*/
    }

    /* 頻度学習値利用に必要なデータを取得する */
    if (loctset->loct.ext_area[NJ_TYPE_EXT_AREA_DEFAULT] != NULL) {
        ext_top = EXT_AREA_TOP_ADDR((NJ_UINT8 *)loctset->loct.ext_area[NJ_TYPE_EXT_AREA_DEFAULT], GET_STORAGE_CACHE_HEAD(loctset->loct.handle));
    } else {
        ext_top = NULL;
    }
...
static NJ_INT16 search_hash_idx(NJ_DIC_HANDLE hdl, NJ_CHAR *yomi, NJ_INT16 ylen, NJ_UINT32 *topno, NJ_UINT32 *bottomno) {
     ...
     * ( データ登録数、先頭アドレス )
     */
    yitbl_addr = GET_STORAGE_CACHE_YOMI_INDEX(hdl);
    yitbl_cnt  = YOMI_IDX_AREA_CNT(GET_STORAGE_CACHE_HEAD(hdl));
    char_tmp   = yitbl_addr;
...
static NJ_INT16 search_word_no(NJ_DIC_HANDLE hdl, NJ_VOID *ext_area, NJ_UINT8 mode,
    ...
    NJ_INT16 diff;
    NJ_UINT8 *head_addr;
    NJ_UINT32 wdtbl_offset;                 /* 単語データ領域操作用 */
    NJ_UINT32 yhtbl_offset;                 /* 読み・表記データ領域先頭アドレス */
    NJ_UINT32 word_offset;
    NJ_UINT32 yomi_offset;
    ...
    /* 単語データ領域の先頭アドレスを取得する */
    head_addr    = GET_STORAGE_CACHE_HEAD(hdl);
    wdtbl_offset = WORD_TOP_OFFSET(head_addr);
    yhtbl_offset = YOMI_HYOKI_TOP_OFFSET(head_addr);
    ...
    *word_clen = 0;
    ...
    if (mode == NJ_CUR_OP_FORE) {
        ...
        for (ylen = 0; ylen < yomilen; ylen += char_len) {
            ...
            while (left <= right) {
                ...
                word_offset = WORD_DATA_OFFSET(wdtbl_offset, mid);
                if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)hdl, NJ_SDIC_STORAGE_WORD_DATA,
                                           word_offset, WORD_DATA_AREA_SIZE, &wdtbl_tmp) < 0) {
                    /* ファイルポインタから読み込み出来ない場合、検索対象なしとする */
                    return -1;    /* NCH_FB */
                }
                /* 読み文字配列長を取得する */
                ...
                if (wkc_len > rtn) {
                    ...
                    yomi_offset = yhtbl_offset + YOMI_DATA_OFFSET(wdtbl_tmp) + (rtn * sizeof(NJ_CHAR));
                    if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)hdl, NJ_SDIC_STORAGE_YOMI_HYOKI,
                                               yomi_offset, (NJ_UINT32)(char_len * sizeof(NJ_CHAR)), &wkc) < 0) {
                        /* ファイルポインタから読み込み出来ない場合、検索対象なしとする */
                        return -1;    /* NCH_FB */
                    }
                    /* 文字列の一致を調べる */
        ...
        while (left <= right) {
            ...
            yomi_offset = yhtbl_offset + YOMI_DATA_OFFSET(wdtbl_tmp);
            if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)hdl, NJ_SDIC_STORAGE_YOMI_HYOKI,
                                       yomi_offset, (NJ_UINT32)(wkc_len * sizeof(NJ_CHAR)), &wkc) < 0) {
                /* ファイルポインタから読み込み出来ない場合、検索対象なしとする */
                return -1;    /* NCH_FB */
            }
        ...
        if (mid_bak == 0) {
            if (findflg) {
                ...
                if (left > src_bottomno) {
                    ...
                    /* 対象の読み文字列を取得する */
                    word_offset = WORD_DATA_OFFSET(wdtbl_offset, left);
                    if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)hdl, NJ_SDIC_STORAGE_WORD_DATA,
                                               word_offset, WORD_DATA_AREA_SIZE, &wdtbl_tmp) < 0) {
                        /* ファイルポインタから読み込み出来ない場合、検索対象なしとする */
                        return -1;    /* NCH_FB */
                    ...
                    if (wkc_len >= yomilen) {
                        yomi_offset = yhtbl_offset + YOMI_DATA_OFFSET(wdtbl_tmp);
                        if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)hdl, NJ_SDIC_STORAGE_YOMI_HYOKI,
                                                   yomi_offset, (NJ_UINT32)(yomilen * sizeof(NJ_CHAR)), &wkc) < 0) {
                            /* ファイルポインタから読み込み出来ない場合、検索対象なしとする */
                            return -1;    /* NCH_FB */
                        }
        ...
        while (left <= right) {
            ...
            wkc_len     = YOMI_LEN(wdtbl_tmp);
            yomi_offset = yhtbl_offset + YOMI_DATA_OFFSET(wdtbl_tmp) + startpos;
            if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)hdl, NJ_SDIC_STORAGE_YOMI_HYOKI,
                                       yomi_offset, (NJ_UINT32)(wkc_len * sizeof(NJ_CHAR)), &wkc) < 0) {
                /* ファイルポインタから読み込み出来ない場合、検索対象なしとする */
                return -1;    /* NCH_FB */
    ...
    /* 辞書情報を取得 */
    wdtbl_addr = GET_STORAGE_CACHE_HINDO(hdl);
    ...
    if (check == (-1)) {
        ...
        /* 頻度学習値利用に必要なデータを取得する */
        if (ext_area != NULL) {
            ext_top = EXT_AREA_TOP_ADDR((NJ_UINT8 *)ext_area, head_addr);
        } else {
            ext_top = NULL;
        }
    ...
    *word_clen = 0;
    ...
    if (mode == NJ_CUR_OP_FORE) {
        ...
        for (ylen = 0; ylen < yomilen; ylen += char_len) {
            ...
            while (left <= right) {
                mid = left + ((right - left) / 2);
                word_offset = WORD_DATA_OFFSET_HIGH_COMPRESS(wdtbl_offset, mid);
                if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)hdl, NJ_SDIC_STORAGE_WORD_DATA,
                                           word_offset, WORD_DATA_HIGH_COMPRESS_AREA_SIZE, &wdtbl_tmp) < 0) {
                    /* ファイルポインタから読み込み出来ない場合、検索対象なしとする */
                    return -1;    /* NCH_FB */
                }
                /* 読み文字配列長を取得する */
                ...
                if (wkc_len > rtn) {
                    /* 読み文字列位置を取得する(unsigned char*) */
                    yomi_offset = yhtbl_offset + YOMI_DATA_OFFSET(wdtbl_tmp) + rtn;
                    if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)hdl, NJ_SDIC_STORAGE_YOMI_HYOKI,
                                               yomi_offset, char_len, &wkc) < 0) {
                        /* ファイルポインタから読み込み出来ない場合、検索対象なしとする */
                        return -1;    /* NCH_FB */
                    }
                    /* 文字列の一致を調べる */
        ...
        if (mid_bak == 0) {
            if (findflg) {
                ...
                if (left > src_bottomno) {
                    ...
                    /* 対象の読み文字列を取得する */
                    word_offset = WORD_DATA_OFFSET_HIGH_COMPRESS(wdtbl_offset, left);
                    if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)hdl, NJ_SDIC_STORAGE_WORD_DATA,
                                               word_offset, WORD_DATA_HIGH_COMPRESS_AREA_SIZE, &wdtbl_tmp) < 0) {
                        /* ファイルポインタから読み込み出来ない場合、検索対象なしとする */
                        return -1;    /* NCH_FB */
...
/**
 * 逆引き前方一致検索−あいまい予測時統合辞書(ストレージ辞書)から検索条件（表記）に該当する単語を検索し、該当する候補データの情報を取得
 *
 * @param[in]           iwnn  解析情報クラス
 * @param[in]      condition  検索条件
 * @param[in,out]  loctset    検索位置
...
static NJ_INT16 search_node_rev_aimai(NJ_CLASS *iwnn, NJ_SEARCH_CONDITION *condition, NJ_SEARCH_LOCATION_SET *loctset, NJ_UINT16 hidx) {
    ...
    NJ_UINT8 *hidx_cur;
    NJ_UINT8 *hitbl_addr;
    NJ_UINT32 hitbl_offset, hitbl_word_offset;
        ...
        if (cmpflg) {    /* cmpflg == 0x01 */
            ...
            if (abPtrIdx == 0) {
                ...
                if (condition->operation == NJ_CUR_OP_FORE_EXT) {
                    ...
                    /* 逆引き前方一致検索の場合 */
                    search_top = 1;
                    search_bottom = (NJ_UINT32)(HYOKI_IDX_AREA_CNT(head_addr));
                }
    ...
    default:
        ...
        for (m = abIdx_old; m < abIdx; m++) {
            ...
            hitbl_word_offset = HYOKI_INDEX_OFFSET(hitbl_offset, psrhCache->storebuff[m].current);
            if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_HYOKI_INDEX,
                                       hitbl_word_offset, HYOKI_INDEX_DATA_AREA_SIZE, &hidx_cur) < 0) {
                /* ファイルからの読み込み不可の場合 */
                return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_SEARCH_WORD, NJ_ERR_STREAM_READ_ERR);    /* NCH_FB */
            }
            ...
            if (condition->operation == NJ_CUR_OP_REV_FORE) {
                ...
                search_bottom = psrhCache->storebuff[m].bottom;
                while (search_top <= search_bottom) {
                    hitbl_word_offset = HYOKI_INDEX_OFFSET(hitbl_offset, search_top);
                    if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_HYOKI_INDEX,
                                               hitbl_word_offset, HYOKI_INDEX_DATA_AREA_SIZE, &hidx_cur) < 0) {
                        /* ファイルからの読み込み不可の場合 */
                        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_SEARCH_WORD, NJ_ERR_STREAM_READ_ERR);    /* NCH_FB */
                    }
                    hindo_cur = HINDO_MORPHO(hidx_cur);
                    if (hindo_tmp < hindo_cur) {
                        hindo_tmp = hindo_cur;
                        psrhCache->storebuff[m].current = search_top;
                    }
 ...
 *          1  検索候補あり
 */
static NJ_INT16 search_node_rev_aimai_ext(NJ_SEARCH_CONDITION *condition, NJ_SEARCH_LOCATION_SET *loctset, NJ_UINT16 hidx) {
    NJ_CHAR *yomi;
    NJ_SEARCH_CACHE *psrhCache = condition->ds->dic[hidx].srhCache;
    NJ_CHAR *key;
    NJ_UINT8 cmpflg;
    ...
    for (i = 0; i < yomi_clen; i++) {
        ...
        if (cmpflg) {    /* cmpflg == 0x01 */
            ...
            if (abPtrIdx == 0) {
                 ...
                 * 該当する単語データ番号の先頭と終端を検索する
                 */
                ret = search_rev_idx_ext(loctset, condition, key_tmp, key_len, 
                                         search_top, search_bottom, 
                                         0, &word_top, &word_bottom);
                ...
                if ((condition->charset != NULL) && aimai_flg) {
                    ...
                    for (l = 0; l < condition->charset->charset_count; l++) {
                        ...
                        if (nj_charncmp(key, condition->charset->from[l], 1) == 0) {
                             ...
                             * 該当する単語データ番号の先頭と終端を検索する
                             */
                            ret = search_rev_idx_ext(loctset, condition, char_tmp, tmp_len,
                                                     search_top, search_bottom, 
                                                     0, &word_top, &word_bottom);
    ...
    for (m = abIdx_old; m < abIdx; m++) {
        ...
        hindo_tmp = HINDO_DATA(hidx_cur);
        if (condition->operation == NJ_CUR_OP_REV_FORE) {
            search_top    = psrhCache->storebuff[m].top + 1;
            search_bottom = psrhCache->storebuff[m].bottom;
            while (search_top <= search_bottom) {
                hindo_cur = HINDO_DATA(HYOKI_INDEX_ADDR(hitbl_addr, search_top));
                if (hindo_tmp < hindo_cur) {
                    hindo_tmp = hindo_cur;
                    psrhCache->storebuff[m].current = search_top;
                }
...
static NJ_INT16 search_rev_idx(NJ_SEARCH_LOCATION_SET *loctset, NJ_SEARCH_CONDITION *condition,
    ...
    NJ_INT8 hyoki_buff_len;
    NJ_INT16 diff;
    NJ_UINT32 index  = hyoki_top;
    NJ_UINT32 index2 = hyoki_bottom;
    NJ_UINT8 findflg;
    NJ_UINT8 *head_addr;
    NJ_UINT32 hitbl_offset, wtbl_offset, yhtbl_offset;
    NJ_UINT32 hitbl_word_offset, wtbl_word_offset;
    NJ_UINT8 *hitbl_cur;
    NJ_UINT8 *hitbl_addr;
    NJ_UINT8 is_hicomp = 1;
    ...
    if ((condition->operation == NJ_CUR_OP_REV_FORE) ||
        ...
        while (hyokilen > 0) {
            ...
            while (left <= right) {
                ...
                if (condition->operation == NJ_CUR_OP_FORE_EXT) {
                    /* 正引き前方一致拡張検索の場合 */
                    hitbl_cur = HYOKI_INDEX_ADDR(hitbl_addr, mid);
                } else {
                    /* 逆引き前方一致検索の場合 */
                    /* 表記インデックスから単語データ番号を取得 */
                    hitbl_word_offset = HYOKI_INDEX_OFFSET(hitbl_offset, mid);
                    if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_HYOKI_INDEX,
                                               hitbl_word_offset, HYOKI_INDEX_DATA_AREA_SIZE, &hitbl_cur) < 0) {
                        /* ファイルからの読み込み不可の場合、検索対象なしとする */
                        return -1;    /* NCH_FB */
                    }
                }
                word_no = HYOKI_INDEX_WORD_NO(hitbl_cur);

                /* 単語データ番号から単語データを取得 */
                wtbl_word_offset =  WORD_DATA_OFFSET_FROM_DIC_TYPE(is_hicomp, wtbl_offset, word_no);
                if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_WORD_DATA,
                                           wtbl_word_offset, GET_WORD_DATA_AREA_SIZE(loctset->loct.handle), &word) < 0) {
                    /* ファイルからの読み込み不可の場合、検索対象なしとする */
                    return -1;    /* NCH_FB */
                }

                /* 表記文字列 */
                hyoki_buff_len = get_candidate_string(loctset->loct.handle, word, yhtbl_offset, hyoki_buff);
            ...
            while (left <= right) {
                ...
                } else if (hyoki_buff_len < 0){ /* NCH_FB */
                    /* ファイルからの読み込み不可の場合、検索対象なしとする */
                    return -1; /* NCH_FB */
                } else {
                    right = mid - 1; /*NCH_DEF*/
        ...
        if (mid_bak == 0) {
            if (findflg) {
                ...
                if (left > hyoki_bottom) {
                    ...
                    if (condition->operation == NJ_CUR_OP_COMP_EXT) {
                        /* 正引き完全一致拡張検索の場合 */
                        hitbl_cur = HYOKI_INDEX_ADDR(hitbl_addr, left);
                    } else {
                        /* 逆引き完全一致検索の場合 */
                        /* 表記インデックスから単語データ番号を取得 */
                        hitbl_word_offset = HYOKI_INDEX_OFFSET(hitbl_offset, left);
                        if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_HYOKI_INDEX,
                                                   hitbl_word_offset, HYOKI_INDEX_DATA_AREA_SIZE, &hitbl_cur) < 0) {
                            /* ファイルからの読み込み不可の場合、検索対象なしとする */
                            return -1;    /* NCH_FB */
...
static NJ_INT16 search_rev_idx_ext(NJ_SEARCH_LOCATION_SET *loctset, NJ_SEARCH_CONDITION *condition,
    ...
    NJ_UINT8 findflg;
    NJ_UINT8 *head_addr;
    NJ_UINT32 wtbl_offset, yhtbl_offset;
    NJ_UINT32 wtbl_word_offset;
    NJ_UINT8 *hitbl_cur;
    NJ_UINT8 *hitbl_addr;
    NJ_UINT8 is_hicomp = 1;
    ...
    if (condition->operation == NJ_CUR_OP_REV_FORE) {
        ...
        while (left <= right) {
            ...
            if (diff == 0) {
                if (hyoki_buff_len < hyokilen) {
                    diff = nj_strncmp(hyoki + 1, &hyoki_buff[1], (NJ_UINT16)(hyoki_buff_len - 1)); /*NCH_DEF*/
                    if (diff == 0) { /*NCH_DEF*/
                        /*
                         * 辞書単語文字列の方が短い場合、
                         * 部分文字列が一致しても、キーの方が大きいと判断
...
static NJ_INT16 sdic_search_data_fore_aimai(NJ_CLASS *iwnn, NJ_SEARCH_CONDITION *condition,
            ...
            if (condition->ylen != 0) {
                ...
                while (current <= loctset->loct.bottom) { /*NCH_FB*/
                    ...
                    if ((condition->ctrl_opt & NJ_SEARCH_DISMANTLING_CONTROL) == 0x00) { /*NCH_FB*/
                        /* 単語使用有無の確認 */
                        if (!IS_USED_FOR_FORECAST(current, hdtbl_addr, ext_top, condition->yclen)) {
                    ...
                    if (hindo > hindo_max) { /*NCH_FB*/
                        ...
                        if (iwnn->option_data.phase3_filter != NULL) {
                            tmp_loctset = *loctset;
                            tmp_loctset.cache_freq = CALCULATE_HINDO(hindo,
                                                                     loctset->dic_freq.base,
                                                                     loctset->dic_freq.high, FUSION_DIC_FREQ_DIV);
                            tmp_loctset.cache_freq = NORMALIZE_HINDO(loctset->cache_freq, loctset->dic_freq_max, loctset->dic_freq_min);
                            tmp_loctset.loct.current = current;
                            tmp_loctset.loct.attr = get_attr(loctset->loct.handle, hindo);

                            /* フィルターチェック処理を実行 */
                            ret_16 = is_sdic_filtering(iwnn, &tmp_loctset);
                        } else {
                            ret_16 = 1;
                        }
    ...
    /* 次候補の取得を行う。 */
    ret = sdic_get_next_data(iwnn, loctset, psrhCache, old_abIdx, yomi_clen, hidx, condition->ctrl_opt);
    /* 現在の候補の頻度を取得する */
    ...
    while (loop_check != count_abIdx) {
        ...
        /* 指定候補の頻度を取得する */
        ret = sdic_get_word_freq(iwnn, loctset, psrhCache, current_abIdx, hidx);
        ...
        if ((ret == hindo) &&
            ...
            /* 単語を１つ進ませる */
            ret = sdic_get_next_data(iwnn, loctset, psrhCache, current_abIdx, yomi_clen, hidx, condition->ctrl_opt);
        }
 ...
 * @retval  1  検索候補あり
 */
static NJ_INT16 sdic_search_data_rev_aimai(NJ_CLASS *iwnn, NJ_SEARCH_CONDITION *condition, NJ_SEARCH_LOCATION_SET *loctset, NJ_UINT16 hidx) {
    NJ_INT32 hindo = INIT_HINDO;
    NJ_SEARCH_CACHE *psrhCache = condition->ds->dic[hidx].srhCache;
    ...
    if (condition->operation == NJ_CUR_OP_FORE_EXT) {
        /* 正引き前方一致拡張検索の場合 */
        ret = sdic_get_next_data_fore_ext(iwnn, condition, loctset, psrhCache, old_abIdx);
        hidx_cur = HYOKI_INDEX_ADDR(hitbl_addr, loctset->loct.current);
        hindo = HINDO_DATA(hidx_cur);
    } else {
        /* 逆引き前方一致検索の場合 */
        ret = sdic_get_next_data_rev(loctset, psrhCache, old_abIdx);
        hitbl_word_offset = HYOKI_INDEX_OFFSET(hitbl_offset, loctset->loct.current);
        if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_HYOKI_INDEX,
                                   hitbl_word_offset, HYOKI_INDEX_DATA_AREA_SIZE, &hidx_cur) < 0) {
            /* ファイルからの読み込み不可の場合 */
    ...
    while (loop_check != count_abIdx) {
        ...
        if (condition->operation == NJ_CUR_OP_FORE_EXT) {
            /* 正引き前方一致拡張検索の場合 */
            ret = sdic_get_word_freq_fore_ext(loctset, psrhCache, current_abIdx);
        } else {
            /* 逆引き前方一致検索の場合 */
            ret = sdic_get_word_freq_rev(loctset, psrhCache, current_abIdx);
        }
        ...
        if ((ret == hindo) &&
            ...
            /* 過去の頻度と同じ頻度でかつ辞書内の同一単語を指している場合 */
            /* 単語を１つ進ませる */
            ret = sdic_get_next_data_rev(loctset, psrhCache, current_abIdx); /*NCH_FB*/
        }
...
/**
 * 逆引き前方一致検索−あいまい検索の時の次候補を検索する（次候補の情報はオフセットとして検索位置(loctset)に設定する）
 *
 * @param[in]      condition  検索条件
 * @param[in,out]  loctset    検索位置
 * @param[in]      hidx       辞書のインデックス
 ...
 * @retval  1  検索候補あり
 */
static NJ_INT16 sdic_search_data_rev_aimai_ext(NJ_SEARCH_CONDITION *condition, NJ_SEARCH_LOCATION_SET *loctset, NJ_UINT16 hidx) {
    NJ_INT32 hindo = INIT_HINDO;
    NJ_SEARCH_CACHE *psrhCache = condition->ds->dic[hidx].srhCache;
    ...
    ret = sdic_get_next_data_rev_ext(loctset, psrhCache, old_abIdx);
    hidx_cur = HYOKI_INDEX_ADDR(hitbl_addr, loctset->loct.current);
    hindo = HINDO_DATA(hidx_cur);
    ...
    while (loop_check != count_abIdx) {
        ...
        /* 指定候補の頻度を取得する */
        ret = sdic_get_word_freq_rev_ext(loctset, psrhCache, current_abIdx);
        ...
        if ((ret == hindo) &&
            ...
            /* 過去の頻度と同じ頻度でかつ辞書内の同一単語を指している場合 */
            /* 単語を１つ進ませる */
            ret = sdic_get_next_data_rev_ext(loctset, psrhCache, current_abIdx); /*NCH_FB*/
        }
...
static NJ_INT16 sdic_search_data_rev(NJ_CLASS *iwnn, NJ_SEARCH_CONDITION *condition, NJ_SEARCH_LOCATION_SET *loctset) {
    ...
    NJ_UINT8 *wkc;
    NJ_UINT8 *head_addr, *hinsi_top_addr;
    NJ_UINT32 wtbl_offset, wtbl_word_offset, hitbl_offset, hitbl_word_offset;
    NJ_UINT8 stem_terminate;
    NJ_UINT8 *hitbl_addr;
    NJ_INT16 hindo_d;
    NJ_UINT8 is_hicomp = 1;
    ...
    wtbl_word_offset = WORD_DATA_OFFSET_FROM_DIC_TYPE(is_hicomp, wtbl_offset, word_no);
    if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_WORD_DATA,
                               wtbl_word_offset, GET_WORD_DATA_AREA_SIZE(loctset->loct.handle), &data_cur) < 0) {
        /*
         * ファイルポインタから読み込み出来ない場合
         * 検索終了の属性を設定
         */
    ...
    if ((condition->operation == NJ_CUR_OP_REV) ||
        ...
        if (GET_LOCATION_STATUS(loctset->loct.status) != NJ_ST_SEARCH_NO_INIT) {
            ...
            if (condition->mode == NJ_CUR_MODE_FREQ) {
                ...
                if (condition->operation == NJ_CUR_OP_COMP_EXT) {
                    ...
                    hitbl_word_offset = HYOKI_INDEX_OFFSET(hitbl_offset, cnt);
                    if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_HYOKI_INDEX,
                                               hitbl_word_offset, HYOKI_INDEX_DATA_AREA_SIZE, &hidx_cur) < 0) {
                        /*
                         * ファイルポインタから読み込み出来ない場合
        ...
        if (condition->mode == NJ_CUR_MODE_FREQ) {
             ...
             */
            if (condition->operation == NJ_CUR_OP_FORE_EXT) {
                hidx_cur = HYOKI_INDEX_ADDR(hitbl_addr, current);
                hindo_current = (NJ_INT16)HINDO_DATA(hidx_cur);
            } else {
                /* 判定するカレント情報を取得 */
                hitbl_word_offset = HYOKI_INDEX_OFFSET(hitbl_offset, current);
                if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_HYOKI_INDEX,
                                           hitbl_word_offset, HYOKI_INDEX_DATA_AREA_SIZE, &hidx_cur) < 0) {
                    /*
                     * ファイルポインタから読み込み出来ない場合
                ...
                hindo_current = (NJ_INT16)HINDO_MORPHO(hidx_cur);
            }
...
static NJ_INT16 sdic_search_data_rev_ext(NJ_SEARCH_CONDITION *condition, NJ_SEARCH_LOCATION_SET *loctset) {
    ...
    NJ_UINT8 *wkc;
    NJ_UINT8 *head_addr, *hinsi_top_addr;
    NJ_UINT32 wtbl_offset, wtbl_word_offset;
    NJ_UINT8 stem_terminate;
    NJ_UINT8 *hitbl_addr, *hitbl_cur;
    NJ_INT16 hindo_d;
    NJ_UINT8 is_hicomp = 1;
    ...
    hitbl_addr = EXT_HYOKI_IDX_AREA_TOP_ADDR((NJ_UINT8 *)loctset->loct.ext_area[NJ_TYPE_EXT_AREA_MORPHO]);
    hitbl_cur = HYOKI_INDEX_ADDR(hitbl_addr, loctset->loct.current);
    ...
    if (condition->operation == NJ_CUR_OP_REV) {
        ...
        if (condition->mode == NJ_CUR_MODE_FREQ) {
            ...
            word_next = 0;
            while (cnt <= loctset->loct.bottom) {
                hitbl_cur = HYOKI_INDEX_ADDR(hitbl_addr, cnt);

                if (HINDO_EXT_AREA_YOSOKU(hitbl_cur)) {
                    hindo = (NJ_INT16)HINDO_DATA(hitbl_cur);
...
static NJ_INT32 sdic_get_next_data_rev(NJ_SEARCH_LOCATION_SET *loctset,
    ...
    if (HAS_MORE_ENTRY(psrhCache->storebuff[abIdx].current)) {
        /* 表記文字列インデックス領域の先頭アドレスを取得 */
        hitbl_offset = HYOKI_IDX_AREA_TOP_OFFSET(head_addr);
        hitbl_word_offset =  HYOKI_INDEX_OFFSET(hitbl_offset, psrhCache->storebuff[abIdx].current);
        if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_HYOKI_INDEX,
                                   hitbl_word_offset, HYOKI_INDEX_DATA_AREA_SIZE, &hidx_cur) < 0) {
            /* ファイルからの読み込み不可の場合、検索対象なしとする */
        ...
        while (cursor <= psrhCache->storebuff[abIdx].bottom) {
            /* 該当する表記文字列情報を取得する */
            /* 該当する表記文字列の頻度を取得する */
            hitbl_word_offset =  HYOKI_INDEX_OFFSET(hitbl_offset, cursor);
            if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_HYOKI_INDEX,
                                       hitbl_word_offset, HYOKI_INDEX_DATA_AREA_SIZE, &hidx_cur) < 0) {
                /* ファイルからの読み込み不可の場合、検索対象なしとする */
                return INIT_HINDO;    /* NCH_FB */
...
static NJ_INT32 sdic_get_next_data_fore_ext(NJ_CLASS *iwnn,
    ...
    if (HAS_MORE_ENTRY(psrhCache->storebuff[abIdx].current)) {
        if (loctset->loct.ext_area[NJ_TYPE_EXT_AREA_INPUT] != NULL) {
            ...
            /* 検索終了の属性を設定 */
            psrhCache->storebuff[abIdx].current = LOC_CURRENT_NO_ENTRY; /*NCH_DEF*/
            return INIT_HINDO; /*NCH_DEF*/
        }
        /* 該当頻度データ領域の終端を超えた場合は抜ける */
        while (cursor <= psrhCache->storebuff[abIdx].bottom) {
            /* 該当する表記文字列情報を取得する */
...
/**
 * 読みなし予測時、ストレージ辞書から検索条件（前確定情報）に該当する単語データを検索し、該当する候補データを取得
 *
 * @param[in]      iwnn       解析情報クラス
 * @param[in]      condition  検索条件
 * @param[in,out]  loctset    検索位置
...
static NJ_INT16 search_node_yominashi(NJ_CLASS *iwnn, NJ_SEARCH_CONDITION *condition,
    ...
    NJ_UINT8 *head_addr;
    NJ_UINT32 wtbl_offset, yhtbl_offset;
    NJ_UINT32 wtbl_word_offset, yhtbl_word_offset;
    NJ_UINT8 is_hicomp = 1;
    ...
    titbl_addr = GET_STORAGE_CACHE_TUNAGARI_INDEX(loctset->loct.handle);

    /* 単語データ領域から前確定の単語データ番号を取得する */
    left = 1;
    right = TSUNAGARI_IDX_AREA_CNT(head_addr);
    index = 0;
    while (left <= right) {
        mid = left + ((right - left) / 2);
        wtbl_word_offset = WORD_DATA_OFFSET_FROM_DIC_TYPE(is_hicomp, wtbl_offset, TSUNAGARI_SRC_NO(titbl_addr, mid));
        if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_WORD_DATA,
                                   wtbl_word_offset, GET_WORD_DATA_AREA_SIZE(loctset->loct.handle), &word_d) < 0) {
            /* ファイルからの読み込み不可の場合、検索対象なしとする */
            loctset->loct.status = NJ_ST_SEARCH_END_EXT;    /* NCH_FB */
            return 0;       /* 検索候補無し */              /* NCH_FB */
        }
        ...
        /* 読み文字列 */
        yhtbl_word_offset = yhtbl_offset + YOMI_DATA_OFFSET(word_d);

        if (!is_hicomp) {
            if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO *)loctset->loct.handle, NJ_SDIC_STORAGE_YOMI_HYOKI,
                                       yhtbl_word_offset, (NJ_UINT32)YOMI_LEN_BYTE(word_d), &yomi_d) < 0) {
                /* ファイルからの読み込み不可の場合、検索対象なしとする */
                loctset->loct.status = NJ_ST_SEARCH_END_EXT;    /* NCH_FB */
                return 0;       /* 検索候補無し */              /* NCH_FB */
            }
            ...
            if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO *)loctset->loct.handle, NJ_SDIC_STORAGE_YOMI_HYOKI,
                                       yhtbl_word_offset, (NJ_UINT32)(yomi_d_len * sizeof(NJ_CHAR)), &yomi_d) < 0) {
                /* ファイルからの読み込み不可の場合、検索対象なしとする */
                loctset->loct.status = NJ_ST_SEARCH_END_EXT;    /* NCH_FB */
                return 0;       /* 検索候補無し */              /* NCH_FB */
            }
            ...
            *yomi = NJ_CHAR_NUL;
            ...
            if (hyoki_d_len == 0) {
                ...
                /* 表記文字列長が>0の時は、辞書から表記文字列データを取得 */
                yhtbl_word_offset = yhtbl_offset + HYOKI_DATA_OFFSET(word_d);
                if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO *)loctset->loct.handle, NJ_SDIC_STORAGE_YOMI_HYOKI,
                                           yhtbl_word_offset, (NJ_UINT32)(hyoki_d_len * sizeof(NJ_CHAR)), &hyoki_d) < 0) {
                    /* ファイルからの読み込み不可の場合、検索対象なしとする */
                    loctset->loct.status = NJ_ST_SEARCH_END_EXT;    /* NCH_FB */
                    return 0;       /* 検索候補無し */              /* NCH_FB */
                }
    ...
    hindo_max = INIT_HINDO;
    index_max = index;
    for (tdtbl_tmp = TSUNAGARI_DATA_ADDR(GET_STORAGE_CACHE_TUNAGARI(loctset->loct.handle), cur);
...
static NJ_INT16 search_node_rev(NJ_CLASS *iwnn, NJ_SEARCH_CONDITION *condition, NJ_SEARCH_LOCATION_SET *loctset) {
    ...
    if ((condition->operation == NJ_CUR_OP_COMP_EXT) ||
        ...
        /* 表記文字列インデックス領域の先頭アドレス取得 */
        hitbl_offset = HYOKI_IDX_AREA_TOP_OFFSET(head_addr);
        hyoki_cnt = HYOKI_IDX_AREA_CNT(head_addr);
    }
    ...
    if ((condition->mode == NJ_CUR_MODE_FREQ) &&
        ...
        if (condition->operation == NJ_CUR_OP_FORE_EXT) {
            ...
            while (lop <= bottom) {
                hitbl_word_offset = HYOKI_INDEX_OFFSET(hitbl_offset, lop);
                if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_HYOKI_INDEX,
                                           hitbl_word_offset, HYOKI_INDEX_DATA_AREA_SIZE, &hidx_tmp) < 0) {
                    /* ファイルからの読み込み不可の場合、検索候補無し */
                    loctset->loct.status = NJ_ST_SEARCH_END_EXT;    /* NCH_FB */
                    return 0;       /* 検索候補無し */              /* NCH_FB */
                }
        ...
        default:
            hindo_top = hyoki_top;
            hitbl_word_offset = HYOKI_INDEX_OFFSET(hitbl_offset, hyoki_top);
            if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loctset->loct.handle, NJ_SDIC_STORAGE_HYOKI_INDEX,
                                       hitbl_word_offset, HYOKI_INDEX_DATA_AREA_SIZE, &hidx_tmp) < 0) {
                /* ファイルからの読み込み不可の場合、検索候補無し */
                loctset->loct.status = NJ_ST_SEARCH_END_EXT;    /* NCH_FB */
...
/**
 * 逆引き完全一致,逆引き前方一致検索の時、<br>
 * 形態素用拡張領域から検索条件（表記）に該当する単語を検索し、該当する候補データの情報を取得
 *
 * @param[in]      condition  検索条件
 * @param[in,out]  loctset    検索位置
 *
...
static NJ_INT16 search_node_rev_ext(NJ_SEARCH_CONDITION *condition, NJ_SEARCH_LOCATION_SET *loctset) {
    ...
    if (condition->ylen > 0) {
         ...
         * 該当する単語データ番号の先頭と終端を検索する
         */
        ret = search_rev_idx_ext(loctset, condition, condition->yomi, condition->ylen,
                                 1, hyoki_cnt,
                                 0, &hyoki_top, &hyoki_bottom);
         ...
         */
        hyoki_top = 1;                      /*NCH*/
        hyoki_bottom = hyoki_cnt;           /*NCH*/
        if (hyoki_top > hyoki_bottom) {     /*NCH*/
            ret = -1;                       /*NCH*/
        }
    }
    ...
    if ((condition->mode == NJ_CUR_MODE_FREQ) &&
        ...
        while (lop <= bottom) {
            ...
            /* 頻度学習値を取得 */
            if (ext_top != NULL) {
                ext_current = EXT_AREA_WORD_ADDR(ext_top, lop);
                ext_hindo = HINDO_EXT_AREA(ext_current);
                hindo_tmp += ext_hindo;
            }
...
static NJ_INT32 get_tsunagari_hindo(NJ_UINT32 top, NJ_UINT32 bottom, NJ_UINT8 *handle,
    ...
    /* つながりデータ領域の先頭アドレスを取得 */
    tdtbl_addr = GET_STORAGE_CACHE_TUNAGARI(handle);
...
static NJ_INT16 search_connect_word(NJ_DIC_HANDLE handle,
    ...
    /* つながりインデックスの有無をチェック */
    head_addr  = GET_STORAGE_CACHE_HEAD(handle);
    titbl_cnt  = TSUNAGARI_IDX_AREA_CNT(head_addr);      /* つながりインデックス登録数   */
    if (titbl_cnt == 0) {
    ...
    /* 検索に必要な初期設定情報を取得 */
    titbl_addr = GET_STORAGE_CACHE_TUNAGARI_INDEX(handle);    /* つながりインデックス先頭取得 */
    tdtbl_addr = GET_STORAGE_CACHE_TUNAGARI(handle);          /* つながりデータ先頭取得       */
    wtbl_offset = WORD_TOP_OFFSET(head_addr);                 /* 単語データ先頭取得           */
    yhtbl_offset = YOMI_HYOKI_TOP_OFFSET(head_addr);          /* 読み・表記データ先頭取得     */
    ...
    for (phr_lop = 0; phr_lop < NJ_MAX_PHR_CONNECT; phr_lop++) {
        ...
        while (left <= right) {
            ...
            /* 単語番号から単語データ位置を取得 */
            wtbl_word_offset = WORD_DATA_OFFSET_FROM_DIC_TYPE(is_hicomp, wtbl_offset, t_src_no);
            if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)handle, NJ_SDIC_STORAGE_WORD_DATA,
                                       wtbl_word_offset, GET_WORD_DATA_AREA_SIZE(handle), &data) < 0) {
                /* ファイルからの読み込み不可の場合、検索対象なしとする */
                return 0;       /* 検索候補無し */    /* NCH_FB */
            }
            ...
            /* 読み文字列を取得する */
            yhtbl_word_offset = yhtbl_offset + YOMI_DATA_OFFSET(data);
            if (wkc_len < complete_ylen) {
                cmp_len = wkc_len * sizeof(NJ_CHAR);
                if (!is_hicomp) {
                    cnv_len = get_stem_yomi_string(handle, data, tmp_buf, wkc_len, sizeof(tmp_buf));
                    wkc = (NJ_UINT8*)tmp_buf;

                    ret = nj_memcmp(wkc, (NJ_UINT8*)complete_yomi, (NJ_UINT16)(cnv_len));
                } else {
                    if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO *)handle, NJ_SDIC_STORAGE_YOMI_HYOKI,
                                               yhtbl_word_offset, (NJ_UINT32)(cmp_len), &wkc) < 0) {
                        /* ファイルからの読み込み不可の場合、検索対象なしとする */
                        return 0;       /* 検索候補無し */    /* NCH_FB */
                    }
                    ret = nj_memcmp(wkc, (NJ_UINT8*)complete_yomi, (NJ_UINT16)(cmp_len));
                }
                if (ret == 0) {
                    ret = -1;
                }
            } else {
                cmp_len = complete_ylen * sizeof(NJ_CHAR);
                if (!is_hicomp) {
                    cnv_len = get_stem_yomi_string(handle, data, tmp_buf, wkc_len, sizeof(tmp_buf));
                    wkc = (NJ_UINT8*)tmp_buf;
        ...
        while ((cursor = TSUNAGARI_WORD_DATA_NO(tdtbl_cursor)) != 0) { /* 単語データ番号を取得 */
            ...
            /* つながりデータの読み文字列を取得 */
            wtbl_word_offset = WORD_DATA_OFFSET_FROM_DIC_TYPE(is_hicomp, wtbl_offset, cursor);
            if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)handle, NJ_SDIC_STORAGE_WORD_DATA,
                                       wtbl_word_offset, GET_WORD_DATA_AREA_SIZE(handle), &data) < 0) {
                /* ファイルからの読み込み不可の場合、検索対象なしとする */
                return 0;       /* 検索候補無し */    /* NCH_FB */
            ...
            if (!is_hicomp) {
                ...
                if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO *)handle, NJ_SDIC_STORAGE_YOMI_HYOKI,
                                           yhtbl_word_offset, (NJ_UINT32)(wkc_len * sizeof(NJ_CHAR)), &wkc) < 0) {
                    /* ファイルからの読み込み不可の場合、検索対象なしとする */
                    return 0;       /* 検索候補無し */    /* NCH_FB */
                }
            }
...
static NJ_INT16 is_sdic_filtering(NJ_CLASS *iwnn, NJ_SEARCH_LOCATION_SET *loctset) {
    ...
    /* 単語情報取得 */
    ret = njd_s_get_word(loctset, &tmp_word);
    if (ret < 0) {
        /*
         * エラーが発生した場合、
         * その候補は使用しない扱いとする。
    ...
    /* 読み文字列取得、設定 */
    ret = njd_s_get_stroke(&tmp_word, tmp_stroke, sizeof(tmp_stroke));
    if (ret < 0) {
        /*
         * エラーが発生した場合、
         * その候補は使用しない扱いとする。
    ...
    /* 候補文字列取得、設定 */
    ret = njd_s_get_candidate(&tmp_word, tmp_string, sizeof(tmp_string));
    if (ret < 0) {
        /*
         * エラーが発生した場合、
         * その候補は使用しない扱いとする。
    ...
    /* 付加情報取得、設定 */
    if (HAS_ADDITIONAL_INFO(tmp_word, 0, NJ_GET_DIC_TYPE_EX(NJ_DIC_H_TYPE_ON_STORAGE, tmp_word.stem.loc.handle))) {
        /* 付加情報データが存在する場合 */
        ret32 = njd_s_get_additional_info(iwnn, &tmp_word, 0, tmp_additional, sizeof(tmp_additional));
        if (ret32 < 0) {
            /*
             * エラーが発生した場合、
             * その候補は使用しない扱いとする。
 ...
 * @retval  <0  エラー
 */
NJ_INT16 njd_s_get_relational_word(NJ_SEARCH_LOCATION *loc,
    ...
    if (word->stem.loc.relation[0] == 0) {
        /* エラーとする */
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_RELATIONAL_WORD, /*NCH_FB*/
    ...
    wtbl_offset = WORD_TOP_OFFSET(head_addr);
    wtbl_word_offset = WORD_DATA_OFFSET_FROM_DIC_TYPE(is_hicomp, wtbl_offset, word->stem.loc.current);
    if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)loc->handle, NJ_SDIC_STORAGE_WORD_DATA,
                               wtbl_word_offset, GET_WORD_DATA_AREA_SIZE(loc->handle), &data) < 0) {
        /* ファイルからの読み込み不可の場合、読み込みエラーとする */
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_RELATIONAL_WORD, NJ_ERR_STREAM_READ_ERR);    /* NCH_FB */
    }
    /**
     * 変換補正の場合は、頻度値を0にする。
    ...
    if (BIT_FHINSI(head_addr)) {
        ...
        fhinsi = GET_BITFIELD_16(hdata, 0, BIT_FHINSI(head_addr));
    } else {
        fhinsi = 0; /*NCH_FB*/
    }
    /* 品詞番号変換データ領域の該当位置 */
    ...
    if (BIT_BHINSI(head_addr)) {
        hdata = HINSI_DATA_FROM_DIC_TYPE(is_hicomp, data);
        bhinsi = GET_BITFIELD_16(hdata, BIT_FHINSI(head_addr), BIT_BHINSI(head_addr));
    } else {
        bhinsi = 0; /*NCH_FB*/
    }
    wkc = (hinsi_top_addr
 ...
 * @retval  1  正常終了  ※ 値は1のみ
 */
NJ_INT16 njd_s_get_ext_area_size(NJ_CLASS *iwnn, NJ_DIC_HANDLE handle, NJ_UINT32 *size) {
    NJ_INT16 ret;
    NJ_UINT32 ret_size;
    NJ_UINT32 word_cnt;
    ...
    ret_size += NJ_INT32_READ(GET_STORAGE_CACHE_HEAD(handle) + NJ_DIC_POS_EXT_SIZE);
     ...
     */
    /* 辞書の単語登録数を取得 */
    word_cnt = WORD_AREA_CNT(GET_STORAGE_CACHE_HEAD(handle));
 ...
 * @retval  <0  エラー
 */
NJ_INT16 njd_s_init_ext_area(NJ_CLASS *iwnn, NJ_DIC_HANDLE handle, NJ_VOID *ext_data, NJ_UINT32 size) {
    NJ_INT16 ret;
    NJ_UINT32 dic_size;
    NJ_UINT8 *ext_tmp;
    NJ_UINT32 use_size;
    ...
    njd_s_get_ext_area_size(iwnn, handle, &dic_size);
    if (size < dic_size) {
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_INIT_EXT_AREA, NJ_ERR_BUFFER_NOT_ENOUGH);
    }
    ...
    handle_tmp = GET_STORAGE_CACHE_HEAD(handle);
    ...
    /* チェック用データサイズ */
    use_size = (NJ_DIC_COMMON_HEADER_SIZE + NJ_INT32_READ(handle_tmp + NJ_DIC_POS_EXT_SIZE));
    ...
    /* 辞書の単語登録数を取得 */
    word_cnt = WORD_AREA_CNT(handle_tmp);
 ...
 * @retval  <0  エラー
 */
NJ_INT16 njd_s_check_ext_area(NJ_CLASS *iwnn, NJ_DIC_HANDLE handle, NJ_VOID *ext_data, NJ_UINT32 size) {
    NJ_INT16 ret;
    NJ_UINT32 ext_size;
    NJ_UINT8 *ext_tmp;
    NJ_UINT32 top_addr;
    ...
    njd_s_get_ext_area_size(iwnn, handle, &ext_size);
    if (size < ext_size) {
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_CHECK_EXT_AREA, NJ_ERR_BUFFER_NOT_ENOUGH);
    }
    ...
    if (NJ_INT32_READ(ext_tmp) != NJ_DIC_EXT_IDENTIFIER) {
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_CHECK_EXT_AREA, NJ_ERR_FORMAT_INVALID);
    }
    ext_tmp += sizeof(NJ_UINT32);
    ...
    if (ext_size != data_size) {
        /* サイズエラー */
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_CHECK_EXT_AREA, NJ_ERR_PARAM_EXT_AREA_INVALID_SIZE);
    }
    ...
    for (i = 0; i < check_size; i++) {
        if (*ext_tmp++ != *handle_tmp++) {
            ret = NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_CHECK_EXT_AREA, NJ_ERR_FORMAT_INVALID);
            break;
        }
    }
 ...
 * @retval  <0  エラー
 */
NJ_INT16 njd_s_check_ext_area2(NJ_CLASS *iwnn, NJ_DIC_HANDLE handle, NJ_VOID *ext_data, NJ_UINT32 size) {
    NJ_INT16 ret;
    NJ_UINT8 *ext_tmp;
    NJ_UINT32 top_addr;
    NJ_UINT32 data_size;
 ...
 * @retval  <0  エラー
 */
NJ_INT16 njd_s_delete_word(NJ_CLASS *iwnn, NJ_RESULT *result) {
    NJ_INT16 ret = 1;
    NJ_UINT8 *ext_top;
    NJ_UINT8 *ext_current;
    NJ_UINT16 functype;
    ...
    /* 頻度学習領域の先頭アドレスを取得 */
    ext_top = EXT_AREA_TOP_ADDR((NJ_UINT8*)result->word.stem.loc.ext_area[NJ_TYPE_EXT_AREA_DEFAULT], GET_STORAGE_CACHE_HEAD(result->word.stem.loc.handle));
 ...
 * @retval  <0  エラー
 */
NJ_INT16 njd_s_learn_word(NJ_CLASS *iwnn, NJ_WORD *word, NJ_LEARN_WORD_INFO *lword, NJ_UINT16 idx)
{
    NJ_INT16 ret;
    NJ_UINT8 *ext_tmp;
    NJ_UINT8 *ext_top;
    ...
    if ((word->stem.loc.handle == handle) &&
        ...
        /*
         * 学習単語が、現在対象となっている統合辞書(ストレージ辞書)のものだった場合
         * ダイレクトに学習することが可能である。
         */
        ...
        case NJ_CUR_OP_LINK:
            /* つながり予測検索時 */
            /* つながりデータ領域の先頭アドレスを取得 */
            tdtbl_addr = GET_STORAGE_CACHE_TUNAGARI(word->stem.loc.handle);
            /* つながりデータ番号から単語データ番号、頻度を取得 */
        ...
        /*
         * 学習単語が、現在対象となっている統合辞書(ストレージ辞書)とは異なる場合に、
         * 統合辞書(ストレージ辞書)内を検索し、該当単語が存在した場合に頻度学習を行う。
         */
        ...
        if (ext_tmp != NULL) {
            ...
            while (word_idx <= yomi_end) {
                /* 単語の情報を取得する */
                wtbl_word_offset = WORD_DATA_OFFSET_FROM_DIC_TYPE(is_hicomp, wtbl_offset, word_idx);
                if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)handle, NJ_SDIC_STORAGE_WORD_DATA,
                                           wtbl_word_offset, GET_WORD_DATA_AREA_SIZE(handle), &data) < 0) {
                    /* ファイルからの読み込み不可の場合、検索対象なしとする */
                    return 0;       /* 検索候補無し */    /* NCH_FB */
                ...
                if (njd_s_get_candidate(&word_tmp, candidate, sizeof(candidate)) < 0) {
                    /* エラーのため読み飛ばす */
                    word_idx++; /*NCH_FB*/
                    continue; /*NCH_FB*/
                }
    ...
    if ((ext_tmp != NULL) &&
        ...
        /* 頻度学習領域の先頭を取得 */
        ext_top = EXT_AREA_TOP_ADDR(ext_tmp, head_addr);

        if (word_id > word_cnt) {
            /* 学習対象の単語より単語数が少ない場合 */
            return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_INIT_EXT_AREA, NJ_ERR_BUFFER_NOT_ENOUGH); /*NCH_FB*/
        }
        ext_current = EXT_AREA_WORD_ADDR(ext_top, word_id);

        /* 頻度学習値の計算を行う。*/
        ext_data = njd_s_calc_ext_hindo(iwnn, (NJ_UINT8)HINDO_EXT_AREA(ext_current));
        ...
        if (ext_data >= EXT_AREA_THRESHOLD) {
            ...
            *ext_current = ext_data | EXT_AREA_WORD_YOSOKU;
            ...
            /* 統合辞書(ストレージ辞書)側の頻度データ領域先頭を取得 */
            hdtbl_addr = GET_STORAGE_CACHE_HINDO(handle);
...
static NJ_INT32 get_hindo(NJ_CLASS *iwnn,
    ...
    /* 頻度学習値利用に必要なデータを取得する */
    if (loctset->loct.ext_area[NJ_TYPE_EXT_AREA_DEFAULT] != NULL) {
        ext_top = EXT_AREA_TOP_ADDR((NJ_UINT8 *)loctset->loct.ext_area[NJ_TYPE_EXT_AREA_DEFAULT], GET_STORAGE_CACHE_HEAD(handle));
    } else {
        ext_top = NULL;
    }
    ext_current = NULL;
...
static NJ_UINT32 get_attr(NJ_DIC_HANDLE handle, NJ_UINT32 current)
{
    ...
    if (((((NJ_STORAGE_DIC_INFO*)handle)->dictype) != NJ_DIC_TYPE_FUSION_STORAGE) &&
        ((((NJ_STORAGE_DIC_INFO*)handle)->dictype) != NJ_DIC_TYPE_FUSION_HIGH_COMPRESS_STORAGE)) {
    ...
    /* 属性データ */
    vattr_addr = GET_STORAGE_CACHE_ZOKUSEI(handle);
    vattr_byte = ZOKUSEI_AREA_SIZE(head_addr);
    /* 実属性データ */
    rattr_addr = GET_STORAGE_CACHE_REAL_ZOKUSEI(handle);
    rattr_cnt = REAL_ZOKUSEI_AREA_CNT(head_addr);
    rattr_byte = REAL_ZOKUSEI_AREA_SIZE(head_addr);
 ...
 * @retval  <0  エラー
 */
NJ_INT16 njd_s_optimize_ext_area(NJ_CLASS *iwnn, NJ_DIC_HANDLE handle, NJ_VOID *ext_data)
{
    NJ_INT16 ret;
    NJ_UINT8 *ext_tmp;
    NJ_UINT8 *ext_top;
    ...
    /* 頻度データオフセットのアドレスを取得 */
    hindo_top_addr = EXT_AREA_TOP_ADDR(ext_top, GET_STORAGE_CACHE_HEAD(handle));
 ...
 * @return  確定頻度値
 */
NJ_UINT8 njd_s_calc_ext_hindo(NJ_CLASS *iwnn, NJ_UINT8 now) {
 ...
 * @retval  <0  エラー
 */
NJ_INT16 njd_s_check_additional_info(NJ_CLASS *iwnn, NJ_DIC_HANDLE handle, NJ_VOID *add_info, NJ_UINT32 size) {
    NJ_INT16 ret;
    NJ_UINT8 *add_tmp;
    NJ_UINT32 top_addr;
    NJ_UINT32 data_size;
    ...
    if (size <= NJ_DIC_ADD_HEAD_SIZE) {
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_CHECK_ADD_INFO, NJ_ERR_BUFFER_NOT_ENOUGH);
    }
    ...
    if (NJ_INT32_READ(add_tmp) != NJ_DIC_ADD_IDENTIFIER) {
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_CHECK_ADD_INFO, NJ_ERR_FORMAT_INVALID);
    }
    ...
    if (size != data_size) {
        /* サイズエラー */
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_CHECK_ADD_INFO, NJ_ERR_PARAM_ADD_INFO_INVALID_SIZE);
    }
    ...
    if (flag & NJ_DIC_ADD_LEARN_FLG) {
        ...
        if ((max_yomi_len / sizeof(NJ_CHAR)) > NJ_MAX_ADDITIONAL_LEN) {
            ret = NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_CHECK_ADD_INFO, NJ_ERR_FORMAT_INVALID);
        }
    }

    /*
     * 辞書と付加情報領域の共通データ、拡張情報をチェック
     */
    handle_tmp = GET_STORAGE_CACHE_HEAD(handle);
    add_tmp = (NJ_UINT8*)(add_info);
    add_tmp += top_addr;
 ...
 * @retval  >=0  取得文字配列長(ヌル文字含まず)
 */
NJ_INT32 njd_s_get_additional_info(NJ_CLASS *iwnn, NJ_WORD *word, NJ_UINT8 index, NJ_CHAR *add_info, NJ_UINT32 size) {
    NJ_SEARCH_LOCATION *loc;
    NJ_UINT8 *data;
    NJ_UINT32 len = 0;
    NJ_UINT32 current;
    ...
    case NJ_CUR_OP_LINK:
        /* つながり予測検索時 */
        /* つながりデータ番号から単語データ番号、頻度を取得 */
        current = TSUNAGARI_WORD_DATA_NO(TSUNAGARI_DATA_ADDR(GET_STORAGE_CACHE_TUNAGARI(loc->handle), loc->current)); /*NCH_DEF*/
        break; /*NCH_DEF*/
    ...
    case NJ_CUR_OP_REV_FORE:
        ...
        if (loc->ext_area[NJ_TYPE_EXT_AREA_MORPHO] != NULL) {
            ...
            offset = HYOKI_INDEX_OFFSET(HYOKI_IDX_AREA_TOP_OFFSET(GET_STORAGE_CACHE_HEAD(loc->handle)), loc->current);
            if (njd_offset_fread_cache(((NJ_STORAGE_DIC_INFO*)loc->handle), NJ_SDIC_STORAGE_HYOKI_INDEX,
                                       offset, HYOKI_INDEX_DATA_AREA_SIZE, &idx_cur_addr) < 0) {
                return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_ADD_INFO, NJ_ERR_INVALID_RESULT);    /* NCH_FB */
            }
            current = HYOKI_INDEX_WORD_NO(idx_cur_addr);
        }
        break;
    ...
    default:
        /* 上記以外の検索結果の場合はエラーとする。*/
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_ADD_INFO, NJ_ERR_INVALID_RESULT); /*NCH*/
    }
    ...
    if (size < ((len + NJ_TERM_LEN) * sizeof(NJ_CHAR))) {
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_ADD_INFO, NJ_ERR_BUFFER_NOT_ENOUGH);
    }
    if ((index == 0) &&
        (ADD_LEARN_FLG(data_top_addr) == NJ_DIC_ADD_LEARN_FLG)) {
        if (len > NJ_MAX_ADDITIONAL_LEN) {
            return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_ADD_INFO, NJ_ERR_BUFFER_NOT_ENOUGH); /*NCH_DEF*/
        }
    }
 ...
 * @retval  <0  エラー
 */
NJ_INT16 njd_s_delete_word_ext(NJ_CLASS *iwnn, NJ_WORD_INFO *info, NJ_UINT16 idx) {
    NJ_INT16 ret;
    NJ_UINT8 *ext_tmp;
    NJ_UINT8 *ext_top;
    NJ_UINT8 *ext_current;
    ...
    if (iwnn->dic_set.dic[idx].ext_area[NJ_TYPE_EXT_AREA_DEFAULT] == NULL) {
        ...
        /*
         * 学習単語が、現在対象となっている統合辞書(ストレージ辞書)とは異なる場合に、
         * 統合辞書(ストレージ辞書)内を検索し、該当単語が存在した場合に頻度学習クリアを行う。
         */
        /* 辞書ハンドルをセーブ */
        handle = iwnn->dic_set.dic[idx].handle;
        word_id = 0;
        ...
        if (ext_tmp != NULL) {
            ...
            while (word_idx <= yomi_end) {
                /* 単語の情報を取得する */
                data_offset = WORD_DATA_OFFSET_FROM_DIC_TYPE(is_hicomp, word_offset, word_idx);
                if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)handle, NJ_SDIC_STORAGE_WORD_DATA,
                                           data_offset, GET_WORD_DATA_AREA_SIZE(handle), &data) < 0) {
                    /*
                     * ファイルポインタから読み込み出来ない場合
                     * 検索終了の属性を設定
                     */
...
/**
 * ストレージ辞書アダプタ ストレージ辞書キャッシュサイズ取得
 *
 * @param[in]  iwnn        解析情報クラス
 * @param[in]  dictype     辞書タイプ
 ...
 * @retval  <0   エラー
 */
NJ_INT32 njd_s_get_storage_dic_cache_size(NJ_CLASS *iwnn, NJ_UINT32 dictype, NJ_FILE* filestream, NJ_UINT32 mode) {
    NJ_UINT32 cache_size[NJ_STORAGE_DIC_CACHE_MAX];
    NJ_UINT32 offset[NJ_STORAGE_DIC_CACHE_MAX];
    NJ_INT32 ret;
    NJ_UINT32 dicsize;

    ret = sdic_get_storage_dic_cache_size(iwnn, dictype, filestream, &cache_size[0], &offset[0], &dicsize, mode);
    if (ret < 0) {
        return ret;
    }
 ...
 * @retval  !=0  エラー
 */
NJ_INT32 njd_s_set_storage_dic_info(NJ_CLASS *iwnn, NJ_STORAGE_DIC_INFO *fdicinfo, NJ_UINT32 dictype, 
                                    NJ_FILE* filestream, NJ_UINT8 *cache_area, NJ_UINT32 cache_size, NJ_UINT32 mode) {
    NJ_UINT8 *ptr, *tmp_ptr;
    NJ_INT32 ret;
    NJ_UINT32 size[NJ_STORAGE_DIC_CACHE_MAX];
    NJ_UINT32 offset[NJ_STORAGE_DIC_CACHE_MAX];
    NJ_INT32 i, j;

    ptr = cache_area;

    fdicinfo->dictype = dictype | NJ_MASK_STORAGE_DIC_TYPE;
    fdicinfo->filestream = filestream;

    /* 各領域のキャッシュサイズを取得 */
    ret = sdic_get_storage_dic_cache_size(iwnn, dictype, filestream, &size[0], &offset[0], &(fdicinfo->dicsize), mode);
    if (ret < 0) {
        return ret;
    } else if ((NJ_UINT32)ret > cache_size) {
        /* 必要とするキャッシュサイズより小さい場合は、エラーとする */
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_SET_STORAGE_DIC_INFO, NJ_ERR_FORMAT_INVALID);
    }

    /* 動作モードを取得 */
    fdicinfo->mode = NJ_SDIC_GET_STORAGE_MODE(mode);

    /* 各領域の読み込み */
    for (i = 0; i < NJ_STORAGE_DIC_CACHE_MAX; i++) {
        if (size[i] <= 0) {
            fdicinfo->cache_area[i]  = NULL;
            continue;
        }
        switch (i) {
        case NJ_STORAGE_DIC_HEAD :             /* キャッシュ領域：辞書ヘッダ情報             */
        case NJ_SDIC_STORAGE_YOMI_INDEX :      /* キャッシュ領域：読み文字列インデックス領域 */
        case NJ_SDIC_STORAGE_TUNAGARI_INDEX :  /* キャッシュ領域：つながりインデックス領域   */
        case NJ_SDIC_STORAGE_HINSI_NO :        /* キャッシュ領域：品詞番号変換データ領域     */
        case NJ_SDIC_STORAGE_REAL_ZOKUSEI :    /* キャッシュ領域：実属性変換データ領域       */
        case NJ_SDIC_STORAGE_ZOKUSEI :         /* キャッシュ領域：属性データ領域             */
        case NJ_SDIC_STORAGE_TUNAGARI :        /* キャッシュ領域：つながりデータ領域         */
        case NJ_SDIC_STORAGE_HINDO :           /* キャッシュ領域：頻度データ領域             */
        case NJ_SDIC_STORAGE_JITU_MOJI :       /* キャッシュ領域：実文字コード変換データ領域 */
            /* 領域が存在する場合、領域の読み込みを行う */
            if (njd_offset_fread(fdicinfo, offset[i], size[i], ptr) < 0) {
                return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_SET_STORAGE_DIC_INFO, NJ_ERR_STREAM_READ_ERR);
            }
            fdicinfo->cache_area[i]  = ptr;
            ptr += size[i];
            break;

        case NJ_SDIC_STORAGE_HYOKI_INDEX :     /* キャッシュ領域：表記文字列インデックス領域 */
            tmp_ptr = ptr;
            if ((fdicinfo->mode & NJ_STORAGE_MODE_ONMEMORY_MORPHO_DATA) != 0) {
                /* 辞書先頭からのオフセットを格納する */
                NJ_INT32_WRITE(tmp_ptr, offset[i]);
                tmp_ptr += sizeof(NJ_UINT32);

                /* 領域が存在する場合、領域の読み込みを行う */
                if (njd_offset_fread(fdicinfo, offset[i], (size[i] - sizeof(NJ_UINT32)), tmp_ptr) < 0) {
                    return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_SET_STORAGE_DIC_INFO, NJ_ERR_STREAM_READ_ERR);
                }
                fdicinfo->cache_area[i]  = ptr;
            } else {
                /* キャッシュエリアをブロックサイズにあわせて読込みを行う。 */
                while ((((NJ_UINT32)tmp_ptr) % NJ_SDIC_HASH_BLOCK_SIZE) != 0) {
                    tmp_ptr++;
                }
                for (j = 0; j < NJ_SDIC_HASH_SIZE; j++) {
                    /* ハッシュ領域のOFFSETをクリアする */
                    ((NJ_STORAGE_DIC_CACHE_HYOKI_INDEX *)tmp_ptr)->hash_data[j].offset = 0;
                }
                fdicinfo->cache_area[i]  = tmp_ptr;
            }
            ptr += size[i];
            break;

        case NJ_SDIC_STORAGE_WORD_DATA :       /* キャッシュ領域：単語データ領域             */
            tmp_ptr = ptr;
            if ((fdicinfo->mode & NJ_STORAGE_MODE_ONMEMORY_WORD_DATA) != 0) {
                ...
                for (j = 0; j < NJ_SDIC_HASH_SIZE; j++) {
                    /* ハッシュ領域のOFFSETをクリアする */
                    ((NJ_STORAGE_DIC_CACHE_WORD_DATA *)tmp_ptr)->hash_data[j].offset = 0;
                }
                fdicinfo->cache_area[i]  = tmp_ptr;
            }
            ptr += size[i];
        ...
        case NJ_SDIC_STORAGE_YOMI_HYOKI :      /* キャッシュ領域：読み表記領域               */
            tmp_ptr = ptr;
            if ((fdicinfo->mode & NJ_STORAGE_MODE_ONMEMORY_STRING_DATA) != 0) {
                ...
                for (j = 0; j < NJ_SDIC_HASH_SIZE; j++) {
                    /* ハッシュ領域のOFFSETをクリアする */
                    ((NJ_STORAGE_DIC_CACHE_YOMI_HYOKI *)tmp_ptr)->hash_data[j].offset = 0;
                }
                fdicinfo->cache_area[i]  = tmp_ptr;
            }
            ptr += size[i];
...
/**
 * ストレージ辞書アダプタ ストレージ辞書キャッシュサイズの計算処理
 *
 * @param[in]   iwnn        解析情報クラス
 * @param[in]   dictype     辞書タイプ
 * @param[in]   filestream  ファイルポインタ
 * @param[out]  size        各領域ごとのキャッシュサイズ
 * @param[out]  offset      各領域ごとの先頭オフセット
 * @param[out]  dic_size    辞書全体のサイズ
 * @param[in]   mode        動作モード
 *
 * @retval  >=0  キャッシュサイズ
 * @retval  <0   エラー
...
{
    NJ_UINT32 tmp_size;
    NJ_UINT8 buf[NJ_SDIC_EXT_MAX_SIZE];
    NJ_UINT8 *ptr;
    NJ_UINT32 top, bottom;
    NJ_INT32 ret, i;
    NJ_UINT32 storage_mode;
    ...
    *dic_size = 0;
    ...
    /* 共通ヘッダサイズを取得 */
    tmp_size = NJ_DIC_COMMON_HEADER_SIZE;

    /* 拡張情報サイズの取得 */
    /* ファイルポインタを先頭へシークする */
    ret = nj_fseek(filestream,  NJ_DIC_POS_EXT_SIZE, NJ_FILE_IO_SEEK_SET);
    if (ret != 0) {
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_STORAGE_DIC_CACHE_SIZE, NJ_ERR_STREAM_SEEK_ERR);
    }

    /* 共通ヘッダから拡張情報サイズを取得 */
    ret = nj_fread(buf, 4, filestream);
    if (ret == 0) {
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_STORAGE_DIC_CACHE_SIZE, NJ_ERR_STREAM_READ_ERR);
    }
    tmp_size += NJ_INT32_READ(buf);
    size[NJ_STORAGE_DIC_HEAD] = tmp_size;
    offset[NJ_STORAGE_DIC_HEAD] = 0;

    if (tmp_size > sizeof(buf)) {
        /* 一時バッファよりサイズが大きい場合 */
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_STORAGE_DIC_CACHE_SIZE, NJ_ERR_FORMAT_INVALID);
    }

    /* 共通ヘッダ、拡張情報をファイルポインタから取得 */
    /* ファイルポインタを先頭へシークする */
    ret = nj_fseek(filestream,  0, NJ_FILE_IO_SEEK_SET);
    if (ret != 0) {
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_STORAGE_DIC_CACHE_SIZE, NJ_ERR_STREAM_SEEK_ERR);
    }
    /* 共通ヘッダ・拡張情報サイズを取得 */
    ret = nj_fread(buf, tmp_size, filestream);
    if (ret == 0) {
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_STORAGE_DIC_CACHE_SIZE, NJ_ERR_STREAM_READ_ERR);
    }

    /* 読み込んだ共通ヘッダ・拡張情報領域の先頭ポインタを格納 */
    ptr = &buf[0];

    /* 辞書ファイル全体のサイズを算出 */
    *dic_size = size[NJ_STORAGE_DIC_HEAD] + NJ_INT32_READ(ptr + NJ_DIC_POS_DATA_SIZE);

    /* 動作モードを取得する */
    storage_mode = NJ_SDIC_GET_STORAGE_MODE(mode);

    /* 読み文字列インデックス領域サイズ取得 */
    top      = 0;
    tmp_size = 0;
    if (YOMI_IDX_AREA_CNT(ptr) > 0) {
        /* 登録数がある場合のみ、領域サイズを算出する */

        /* 領域の先頭オフセットを取得 */
        top = YOMI_IDX_AREA_TOP_OFFSET(ptr);

        /* 次領域の先頭オフセットを取得 */
        if (TSUNAGARI_IDX_AREA_TOP_OFFSET(ptr) != 0) {
            /* つながりインデックス領域が存在する場合 */
            bottom = TSUNAGARI_IDX_AREA_TOP_OFFSET(ptr);
        } else if (HYOKI_IDX_AREA_TOP_OFFSET(ptr) != 0) {
            /* 表記文字列インデックス領域が存在する場合 */
            bottom = HYOKI_IDX_AREA_TOP_OFFSET(ptr);
        } else {
            /* 品詞番号変換データ領域が存在する場合(常に存在する領域) */
            bottom = HINSI_NO_AREA_TOP_OFFSET(ptr);
        }

        /*
         * 領域と次領域の先頭オフセット差異を取得し、
         * 必要となる領域サイズを算出する。
         */
        if (bottom > top) {
            tmp_size = (bottom - top);
    ...
    size[NJ_SDIC_STORAGE_YOMI_INDEX]   = tmp_size;
    offset[NJ_SDIC_STORAGE_YOMI_INDEX] = top;


    /* つながりインデックス領域サイズ取得 */
    top      = 0;
    tmp_size = 0;
    if (TSUNAGARI_IDX_AREA_CNT(ptr) > 0) {
        /* 登録数がある場合のみ、領域サイズを算出する */

        /* 領域の先頭オフセットを取得 */
        top = TSUNAGARI_IDX_AREA_TOP_OFFSET(ptr);

        /* 領域が存在しない場合は、サイズ算出処理を行わない */
        if (top != 0) {
            /* 次領域の先頭オフセットを取得 */
            if (HYOKI_IDX_AREA_TOP_OFFSET(ptr) != 0) {
                /* 表記文字列インデックス領域が存在する場合 */
                bottom = HYOKI_IDX_AREA_TOP_OFFSET(ptr);
            } else {
                /* 品詞番号変換データ領域が存在する場合(常に存在する領域) */
    ...
    size[NJ_SDIC_STORAGE_TUNAGARI_INDEX]   = tmp_size;
    offset[NJ_SDIC_STORAGE_TUNAGARI_INDEX] = top;


    /* 表記文字列インデックス領域サイズ取得 */
    if ((storage_mode & NJ_STORAGE_MODE_ONMEMORY_MORPHO_DATA) != 0)  {
        /* メモリ展開を行う*/
        top      = 0;
        tmp_size = 0;
        if (HYOKI_IDX_AREA_CNT(ptr) > 0) { 
            /* 登録数がある場合のみ、領域サイズを算出する */

            /* 領域の先頭オフセットを取得 */
            top = HYOKI_IDX_AREA_TOP_OFFSET(ptr);

            /* 領域が存在しない場合は、サイズ算出処理を行わない */
            if (top != 0) {
                /* 次領域(品詞番号変換データ領域)の先頭オフセットを取得 */
                bottom = HINSI_NO_AREA_TOP_OFFSET(ptr);
                 ...
                 */
                if (bottom > top) {
                    tmp_size = (bottom - top) + sizeof(NJ_UINT32);
                } else {
                    return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_STORAGE_DIC_CACHE_SIZE, NJ_ERR_FORMAT_INVALID);
                }
            }
        }
        size[NJ_SDIC_STORAGE_HYOKI_INDEX]   = tmp_size;
        offset[NJ_SDIC_STORAGE_HYOKI_INDEX] = top;
    } else {
        /* キャッシュ領域のサイズを格納する */
        size[NJ_SDIC_STORAGE_HYOKI_INDEX]   = sizeof(NJ_STORAGE_DIC_CACHE_HYOKI_INDEX) + NJ_SDIC_HASH_BLOCK_SIZE;
        offset[NJ_SDIC_STORAGE_HYOKI_INDEX] = 0;
    }
    ...
    top      = 0;
    tmp_size = 0;
    if ((FHINSI_NO_CNT(ptr) > 0) &&
        (BHINSI_NO_CNT(ptr) > 0)) { 
        /* 登録数がある場合のみ、領域サイズを算出する */

        /* 領域の先頭オフセットを取得 */
        top = HINSI_NO_AREA_TOP_OFFSET(ptr);
        /* 次領域(単語データ領域)の先頭オフセットを取得 */
        bottom = WORD_TOP_OFFSET(ptr);
    ...
    size[NJ_SDIC_STORAGE_HINSI_NO]   = tmp_size;
    offset[NJ_SDIC_STORAGE_HINSI_NO] = top;

    /* 単語データ領域サイズ取得 */
    if ((storage_mode & NJ_STORAGE_MODE_ONMEMORY_WORD_DATA) != 0)  {
        /* メモリ展開を行う*/
        top      = 0;
        tmp_size = 0;
        if (WORD_AREA_CNT(ptr) > 0) { 
            /* 登録数がある場合のみ、領域サイズを算出する */

            /* 領域の先頭オフセットを取得 */
            top = WORD_TOP_OFFSET(ptr);

            /* 領域が存在しない場合は、サイズ算出処理を行わない */
            if (top != 0) {
                /* 次領域の先頭オフセットを取得 */
                if (((dictype == NJ_DIC_TYPE_FUSION) || (dictype == NJ_DIC_TYPE_FUSION_HIGH_COMPRESS)) &&
                    (REAL_ZOKUSEI_AREA_TOP_OFFSET(ptr) != 0)) {
                    /* 実属性変換データ領域が存在する場合(統合辞書(ストレージ辞書)iWnnタイプのみ存在する領域) */
                    bottom = REAL_ZOKUSEI_AREA_TOP_OFFSET(ptr);
                } else if (((dictype == NJ_DIC_TYPE_FUSION) || (dictype == NJ_DIC_TYPE_FUSION_HIGH_COMPRESS)) &&
                           (ZOKUSEI_AREA_TOP_OFFSET(ptr) != 0)) {
                    /* 属性データ領域が存在する場合(統合辞書(ストレージ辞書)iWnnタイプのみ存在する領域) */
                    bottom = ZOKUSEI_AREA_TOP_OFFSET(ptr); /*NCH*/
                } else if (TSUNAGARI_TOP_OFFSET(ptr) != 0) {
                    /* つながりデータ領域が存在する場合 */
                    bottom = TSUNAGARI_TOP_OFFSET(ptr);
                } else {
                    /* 読み・表記領域が存在する場合(常に存在する領域) */
                    bottom = YOMI_HYOKI_TOP_OFFSET(ptr);
                }
        ...
        size[NJ_SDIC_STORAGE_WORD_DATA]   = tmp_size;
        offset[NJ_SDIC_STORAGE_WORD_DATA] = top;
    } else {
        /* キャッシュ領域のサイズを格納する */
        size[NJ_SDIC_STORAGE_WORD_DATA]   = sizeof(NJ_STORAGE_DIC_CACHE_WORD_DATA) + NJ_SDIC_HASH_BLOCK_SIZE;
        offset[NJ_SDIC_STORAGE_WORD_DATA] = 0;
    }

    if ((dictype == NJ_DIC_TYPE_FUSION) || (dictype == NJ_DIC_TYPE_FUSION_HIGH_COMPRESS)) {
        /*
         * 実属性データ、属性データは、統合辞書(ストレージ辞書)iWnn/高圧縮タイプでのみ存在する領域のため、
         * 領域が存在しない場合は、スキップする。
         */
        ...
        top      = 0;
        tmp_size = 0;
        if (REAL_ZOKUSEI_AREA_CNT(ptr) > 0) {
            /* 登録数がある場合のみ、領域サイズを算出する */

            /* 領域の先頭オフセットを取得 */
            top = REAL_ZOKUSEI_AREA_TOP_OFFSET(ptr);

            /* 領域が存在しない場合は、サイズ算出処理を行わない */
            if (top != 0) {
                /* 次領域(属性データ領域)の先頭オフセットを取得 */
                bottom = ZOKUSEI_AREA_TOP_OFFSET(ptr);
        ...
        size[NJ_SDIC_STORAGE_REAL_ZOKUSEI]   = tmp_size;
        offset[NJ_SDIC_STORAGE_REAL_ZOKUSEI] = top;
        ...
        if (WORD_AREA_CNT(ptr) > 0) { 
            ...
            /* 領域の先頭オフセットを取得 */
            top = ZOKUSEI_AREA_TOP_OFFSET(ptr);

            /* 領域が存在しない場合は、サイズ算出処理を行わない */
            if (top != 0) {
                /* 次領域の先頭オフセットを取得 */
                if (TSUNAGARI_TOP_OFFSET(ptr) != 0) {
                    /* つながりデータ領域が存在する場合 */
                    bottom = TSUNAGARI_TOP_OFFSET(ptr);
                } else {
                    /* 読み・表記領域が存在する場合(常に存在する領域) */
        ...
        size[NJ_SDIC_STORAGE_ZOKUSEI]   = tmp_size;
        offset[NJ_SDIC_STORAGE_ZOKUSEI] = top;

    } else {
        size[NJ_SDIC_STORAGE_REAL_ZOKUSEI]   = 0;
        size[NJ_SDIC_STORAGE_ZOKUSEI]        = 0;
        offset[NJ_SDIC_STORAGE_REAL_ZOKUSEI] = 0;
        offset[NJ_SDIC_STORAGE_ZOKUSEI]      = 0;
    }

    if (dictype == NJ_DIC_TYPE_FUSION_HIGH_COMPRESS) {
        /*
         * 実文字コード変換データ領域は、統合辞書(ストレージ辞書)高圧縮タイプでのみ存在する領域のため、
         * 領域が存在しない場合は、スキップする。
         */

        /* 実文字コード変換データインデックス領域サイズ取得 */
        top      = 0;
        tmp_size = 0;
        if (JITU_MOJI_HENKAN_DATA_AREA_CNT(ptr) > 0)  {

            /* 領域の先頭オフセットを取得 */
            top = JITU_MOJI_HENKAN_DATA_AREA_TOP_OFFSET(ptr);
            bottom = 0;
        ...
        size[NJ_SDIC_STORAGE_JITU_MOJI]   = tmp_size;
        offset[NJ_SDIC_STORAGE_JITU_MOJI] = top;

    } else {
        size[NJ_SDIC_STORAGE_JITU_MOJI]      = 0;
        offset[NJ_SDIC_STORAGE_JITU_MOJI]    = 0;
    }

    /* つながりデータ領域サイズ取得 */
    top      = 0;
    tmp_size = 0;
    if (TSUNAGARI_AREA_CNT(ptr) > 0) { 
        /* 登録数がある場合のみ、領域サイズを算出する */

        /* 領域の先頭オフセットを取得 */
        top = TSUNAGARI_TOP_OFFSET(ptr);

        /* 領域が存在しない場合は、サイズ算出処理を行わない */
        if (top != 0) {
            /* 次領域(読み・表記領域)の先頭オフセットを取得 */
            bottom = YOMI_HYOKI_TOP_OFFSET(ptr);
    ...
    size[NJ_SDIC_STORAGE_TUNAGARI]   = tmp_size;
    offset[NJ_SDIC_STORAGE_TUNAGARI] = top;

    /* 読み・表記領域サイズ取得 */
    if ((storage_mode & NJ_STORAGE_MODE_ONMEMORY_STRING_DATA) != 0)  {
        /* メモリ展開を行う */
        top      = 0;
        tmp_size = 0;
        if (WORD_AREA_CNT(ptr) > 0) { 
            ...
            /* 領域の先頭オフセットを取得 */
            top = YOMI_HYOKI_TOP_OFFSET(ptr);

            /* 領域が存在しない場合は、サイズ算出処理を行わない */
            if (top != 0) {
                /* 次領域(頻度データ領域)の先頭オフセットを取得 */
                bottom = HINDO_TOP_OFFSET(ptr);
        ...
        size[NJ_SDIC_STORAGE_YOMI_HYOKI]   = tmp_size;
        offset[NJ_SDIC_STORAGE_YOMI_HYOKI] = top;
    } else {
        /* キャッシュ領域のサイズを格納する */
        size[NJ_SDIC_STORAGE_YOMI_HYOKI]   = sizeof(NJ_STORAGE_DIC_CACHE_YOMI_HYOKI) + NJ_SDIC_HASH_BLOCK_SIZE;
        offset[NJ_SDIC_STORAGE_YOMI_HYOKI] = 0;
    }
    ...
    if (WORD_AREA_CNT(ptr) > 0) { 
        ...
        /* 領域の先頭オフセットを取得 */
        top = HINDO_TOP_OFFSET(ptr);
        /* 次領域(辞書終端識別子)の先頭オフセットを取得 */
        bottom = (NJ_DIC_COMMON_HEADER_SIZE + NJ_INT32_READ(ptr + NJ_DIC_POS_DATA_SIZE) + NJ_INT32_READ(ptr + NJ_DIC_POS_EXT_SIZE)) - NJ_DIC_ID_LEN;
    ...
    size[NJ_SDIC_STORAGE_HINDO]   = tmp_size;
    offset[NJ_SDIC_STORAGE_HINDO] = top;
 ...
 * @retval  <0  エラー
 */
NJ_INT32 njd_s_get_user_prof_data_size(NJ_CLASS *iwnn, NJ_DIC_HANDLE handle, NJ_VOID *ext_area, NJ_EXT_HINDO_INFO *ext_hindo_info) {
    NJ_INT32 ret = 0;
    ...
    /* 辞書データより、単語登録数を取得 */
    word_cnt = WORD_AREA_CNT(head_addr);
    ...
    if (word_cnt != chk_size) {
        ...
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_USER_PROF_DATA_SIZE, NJ_ERR_PARAM_EXT_AREA_INVALID);
    }
    ...
    /* 頻度学習データの先頭アドレスを取得 */
    ext_top = EXT_AREA_TOP_ADDR((NJ_UINT8 *)ext_area, GET_STORAGE_CACHE_HEAD(handle));
    ext_cur = ext_top;
    ...
    for (cnt = 1; cnt <= word_cnt; cnt++) {
        ...
        if (*ext_cur != 0) {
            /* 単語データのアドレス */
            offset = WORD_DATA_OFFSET_FROM_DIC_TYPE(is_hicomp, wtbl_offset, cnt);

            /* ストレージデータから単語データの読み部分の読み込みを行う */
            if (njd_offset_fread_cache((NJ_STORAGE_DIC_INFO*)handle, NJ_SDIC_STORAGE_WORD_DATA,
                                       offset, WORD_DATA_YOMI_DATA_SIZE, &data_cur) < 0) {
                return 0;   /*NCH_FB*/
            }
            ...
            /* 高圧縮タイプは表記サイズを加算しない */
            if (!is_hicomp) {
                /* ストレージデータから読み・表記部分の読み込みを行う */
                ryomi_len = get_stem_yomi_string(handle, data_cur, tmp_buff, YOMI_LEN_BYTE(data_cur), sizeof(tmp_buff));
 ...
 * @retval  <0  エラー
 */
NJ_INT32 njd_s_export_user_prof_data(NJ_CLASS *iwnn, NJ_DIC_HANDLE handle,
    ...
    if (word_cnt != chk_size) {
        /* 辞書データと頻度学習データが一致しない場合 */
        return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_EXP_USER_PROF_DATA, NJ_ERR_PARAM_EXT_AREA_INVALID);
    }

    /* 単語データ領域先頭アドレスを取得 */
    wtbl_offset = WORD_TOP_OFFSET(GET_STORAGE_CACHE_HEAD(handle));
    yhtbl_offset = YOMI_HYOKI_TOP_OFFSET(GET_STORAGE_CACHE_HEAD(handle));
        ...
        if ((*ext_cur != 0) &&
            ...
            if (!is_hicomp) {
                ...
                *wk_data = wk_len_size;
                ...
                /* 表記サイズ(1byte)を加算 */
                wk_len = HYOKI_LEN(data_cur);
                wk_len_size = wk_len * sizeof(NJ_CHAR);
                *wk_data = HYOKI_LEN_BYTE_INFO(data_cur);
                ...
                /* 表記文字列データサイズを加算 */
                if (wk_len > 0) {
                    wk_size = get_candidate_string(handle, data_cur, yhtbl_offset, tmp_buff);
                    cp_ptr = tmp_buff;
                    i = 0;
                    while (i < wk_len_size) {
                        NJ_CHAR_COPY(wk_data, cp_ptr);
 ...
 * @retval  <0  エラー
 */
NJ_INT32 njd_s_import_user_prof_data(NJ_CLASS *iwnn, NJ_WORD_INFO *info, NJ_UINT16 idx,
    ...
    if (ext_tmp != NULL) {
        ...
        while (word_idx <= yomi_end) {
            ...
            if (word_id != 0) {
                ...
                /* 頻度学習領域の先頭を取得 */
                ext_top = EXT_AREA_TOP_ADDR(ext_tmp, GET_STORAGE_CACHE_HEAD(handle));
 ...
 *
 * @param[in]   handle          辞書ハンドル
 * @param[in]   jitu_len        実文字コード読み配列長
 * @param[in]   jitu_yomi       実文字コード読み文字列
...
static NJ_INT16 convert_str_real_to_virtual(NJ_DIC_HANDLE handle, NJ_CHAR* real_yomi, NJ_UINT16 real_yomi_len, NJ_UINT8* conv_yomi, NJ_UINT16 conv_yomi_size) {
    ...
    max_cnt = JITU_MOJI_HENKAN_DATA_AREA_CNT(GET_STORAGE_CACHE_HEAD(handle));
    /* [実文字コード変換データ領域]実文字格納バイト数 取得 */
    data_size = JITU_MOJI_HENKAN_DATA_AREA_BYTE_SIZE(GET_STORAGE_CACHE_HEAD(handle));
    /* [実文字コード変換データ領域]先頭アドレス 取得 */
    vtbl_addr = GET_STORAGE_CACHE_JITU_MOJI(handle);
 ...
 *
 * @param[in]   handle          辞書ハンドル
 * @param[in]   yomi_len        仮想文字コード読み配列長
...
NJ_INT16 njd_s_get_word(NJ_SEARCH_LOCATION_SET *loctset, NJ_WORD *word) {
    /* エラーで返す */
    return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_WORD, NJ_ERR_OPTION_STORAGE_OFF); /*NCH*/
}
...
NJ_INT16 njd_s_get_candidate(NJ_WORD *word, NJ_CHAR *candidate, NJ_UINT16 size) {
    /* エラーで返す */
    return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_CANDIDATE, NJ_ERR_OPTION_STORAGE_OFF); /*NCH*/
}
...
NJ_INT16 njd_s_get_stroke(NJ_WORD *word, NJ_CHAR *stroke, NJ_UINT16 size) {
    /* エラーで返す */
    return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_STROKE, NJ_ERR_OPTION_STORAGE_OFF); /*NCH*/
}
...
NJ_INT16 njd_s_get_relational_word(NJ_SEARCH_LOCATION *loc,
                                   NJ_WORD *word, NJ_DIC_FREQ *mdic_freq ) {
    /* エラーで返す */
    return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_RELATIONAL_WORD, NJ_ERR_OPTION_STORAGE_OFF); /*NCH*/
}
...
NJ_INT16 njd_s_delete_word(NJ_CLASS *iwnn, NJ_RESULT *result) {
    /* エラーで返す */
    return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_DELETE_WORD, NJ_ERR_OPTION_STORAGE_OFF); /*NCH*/
}
...
NJ_INT16 njd_s_learn_word(NJ_CLASS *iwnn, NJ_WORD *word, NJ_LEARN_WORD_INFO *lword, NJ_UINT16 idx) {
    /* エラーで返す */
    return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_LEARN_WORD, NJ_ERR_OPTION_STORAGE_OFF); /*NCH*/
}
...
NJ_INT16 njd_s_delete_word_ext(NJ_CLASS *iwnn, NJ_WORD_INFO *info, NJ_UINT16 idx) {
    /* エラーで返す */
    return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_DELETE_WORD_EXT, NJ_ERR_OPTION_STORAGE_OFF); /*NCH*/
}
...
NJ_INT32 njd_s_set_storage_dic_info(NJ_CLASS *iwnn, NJ_STORAGE_DIC_INFO *fdicinfo, NJ_UINT32 dictype, 
                                    NJ_FILE* filestream, NJ_UINT8 *cache_area, NJ_UINT32 cache_size, NJ_UINT32 mode) {
    /* エラーで返す */
    return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_SET_STORAGE_DIC_INFO, NJ_ERR_OPTION_STORAGE_OFF); /*NCH*/
}
...
NJ_INT32 njd_s_get_user_prof_data_size(NJ_CLASS *iwnn, NJ_DIC_HANDLE handle, NJ_VOID *ext_area, NJ_EXT_HINDO_INFO *ext_hindo_info) {
    /* 辞書ハンドルエラーとして返す */
    return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_GET_USER_PROF_DATA_SIZE, NJ_ERR_OPTION_STORAGE_OFF);
}


/**
 * ユーザープロファイルデータエクスポートを行う。
 *
 * @param[in]   iwnn            解析情報クラス
 * @param[in]   handle          辞書ハンドル
 * @param[in]   ext_area        頻度学習領域
...
NJ_INT32 njd_s_export_user_prof_data(NJ_CLASS *iwnn, NJ_DIC_HANDLE handle,
                                     NJ_VOID *ext_area, NJ_VOID *exp_data, NJ_EXT_HINDO_INFO *ext_hindo_info, NJ_UINT8 hindo) {
    /* 辞書ハンドルエラーとして返す */
    return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_EXP_USER_PROF_DATA, NJ_ERR_OPTION_STORAGE_OFF);
}
...
NJ_INT32 njd_s_import_user_prof_data(NJ_CLASS *iwnn, NJ_WORD_INFO *info, NJ_UINT16 idx,
                                     NJ_INT16 fhinsi, NJ_INT16 bhinsi, NJ_UINT8 hindo_data) {
    /* 辞書ハンドルエラーとして返す */
    return NJ_SET_ERR_VAL(NJ_FUNC_NJD_S_IMP_USER_PROF_DATA, NJ_ERR_OPTION_STORAGE_OFF);
}
