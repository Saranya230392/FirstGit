...
import com.android.settings.DataUsageSummaryMultiSIM.AppItem;

/**
 * Loader for historical chart data for both network and UID details.
 */
public class ChartDataLoaderMultiSIM extends AsyncTaskLoader<ChartData> {
    ...
    public ChartDataLoaderMultiSIM(Context context, INetworkStatsSession session, Bundle args) {
        super(context);
        mSession = session;
        mArgs = args;
    }
