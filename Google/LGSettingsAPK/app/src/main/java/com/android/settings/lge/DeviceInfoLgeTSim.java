...
public class DeviceInfoLgeTSim extends SettingsPreferenceFragment
        implements Preference.OnPreferenceClickListener {
    private static final String LOG_TAG = "aboutphone # DeviceInfoLgeTSim";

    private static final String TAB_SIM1 = "sim1";
    private static final String TAB_SIM2 = "sim2";
    private static final String TAB_SIM3 = "sim3";
    ...
    public static String sim3_state = "";
    ...
    private static final boolean MENU_ACTIVATE = true;
    private static final boolean MENU_NOT_ACTIVATE = false;
...
//            mDeviceNamePref.getEditText().setRawInputType(InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        /*        
                mTabHost.addTab(buildTabSpec(TAB_SIM1, R.string.sp_sim1_number_NORMAL));
                mTabHost.addTab(buildTabSpec(TAB_SIM2, R.string.sp_sim2_number_NORMAL));
                mTabHost.addTab(buildTabSpec(TAB_SIM3, R.string.sp_sim3_number_NORMAL));
        */
        mTabHost.addTab(buildTabSpec(TAB_SIM1, OverlayUtils.getMSimTabName(context,
                SettingsConstants.System.SIM1_NAME)));
        mTabHost.addTab(buildTabSpec(TAB_SIM2, OverlayUtils.getMSimTabName(context,
                SettingsConstants.System.SIM2_NAME)));
        mTabHost.addTab(buildTabSpec(TAB_SIM3, OverlayUtils.getMSimTabName(context,
        ...
        // [S][2012.11.01][yongjaeo.lee@lge.com] changed tab width, size
        /*
        mTabWidget.setMeasureWithLargestChildEnabled(false);
        mTabHost.getTabWidget().getChildAt(0).getLayoutParams().width = 1;
        */
        // [E]
        ...
        sim3_state = OverlayUtils.get_SIM_state(getActivity().getApplicationContext(), 2);
    ...
    private void display_multiSIM_tab12_menu(boolean activate) {
        addPreferencesFromResource(R.xml.device_info_lge_dsim_tab12);
        mListView.setVisibility(View.VISIBLE);
        img_view.setVisibility(View.GONE);

        if (getPreferenceScreen() != null) {
            getPreferenceScreen().setEnabled(activate);
        }
    }
        ...
        if (mCurrentTab.equals(TAB_SIM1) || mCurrentTab.equals(TAB_SIM2)
            ...
            if (mCurrentTab.equals(TAB_SIM1)) {
                if (insertedSimvalue == IN_SIM_1 || insertedSimvalue == IN_SIM_1_2
                        || insertedSimvalue == IN_SIM_1_3 || insertedSimvalue == IN_SIM_1_2_3) { // sim inserted in SIM1 Slot
                    ...
                    } else if (sim1_state.equals("unknown")) {
                        display_multiSIM_tab12_menu(MENU_NOT_ACTIVATE);
                    } else {
                        display_multiSIM_tab12_menu(MENU_ACTIVATE);
                    }
                } else {
                    mListView.setVisibility(View.GONE);
                    img_view.setVisibility(View.VISIBLE);
            ...
            } else if (mCurrentTab.equals(TAB_SIM2)) {
                if (insertedSimvalue == IN_SIM_2 || insertedSimvalue == IN_SIM_1_2
                        || insertedSimvalue == IN_SIM_2_3 || insertedSimvalue == IN_SIM_1_2_3) { // sim inserted in SIM2 Slot
                    ...
                    } else if (sim2_state.equals("unknown")) {
                        display_multiSIM_tab12_menu(MENU_NOT_ACTIVATE);
                    } else {
                        display_multiSIM_tab12_menu(MENU_ACTIVATE);
                    }
                ...
                if (insertedSimvalue == IN_SIM_3 || insertedSimvalue == IN_SIM_1_3
                        || insertedSimvalue == IN_SIM_2_3 || insertedSimvalue == IN_SIM_1_2_3) { // sim inserted in SIM2 Slot
                    if (sim3_state.equals("pin_lock") || sim3_state.equals("puk_lock")
                            || sim3_state.equals("perm_lock")) { // sim lock check
                        mListView.setVisibility(View.GONE);
                        img_view.setVisibility(View.VISIBLE);

                        if (sim3_state.equals("pin_lock")) {
                            mTextView_sim3.setText(getString(R.string.sp_sim3pinlocked_new_NORMAL));
                        } else if (sim3_state.equals("puk_lock")) {
                            mTextView_sim3.setText(getString(R.string.sp_sim3puklocked_new_NORMAL));
                        } else {
                            mTextView_sim3.setText(getString(R.string.sp_sim3permlocked_new_NORMAL));
                        }
                        mTextView_sim3.setVisibility(View.VISIBLE);
                    } else if (sim3_state.equals("unknown")) {
                        display_multiSIM_tab12_menu(MENU_NOT_ACTIVATE);
                    } else {
                        display_multiSIM_tab12_menu(MENU_ACTIVATE);
                    }
            ...
            if (mAboutPhonePreference != null) {
                if (TelephonyManager.PHONE_TYPE_CDMA != activePhoneType) {
                    ...
                    mAboutPhonePreference
                            .setSummary(getString(R.string.sp_PhoneSummary_MEID_NORMAL));
                }
            }
