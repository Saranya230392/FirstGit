...
public class RcsAgreeSettings extends Activity {
    private static final String TAG = "RcsAgreeSettings";
    private ContentResolver mContentResolver;
    public static final String CONTENT_URI = "content://com.lge.ims.ac.termsprovider/terms";
    //private String agreeTitle = null;
            ...
            if (Config.getOperator().equals("LGU")) {
                if (mCursor != null && mCursor.moveToFirst()) {
                    if (mCursor.getInt(mCursor.getColumnIndex("_id")) == 2) {
                        //agreeTitle = (mCursor.getString(mCursor.getColumnIndex("title")));
                        agreeUrl = (mCursor.getString(mCursor.getColumnIndex("url")));
                    }
