...
public class SettingsPreferenceFragment extends PreferenceFragment implements DialogCreatable {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPinnedHeaderFrameLayout = new FrameLayout(getActivity());
        //(ViewGroup)root.findViewById(R.id.pinned_header);
        FrameLayout.LayoutParams params =
                new FrameLayout.LayoutParams(
                        FrameLayout.LayoutParams.WRAP_CONTENT,
                        FrameLayout.LayoutParams.WRAP_CONTENT);
        ((ViewGroup)root).addView(mPinnedHeaderFrameLayout, 0, params);
        return root;
    }
    ...
    public boolean startFragment(
            Fragment caller, String fragmentClass, int requestCode, Bundle extras, int titleres) {
        if (getActivity() instanceof PreferenceActivity) {
            PreferenceActivity preferenceActivity = (PreferenceActivity)getActivity();
            preferenceActivity.startPreferencePanel(fragmentClass, extras,
