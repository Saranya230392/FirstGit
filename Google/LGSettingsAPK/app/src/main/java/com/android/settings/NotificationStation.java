...
/*    private INotificationListener.Stub mListener = new INotificationListener.Stub() {
        @Override
        public void onNotificationPosted(StatusBarNotification notification, NotificationRankingUpdate paramNotificationRankingUpdate) throws RemoteException {
        ...
        @Override
        public void onNotificationRemoved(StatusBarNotification notification, NotificationRankingUpdate paramNotificationRankingUpdate)
        ...
        @Override
        public void onListenerConnected(NotificationRankingUpdate paramNotificationRankingUpdate) throws RemoteException {
        }
    ...
    private List<HistoricalNotificationInfo> loadNotifications() {
        ...
        try {
            StatusBarNotification[] active = mNoMan.getActiveNotifications(mContext
                    .getPackageName());
            ...
            for (StatusBarNotification[] resultset : new StatusBarNotification[][] { active,
                    dismissed }) {
