...
public class KeyboardLayoutDialogFragment extends DialogFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mInputDeviceIdentifier = (InputDeviceIdentifier)savedInstanceState.getParcelable("inputDeviceIdentifier");
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putParcelable("inputDeviceIdentifier", mInputDeviceIdentifier);
    }
