...
import com.android.settings.applications.AccessLockState.AppOpEntry;

public class AccessLockCategory extends ListFragment implements
        LoaderManager.LoaderCallbacks<List<AppOpEntry>> {

    private static final int RESULT_APP_DETAILS = 1;

    AccessLockState mState;
    ...
    public AccessLockCategory() {
    }

    public AccessLockCategory(AccessLockState.OpsTemplate template) {
    ...
    public static class AppListLoader extends AsyncTaskLoader<List<AppOpEntry>> {
        ...
        final AccessLockState mState;
        final AccessLockState.OpsTemplate mTemplate;

        List<AppOpEntry> mApps;
        PackageIntentReceiver mPackageObserver;

        public AppListLoader(Context context, AccessLockState state,
                AccessLockState.OpsTemplate template) {
            super(context);
            mState = state;
            mTemplate = template;
        }
    ...
    public static class AppListAdapter extends BaseAdapter {
        ...
        public AppListAdapter(Context context, AccessLockState state) {
    ...
    private void startApplicationDetailsActivity() {
        ...
        Bundle args = new Bundle();
        args.putString(AccessLockDetails.ARG_PACKAGE_NAME, mCurrentPkgName);

        PreferenceActivity pa = (PreferenceActivity)getActivity();
        pa.startPreferencePanel(AccessLockDetails.class.getName(), args,
    ...
    public Loader<List<AppOpEntry>> onCreateLoader(int id, Bundle args) {
        ...
        AccessLockState.OpsTemplate template = null;
        if (fargs != null) {
            template = (AccessLockState.OpsTemplate)fargs.getParcelable("template");
            int length = template.ops.length;
