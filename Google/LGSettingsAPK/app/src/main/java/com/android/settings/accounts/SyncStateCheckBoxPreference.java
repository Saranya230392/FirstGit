...
public class SyncStateCheckBoxPreference extends CheckBoxPreference {
    ...
    public void onBindView(View view) {
        ...
        if (mOneTimeSyncMode) {
             ...
             * line).
             */
            // [LG APPS] different description such as 'Tap to update'
            TextView summary = (TextView)view.findViewById(android.R.id.summary);
            if (mAccount.type.startsWith(AccountsGroupSettingsActivity.LG_ACCOUNTS_FOR_WIDGET_TYPE)) {
                summary.setText(getContext().getString(R.string.sp_tap_update_NORMAL, getSummary()));
            } else {
