...
public class LinearColorBar extends LinearLayout {
    static int LEFT_COLOR;
    static int MIDDLE_COLOR;
    static int RIGHT_COLOR;
    ...
    public LinearColorBar(Context context, AttributeSet attrs) {
        ...
        if (Utils.isUI_4_1_model(context)) {
            LEFT_COLOR = 0xff1ddbd8;
            MIDDLE_COLOR = 0xff1ddbd8;
            RIGHT_COLOR = 0xffe0e0e0;
            GRAY_COLOR = 0xff555555;
            ...
            LEFT_COLOR = 0xff009688;
            MIDDLE_COLOR = 0xff009688;
            RIGHT_COLOR = 0xffced7db;
            GRAY_COLOR = 0xff555555;
            WHITE_COLOR = 0xffffffff;
        ...
        if (mShowingGreen) {
            ...
            mColorGradientPaint
                    .setShader(new LinearGradient(
                            0, 0, 0, off - 2, mMiddleColor & 0xffffff, mMiddleColor,
