...
public class VolumePreference extends SeekBarDialogPreference implements
    ...
    protected static final String TAG = "VolumePreference";

    protected int mStreamType;

    /** May be null if the dialog isn't visible. */
    protected SeekBarVolumizer mSeekBarVolumizer;
    ...
    public class SeekBarVolumizer implements OnSeekBarChangeListener, Handler.Callback {
        ...
        protected ContentObserver mVolumeObserver = new ContentObserver(mHandler) {
            @Override
