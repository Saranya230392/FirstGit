...
public class CaptionPropertiesFragment extends SettingsPreferenceFragment
    ...
    private static final String INTENT_CAPTION_SETTINGS = "com.lge.accessibility.CAPTIONING_SETTINGS";

    static final String TAG = "CaptionPropertiesFragment";
    ...
    public boolean getAccessibilityDeleteSwitchIntent() {
        ...
        if (action.equals(INTENT_CAPTION_SETTINGS)) {
            return true;
        } else if (action.equals("android.settings.CAPTIONING_SETTINGS")
                && "lg_video_player".equals(intent.getStringExtra("from_package"))) {
    ...
    private void initSwitch() {
        if (getAccessibilityDeleteSwitchIntent()) {
            return;
        }
        mToggleSwitch = new Switch(getActivity());
        mToggleSwitch.setChecked(mCaptioningManager.isEnabled());
        try {
        ...
        mToggleSwitch.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
                ...
                if (mPreviewText != null) {
                    mPreviewText.setVisibility(mToggleSwitch.isChecked() ? View.VISIBLE : View.INVISIBLE);
                }
            }
        });
    }
    ...
    private void setSwitchPadding() {
        ...
        if (null != actionBar) {
            ...
            Log.d(TAG, "CaptionPropertiesFragment/setSwitchPadding");
        }
    }
