...
public class IndexDatabaseHelper extends SQLiteOpenHelper {
    ...
    public interface IndexColumns {
        ...
        public static final String CURRENT_ENABLE = "current_enable";
        public static final String PREPERENCE_TYPE = "preference_type";
        public static final String SETTINGS_DB_TABLE = "settings_db_table";
        public static final String SETTINGS_DB_FIELD = "settings_db_field";
    ...
    private static final String CREATE_INDEX_TABLE = "CREATE VIRTUAL TABLE "
            + Tables.TABLE_PREFS_INDEX + " USING fts4" + "("
            + IndexColumns.LOCALE + ", " + IndexColumns.DATA_RANK + ", "
            ...
            + IndexColumns.DATA_ENTRIES + ", " + IndexColumns.DATA_KEYWORDS
            + ", " + IndexColumns.SCREEN_TITLE + ", " + IndexColumns.CLASS_NAME
            + ", " + IndexColumns.ICON + ", " + IndexColumns.INTENT_ACTION
            + ", " + IndexColumns.INTENT_TARGET_PACKAGE + ", "
            + IndexColumns.INTENT_TARGET_CLASS + ", " + IndexColumns.ENABLED
            + ", " + IndexColumns.DATA_KEY_REF + ", " + IndexColumns.USER_ID
            + ", " + IndexColumns.CURRENT_ENABLE + ", "
            + IndexColumns.PREPERENCE_TYPE + ", "
            + IndexColumns.SETTINGS_DB_TABLE + ", "
            + IndexColumns.SETTINGS_DB_FIELD + ", " + IndexColumns.VISIBLE
            + ", " + IndexColumns.CHECK_VALUE + ");";

    private static final String CREATE_META_TABLE = "CREATE TABLE "
            + Tables.TABLE_META_INDEX + "(" + MetaColumns.BUILD
            + " VARCHAR(32) NOT NULL" + ")";

    private static final String CREATE_SAVED_QUERIES_TABLE = "CREATE TABLE "
            + Tables.TABLE_SAVED_QUERIES + "(" + SavedQueriesColums.QUERY
            + " VARCHAR(64) NOT NULL" + ", " + SavedQueriesColums.TIME_STAMP
            + " INTEGER" + ")";

    private static final String INSERT_BUILD_VERSION = "INSERT INTO "
            + Tables.TABLE_META_INDEX + " VALUES ('"
            + Build.VERSION.INCREMENTAL + "');";

    private static final String SELECT_BUILD_VERSION = "SELECT "
            + MetaColumns.BUILD + " FROM " + Tables.TABLE_META_INDEX
            + " LIMIT 1;";
    ...
    public void onOpen(SQLiteDatabase db) {
        ...
        if (!Build.VERSION.INCREMENTAL.equals(getBuildVersion(db))) {
            Log.w(TAG,
                    "Index needs to be rebuilt as build-version is not the same");
