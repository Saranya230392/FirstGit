...
public class PowerSaveBatteryChart extends View {
    ...
    final int mPaddingText16 = (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
            16, getResources().getDisplayMetrics());
    final int mPaddingText10 = (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
    ...
    final TextPaint mTextRedPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
    ...
    public PowerSaveBatteryChart(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        try {
            ...
            if (instance != null) {
                mTextPaint.density = instance.getDisplayMetrics().density;
                mTextPaint.setCompatibilityScaling(
                        instance.getCompatibilityInfo().applicationScale);
            }
        } catch (NullPointerException e) {
            Log.w("PowerSaveBatteryChart", "NullPointerException");
        } catch (Exception e) { // WBT
            Log.w("PowerSaveBatteryChart", "Exception");
        }
    ...
    void setStats(BatteryStats stats) {
        ...
        String totalDurationString = Utils.formatElapsedTime(getContext(), mHistEnd - mHistStart,
                true);
        mTotalDurationString = getContext().getString(
                R.string.sp_power_save_total_usage_time_NORMAL,
                totalDurationString);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int textHeight = mTextDescent - mTextAscent + mPaddingText16;
        ...
        if (h > (textHeight * 6)) {
            ...
            // jongtak0920.kim@lge.com 120817 Edit Graph GUI [START]
            mLevelTop = textHeight + mPaddingText16;
            // jongtak0920.kim@lge.com 120817 Edit Graph GUI [END]
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mLargeMode) {
            ...
            // jongtak0920.kim@lge.com 120807 [START]
            if (mTotalDurationStringWidth > width - 15) {
                String totalDurationString = Utils.formatElapsedTime(getContext(),
                        mHistEnd - mHistStart, true);
                mTotalDurationString = totalDurationString;
                mTotalDurationStringWidth = (int)mTextPaint.measureText(mTotalDurationString);
            }
            // jongtak0920.kim@lge.com 120807 [END]

            // jongtak0920.kim@lge.com 120817 Edit Graph GUI [START]
            //            canvas.drawText(mDurationString, 10, -mTextAscent + (mLineWidth/2), mTextPaint);
            ...
            canvas.drawText(mDurationString, 0, -mTextAscent + mPaddingText16, mTextPaint);
            canvas.drawText(mTotalDurationString, (width / 2) - (mTotalDurationStringWidth / 2),
                    mLevelBottom - mTextAscent + mThinLineWidth + mPaddingText10, mTextPaint);
            // jongtak0920.kim@lge.com 120817 Edit Graph GUI [START]
        } else {
        ...
        if (mLargeMode) {
            ...
            for (int i = 1; i < 10; i++) { // yonguk.kim 20120420 PowerSave start immediatly
