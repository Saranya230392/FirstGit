...
public class ChooseLockGeneric extends PreferenceActivity {
    ...
    public Intent getIntent() {
        ...
        modIntent.putExtra(EXTRA_NO_HEADERS, true); // CAPP_KEYGUARD
        return modIntent;
    }
    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        private static final int REQ_SEPARATED_CODE = 103; // CAPP_KEYGUARD
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if (intent != null
                    && Utils.checkPackage(getActivity().getApplicationContext(), "com.lge.lockscreensettings")) {
                Log.d(TAG, "start LockScreenSettings");
                intent.setClassName("com.lge.lockscreensettings", "com.lge.lockscreensettings.lockscreen.ChooseLockGeneric");
                startActivityForResult(intent, REQ_SEPARATED_CODE);
                return;
            }
            // CAPP_KEYGUARD_END
        ...
        public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
            ...
            //EventLog.writeEvent(EventLogTags.LOCK_SCREEN_TYPE, key); // CAPP_KEYGUARD
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            ((ListView)v.findViewById(android.R.id.list)).setItemsCanFocus(true); // CAPP_KEYGUARD
        ...
        public void onActivityResult(int requestCode, int resultCode, Intent data) {
            ...
            } else if(requestCode == REQ_SEPARATED_CODE) {
            // CAPP_KEYGUARD_START
                if (resultCode == RESULT_OK) {
                    if (data != null) {
                        Intent intent = new Intent();
                        intent.putExtra(ChooseLockSettingsHelper.EXTRA_KEY_PASSWORD, data.getStringExtra(ChooseLockSettingsHelper.EXTRA_KEY_PASSWORD));
                    ...
                    if (com.lge.config.ConfigBuildFlags.CAPP_SDENCRYPTION_USERKEY) {
                        ...
                        if ( data != null) {
                            password = data.getStringExtra(ChooseLockSettingsHelper.EXTRA_KEY_PASSWORD);
                        }
                        ...
                        if (quality < DevicePolicyManager.PASSWORD_QUALITY_NUMERIC) {
                            mLGSDEncManager.lockDevice();
                        } else {
                            if (password != null) {
                                mLGSDEncManager.changepw(password);
                            }
                        }
                    }
                    Log.d(TAG, "onActivityResult ChooseLockGeneric End requestCode : REQ_SEPARATED_CODE, resultCode : RESULT_OK ");
                } else {
                    Log.d(TAG, "onActivityResult ChooseLockGeneric End requestCode : REQ_SEPARATED_CODE, resultCode : RESULT_CANCELED ");
        ...
        private void updatePreferenceSummaryIfNeeded() {
            ...
            for (int i = 0; i < preferenceCount; i++) {
                ...
                if (KEY_UNLOCK_SET_PATTERN.equals(preference.getKey()) ||
                    KEY_UNLOCK_SET_PIN.equals(preference.getKey()) ||
                    KEY_UNLOCK_SET_PASSWORD.equals(preference.getKey())) {
