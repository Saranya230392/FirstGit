...
public class NetworkPolicyEditor {
    ...
    private boolean setMobilePolicySplitInternal(String subscriberId, boolean split) {
        ...
        if (split == beforeSplit) {
            ...
            if (null == policy3g || null == policy4g) {
                //WBT : 525080
                return false;
            }
            ...
            mPolicies.add(new NetworkPolicy(template3g, policyAll.cycleDay,
                    policyAll.cycleTimezone,
                    policyAll.warningBytes, policyAll.limitBytes, SNOOZE_NEVER, SNOOZE_NEVER,
                    policyAll.metered, policyAll.inferred));
            mPolicies.add(new NetworkPolicy(template4g, policyAll.cycleDay,
                    policyAll.cycleTimezone,
                    policyAll.warningBytes, policyAll.limitBytes, SNOOZE_NEVER, SNOOZE_NEVER,
                    policyAll.metered, policyAll.inferred));
            return true;
