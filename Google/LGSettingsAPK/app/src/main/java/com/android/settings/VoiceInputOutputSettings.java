...
public class VoiceInputOutputSettings implements OnPreferenceChangeListener {
    ...
    public Preference getTtsSettingsPreference() {
        return mTtsSettingsPref;
    }

    public void setTtsSettingsPreference(Preference mTtsSettingsPref) {
        this.mTtsSettingsPref = mTtsSettingsPref;
    }

    public Preference getRecognizerSettingsPreference() {
        return mRecognizerSettingsPref;
    }

    public void setRecognizerSettingsPreference(Preference mRecognizerSettingsPref) {
        this.mRecognizerSettingsPref = mRecognizerSettingsPref;
    }

    public ListPreference getRecognizerPreference() {
        return mRecognizerPref;
    }

    public void setRecognizerPreference(ListPreference mRecognizerPref) {
        this.mRecognizerPref = mRecognizerPref;
    }
