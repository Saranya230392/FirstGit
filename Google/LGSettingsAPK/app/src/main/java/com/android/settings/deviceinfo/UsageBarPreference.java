...
public class UsageBarPreference extends Preference {
    ...
    public UsageBarPreference(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        if (Config.getOperator().equals(Config.VZW)) {
            setLayoutResource(R.layout.preference_memoryusage_vzw);
        } else {
            setLayoutResource(R.layout.preference_memoryusage);
        }
    }

    public void setUsageBarPreference(Context context) {
        setLayoutResource(R.layout.bua_preference_memoryusage);
    }
