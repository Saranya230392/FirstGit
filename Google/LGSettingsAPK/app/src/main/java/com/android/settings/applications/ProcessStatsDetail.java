...
public class ProcessStatsDetail extends Fragment implements Button.OnClickListener {
    ...
    private void addPackageHeaderItem(ViewGroup parent, String packageName) {
        ...
        try {
            ...
            Log.w("ProcessStatsDetail", "PackageManager.NameNotFoundException");
        }
    ...
    final static Comparator<ProcStatsEntry.Service> sServiceCompare = new Comparator<ProcStatsEntry.Service>() {
        @Override
    ...
    final static Comparator<ArrayList<ProcStatsEntry.Service>> sServicePkgCompare = new Comparator<ArrayList<ProcStatsEntry.Service>>() {
        @Override
    ...
    private void fillServicesSection() {
        if (mEntry.mServices.size() > 0) {
            ...
            // Sort it all.
            ArrayList<ArrayList<ProcStatsEntry.Service>> servicePkgs = new ArrayList<ArrayList<ProcStatsEntry.Service>>();
