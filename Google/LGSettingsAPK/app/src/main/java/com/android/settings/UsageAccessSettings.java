...
public class UsageAccessSettings extends SettingsPreferenceFragment implements
    ...
    private class AppsRequestingAccessFetcher extends
        ...
        protected ArrayMap<String, PackageEntry> doInBackground(Void... params) {
            ...
            ArrayMap<String, PackageEntry> entries = new ArrayMap<String, PackageEntry>();
        ...
        protected void onPostExecute(ArrayMap<String, PackageEntry> newEntries) {
            ...
            for (int i = 0; i < packageCount; i++) {
                ...
                if (packageEntry.preference == null) {
                    packageEntry.preference = new SettingsSwitchPreference(mContext);
                    packageEntry.preference.setSwitchTextOn("");
                    packageEntry.preference.setSwitchTextOff("");
                    packageEntry.preference.setPersistent(false);
                    packageEntry.preference.setDivider(false);
                    packageEntry.preference.setOnPreferenceChangeListener(UsageAccessSettings.this);
                    if ("com.lge.mlt".equals(packageEntry.packageName)) {
                        continue;
                    }
    ...
    ArrayMap<String, PackageEntry> mPackageEntryMap = new ArrayMap<String, PackageEntry>();
    ...
    public static class WarningDialogFragment extends DialogFragment
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            return new AlertDialog.Builder(getActivity())
                    .setTitle(R.string.apps_with_usage_access_title)
                    .setMessage(R.string.apps_with_usage_access_popup_description)
