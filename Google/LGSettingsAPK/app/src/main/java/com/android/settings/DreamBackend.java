...
public class DreamBackend {
    private static final String TAG = "DreamSettings.Backend";
    ...
    public DreamBackend(Context context) {
        ...
        mDreamsEnabledByDefault = Config.getFWConfigBool(mContext, com.android.internal.R.bool.config_dreamsEnabledByDefault, 
                           "com.android.internal.R.bool.config_dreamsEnabledByDefault");
        mDreamsActivatedOnSleepByDefault = Config.getFWConfigBool(mContext, com.android.internal.R.bool.config_dreamsActivatedOnSleepByDefault, 
                           "com.android.internal.R.bool.config_dreamsActivatedOnSleepByDefault");
        mDreamsActivatedOnDockByDefault = Config.getFWConfigBool(mContext, com.android.internal.R.bool.config_dreamsActivatedOnDockByDefault, 
    ...
    public List<DreamInfo> getDreamInfos() {
        ...
        for (ResolveInfo resolveInfo : resolveInfos) {
            ...
            if ("com.android.systemui.BeanBagDream".equals(resolveInfo.serviceInfo.name)) {
                dreamInfo.icon = mContext.getResources().getDrawable(R.drawable.img_bean_fliger);
            } else {
                dreamInfo.icon = resolveInfo.loadIcon(pm);
            }
            dreamInfo.componentName = getDreamComponentName(resolveInfo);
            if (dreamInfo.componentName != null) {
