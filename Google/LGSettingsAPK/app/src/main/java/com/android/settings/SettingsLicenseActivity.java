...
import android.webkit.WebSettings; //[2012.04.16][seungeene][Common][TD_152835] Apply wide view port attribute.
...
//[S][COMMON][Settings][never1029]open source licenses do not long toutch
import android.view.View;
import android.view.View.OnLongClickListener;

//[E][COMMON][Settings][never1029]open source licenses do not long toutch
...
public class SettingsLicenseActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //[S][2012.04.16][seungeene][Common][TD_152835] Apply wide view port attribute.
        WebSettings webSettings = mWebView.getSettings();
        if (webSettings != null) { //[2012.08.20][yongjaeo.lee][Common][WBT_376351] add ,avoid null pointer exception
            webSettings.setUseWideViewPort(true);
            webSettings.setBuiltInZoomControls(true);
            webSettings.setDisplayZoomControls(false);
        }
        //[E][2012.04.16][seungeene][Common][TD_152835] Apply wide view port attribute.
        ...
        pd.setOnCancelListener(new DialogInterface.OnCancelListener() {
            @Override
            public void onCancel(DialogInterface dlgi) {
                mQuit = true;
                cancelLoadData();
            }
        });
    ...
    private void showPageOfText(String text) {
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                if (mSpinnerDlg != null) {
                    mSpinnerDlg.dismiss();
                    //mSpinnerDlg = null;   //[2012.01.15][jm.lee2] ICS 4.0.3 merge
                }
                ...
                if (mTextDlg != null) {
                    mTextDlg.show();
                    //mTextDlg = null;    //[2012.01.15][jm.lee2] ICS 4.0.3 merge
                }
            }
        });
        //[S][COMMON][Settings][never1029]open source licenses do not long toutch
        mWebView.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View arg0) {
                ...
                Log.d("babyhulk", "return LongClick for webView");
                return true;
            }
        });
        //[E][COMMON][Settings][never1029]open source licenses do not long toutch
