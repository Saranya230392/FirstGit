...
public class DataUsageMeteredSettings extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (Utils.supportSplitView(context)) {
            Log.d("DataUsageMeteredSettings", "[DataUsageMeteredSettings] if tablet, skip icon");
        } else {
            Log.d("DataUsageMeteredSettings", "[DataUsageMeteredSettings] shortcut_data_usage icon");
            getActivity().getActionBar().setIcon(R.drawable.shortcut_data_usage);
        }
    ...
    private void updateNetworks(Context context) {
        ...
        if (hasWifiRadio(context) && mWifiManager.isWifiEnabled()
                && mWifiManager.getConfiguredNetworks() != null) {
