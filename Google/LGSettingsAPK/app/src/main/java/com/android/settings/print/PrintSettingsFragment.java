...
public class PrintSettingsFragment extends SettingsPreferenceFragment
        implements DialogCreatable, OnItemSelectedListener {
    ...
    private void updateServicesPreferences() {
        ...
        for (int i = 0; i < installedServiceCount; i++) {
            ...
            preference.setFragment("com.android.settings.print.PrintServiceSettingsFragment");
            ...
            extras.putString(EXTRA_ENABLE_WARNING_TITLE, getString(
                    R.string.print_service_security_title, applicationLabel));
