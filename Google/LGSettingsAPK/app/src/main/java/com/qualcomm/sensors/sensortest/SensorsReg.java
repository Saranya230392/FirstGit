...
--------    ---    ----------------------------------------------------------
12/22/2011  gju    Removed trailing whitespace.
10/10/2011  gju    Changed logcat TAG.
09/21/2011  gju    Created
...
public class SensorsReg {
    ...
    */
   static public native int setRegistryValue(short itemID, byte[] data, byte len);
    ...
    *         -6: Did not call open() first
    */
   static public native byte[] getRegistryValue(short itemID);
